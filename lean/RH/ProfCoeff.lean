...
-- claim: zprep22-coeff-n22-m1o2 (8519c3cc386a1a5b22dc505e0598d5162453b6cb5942fd8f953b06bf25545484)
def Claim_8519c3cc386a : Prop :=
  ((∑ n ∈ Finset.range 22, Real.log n * (n : ℝ) ^ (-((1) / 2 : ℝ))) ≤ ((1731) / 125 : ℝ)) ∧ (15 / 16 * (Real.log 22 * (22 : ℝ) ^ (-((1) / 2 : ℝ))) + 11 / 16 * (Real.log 23 * (23 : ℝ) ^ (-((1) / 2 : ℝ))) + 5 / 16 * (Real.log 24 * (24 : ℝ) ^ (-((1) / 2 : ℝ))) + 1 / 16 * (Real.log 25 * (25 : ℝ) ^ (-((1) / 2 : ℝ))) ≤ ((1331) / 1000 : ℝ))

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-eta-grid, proof sha256: ce4485c1e95154703921812fcc862673f497de670096a5c56e7a8de614ae46e1)
theorem prove_Claim_8519c3cc386a : Claim_8519c3cc386a :=
  by
    unfold Claim_8519c3cc386a
    ...
    · rw [show Finset.range 22 = Finset.range 22 from rfl]
      ...
      nlinarith [hterm2, hterm3, hterm4, hterm5, hterm6, hterm7, hterm8, hterm9, hterm10, hterm11, hterm12, hterm13, hterm14, hterm15, hterm16, hterm17, hterm18, hterm19, hterm20, hterm21]
    · nlinarith [hterm22, hterm23, hterm24, hterm25]
-- END UNTRUSTED PROOF

#rh_audit_axioms prove_Claim_8519c3cc386a
