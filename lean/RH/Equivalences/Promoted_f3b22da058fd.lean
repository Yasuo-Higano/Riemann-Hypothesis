...
-- claim: zcb15k2-rot-n9 (f3b22da058fd0eb857c6967a8faa49c818a74a002e57f53412b910660e5d788e)
def Claim_f3b22da058fd : Prop :=
  ‖((9 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((96251933) / 100000000 : ℝ) : ℂ) - (((27121309) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((127) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: aaa22b375dfd734f3fe7aecf71151d571a555f4eaed97a6315468b74e84fe01c)
theorem prove_Claim_f3b22da058fd : Claim_f3b22da058fd :=
  by
    unfold Claim_f3b22da058fd
...
#rh_audit_axioms prove_Claim_f3b22da058fd
