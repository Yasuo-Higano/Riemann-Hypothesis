...
-- claim: zcb29k4-rot-n5 (19651de955f2a36ec662d9e7e53d87eec2c3d82efff18df574cc5b0ac329258e)
def Claim_19651de955f2 : Prop :=
  ‖((5 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 32 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((24968387) / 25000000 : ℝ) : ℂ) - (((2513687) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((11) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 877a5d881eed70805a3f544aeef30176e18cb6183173c198886c362e4cdfda9b)
theorem prove_Claim_19651de955f2 : Claim_19651de955f2 :=
  by
    unfold Claim_19651de955f2
...
#rh_audit_axioms prove_Claim_19651de955f2
