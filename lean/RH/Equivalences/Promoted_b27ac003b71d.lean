...
-- claim: zcb21k2-rot-n16 (b27ac003b71d43222417238a3005ba7f7375efda74cd64b07868159598349471)
def Claim_b27ac003b71d : Prop :=
  ‖((16 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((9405421) / 10000000 : ℝ) : ℂ) - (((1061491) / 3125000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((19) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 24563714e99da76965e1a7239c66562307b3a585d128f7c50f2cacc66da7ee6b)
theorem prove_Claim_b27ac003b71d : Claim_b27ac003b71d :=
  by
    unfold Claim_b27ac003b71d
...
#rh_audit_axioms prove_Claim_b27ac003b71d
