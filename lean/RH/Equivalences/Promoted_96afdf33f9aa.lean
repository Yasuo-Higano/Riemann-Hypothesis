...
-- claim: zcb28k2-rot-n4 (96afdf33f9aafc02677998d49c5f9bcd9be39d281ad3b76bb0aa22d83ccb72fc)
def Claim_96afdf33f9aa : Prop :=
  ‖((4 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 40 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99939949) / 100000000 : ℝ) : ℂ) - (((1732521) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 12483e0576f39476094d4220a98e871f3903f8d3a1c81406c9283291ad085d88)
theorem prove_Claim_96afdf33f9aa : Claim_96afdf33f9aa :=
  by
    unfold Claim_96afdf33f9aa
    ...
    have hv : |((1) / 40 : ℝ) * Real.log ((4 : ℕ) : ℝ) - ((433217) / 12500000 : ℝ)| ≤ ((1) / 50000000 : ℝ) :=
      hssb (Real.log ((4 : ℕ) : ℝ)) ((1386294361) / 1000000000 : ℝ) ((601) / 1000000000000 : ℝ) (((1) / 40 : ℝ)) ((433217) / 12500000 : ℝ) ((1) / 100000000 : ℝ) ((1) / 50000000 : ℝ) hlog
        (by rw [abs_le]; constructor <;> norm_num)
    ...
    have hmain := prove_Claim_fe51a39a688e 4 ((0 : ℝ)) (((1) / 40 : ℝ)) (0 : ℝ) (1 : ℝ) ((3) / 100000000 : ℝ) ((1) / 100000000 : ℝ) ((433217) / 12500000 : ℝ) ((99939949) / 100000000 : ℝ) ((3) / 100000000 : ℝ) ((1732521) / 50000000 : ℝ) ((3) / 100000000 : ℝ) ((1) / 50000000 : ℝ)
    ...
    calc ‖((4 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 40 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99939949) / 100000000 : ℝ) : ℂ) - (((1732521) / 50000000 : ℝ) : ℂ) * Complex.I)‖
...
#rh_audit_axioms prove_Claim_96afdf33f9aa
