...
-- claim: zl3ch-rot-n25 (66af43fdd7e8260aa9a458e6eee8d62fafa3d7d0455a0234375f12624310f44c)
def Claim_66af43fdd7e8 : Prop :=
  ‖((25 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 40 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((24919097) / 25000000 : ℝ) : ℂ) - (((803851) / 10000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 2000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 66f84241b5e109e99e83af99212d20649f760aa20cedbb9be958434b4ae924c2)
theorem prove_Claim_66af43fdd7e8 : Claim_66af43fdd7e8 :=
  by
    unfold Claim_66af43fdd7e8
...
#rh_audit_axioms prove_Claim_66af43fdd7e8
