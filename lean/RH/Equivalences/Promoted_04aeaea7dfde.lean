...
-- claim: zcb20k3-rot-n14 (04aeaea7dfde4cc15bee914bae2793e8c5d5e63e60e0f91eb4e421776feb1c81)
def Claim_04aeaea7dfde : Prop :=
  ‖((14 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49321401) / 50000000 : ℝ) : ℂ) - (((8209713) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 12500000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: f4932b035eec6e3c511fcf45335cace5f6aaf14c5e7081a5f86c12f9e06aaf94)
theorem prove_Claim_04aeaea7dfde : Claim_04aeaea7dfde :=
  by
    unfold Claim_04aeaea7dfde
...
#rh_audit_axioms prove_Claim_04aeaea7dfde
