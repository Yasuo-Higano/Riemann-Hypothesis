...
-- claim: zcb15k3-rot-n4 (346e007cdee37a82d3aa2a85df3b89bc3ba14691c04c23b57978b9b3086afb54)
def Claim_346e007cdee3 : Prop :=
  ‖((4 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99624881) / 100000000 : ℝ) : ℂ) - (((8653503) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: cbb55d0bc97bb49412a74f6379897b27309345d00f41e0a0ae96e838b66e947c)
theorem prove_Claim_346e007cdee3 : Claim_346e007cdee3 :=
  by
    unfold Claim_346e007cdee3
...
#rh_audit_axioms prove_Claim_346e007cdee3
