...
-- claim: zcb2k3-rot-n2 (e1de94bdce30b467e0acaadc50811cbdaa4c8d56add327f3302df14e22599303)
def Claim_e1de94bdce30 : Prop :=
  ‖((2 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((780517) / 781250 : ℝ) : ℂ) - (((866163) / 20000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 6ba678be515b8118e31767024a9f95b53e982dc14d785aa3c5c28f07e4f97a96)
theorem prove_Claim_e1de94bdce30 : Claim_e1de94bdce30 :=
  by
    unfold Claim_e1de94bdce30
...
#rh_audit_axioms prove_Claim_e1de94bdce30
