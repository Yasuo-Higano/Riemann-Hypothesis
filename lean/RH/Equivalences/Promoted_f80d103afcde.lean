...
-- claim: auto-exp-eta-partial-30-t141-term-15 (f80d103afcdeb66fff6fb479004d9b8c14d336669f7a5a1c50d3bb86252c6374)
def Claim_f80d103afcde : Prop :=
  |Real.exp ((-3385063) / 2500000 : ℝ) - ((12909943) / 50000000 : ℝ)| ≤ ((23) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-exp-square, proof sha256: 825b1cd4c01d34da1cf1f29ba5603897a311c5d0b639965bf73591ba1d841e07)
theorem prove_Claim_f80d103afcde : Claim_f80d103afcde :=
  by
    unfold Claim_f80d103afcde
    have hb : |Real.exp ((-3385063) / 5000000 : ℝ) - ((6351659) / 12500000 : ℝ)| ≤ ((1) / 5000000 : ℝ) := by
      have h := prove_Claim_fa96b24abccf
      unfold Claim_fa96b24abccf at h
      exact h
...
#rh_audit_axioms prove_Claim_f80d103afcde
