...
-- claim: zcb3k3-rot-n8 (fab96813aa003232dbe8bbd28dcc38f837bc03948f0d09e47189419db67dd0b0)
def Claim_fab96813aa00 : Prop :=
  ‖((8 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49578321) / 50000000 : ℝ) : ℂ) - (((6479977) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: cbd77553843a86c61d7f3feab0eaaf8d07f76c17e15deb333d094526179139e4)
theorem prove_Claim_fab96813aa00 : Claim_fab96813aa00 :=
  by
    unfold Claim_fab96813aa00
...
#rh_audit_axioms prove_Claim_fab96813aa00
