...
-- claim: zl3ch-rot-n32 (b3d40b066c6fb4bc3d020611f2c1f783afedd52151e11a59989393228e587920)
def Claim_b3d40b066c6f : Prop :=
  ‖((32 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 40 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99624881) / 100000000 : ℝ) : ℂ) - (((8653503) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 57a8665e58323b3e6dbe25b3a29dbba114e168c3ca32abf8728b827471ce2573)
theorem prove_Claim_b3d40b066c6f : Claim_b3d40b066c6f :=
  by
    unfold Claim_b3d40b066c6f
    ...
    have hv : |((1) / 40 : ℝ) * Real.log ((32 : ℕ) : ℝ) - ((433217) / 5000000 : ℝ)| ≤ ((1) / 50000000 : ℝ) :=
      hssb (Real.log ((32 : ℕ) : ℝ)) ((1386294361) / 400000000 : ℝ) ((1501) / 1000000000000 : ℝ) (((1) / 40 : ℝ)) ((433217) / 5000000 : ℝ) ((1) / 100000000 : ℝ) ((1) / 50000000 : ℝ) hlog
        (by rw [abs_le]; constructor <;> norm_num)
    ...
    have hmain := prove_Claim_fe51a39a688e 32 ((0 : ℝ)) (((1) / 40 : ℝ)) (0 : ℝ) (1 : ℝ) ((3) / 100000000 : ℝ) ((1) / 100000000 : ℝ) ((433217) / 5000000 : ℝ) ((99624881) / 100000000 : ℝ) ((3) / 100000000 : ℝ) ((8653503) / 100000000 : ℝ) ((3) / 100000000 : ℝ) ((1) / 50000000 : ℝ)
    ...
    calc ‖((32 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 40 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99624881) / 100000000 : ℝ) : ℂ) - (((8653503) / 100000000 : ℝ) : ℂ) * Complex.I)‖
...
#rh_audit_axioms prove_Claim_b3d40b066c6f
