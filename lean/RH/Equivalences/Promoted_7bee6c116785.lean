...
-- claim: zcb21k2-rot-n12 (7bee6c11678599d7ee426102df9988abce6234e0588ad0ddc253e0d68e50ea44)
def Claim_7bee6c116785 : Prop :=
  ‖((12 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((95214627) / 100000000 : ℝ) : ℂ) - (((15282137) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((29) / 20000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: b56c58f04d57004c1cae080fa5d1b6ab8082b4e4517d77723c6ca2aac1cb08f3)
theorem prove_Claim_7bee6c116785 : Claim_7bee6c116785 :=
  by
    unfold Claim_7bee6c116785
...
#rh_audit_axioms prove_Claim_7bee6c116785
