...
-- claim: zcb15k2-rot-n11 (7f73bf8c85237c1eb54c978f75e2e49b6f842dbd9160500cae17651fee2e1b6c)
def Claim_7f73bf8c8523 : Prop :=
  ‖((11 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((95541419) / 100000000 : ℝ) : ℂ) - (((2952689) / 10000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((119) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 4e40952d3755a8a6cf28452901c7a97e1d2ce72e1a1166462be40c16222afcb2)
theorem prove_Claim_7f73bf8c8523 : Claim_7f73bf8c8523 :=
  by
    unfold Claim_7f73bf8c8523
...
#rh_audit_axioms prove_Claim_7f73bf8c8523
