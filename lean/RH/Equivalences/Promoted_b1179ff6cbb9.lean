...
-- claim: zcb21k2-rot-n5 (b1179ff6cbb9c4a1db80819f5ce15be2d4dcff09ad740c3dc36fb392dbd6dfb0)
def Claim_b1179ff6cbb9 : Prop :=
  ‖((5 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((6123947) / 6250000 : ℝ) : ℂ) - (((9991271) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((7) / 20000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: f6aef1b025575263b2292f8033d11d2542f61f28101fb60af6d72a3f1d45075c)
theorem prove_Claim_b1179ff6cbb9 : Claim_b1179ff6cbb9 :=
  by
    unfold Claim_b1179ff6cbb9
...
#rh_audit_axioms prove_Claim_b1179ff6cbb9
