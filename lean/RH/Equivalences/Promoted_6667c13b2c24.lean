...
-- claim: zcb16k4-rot-n13 (6667c13b2c245457e6b13f8a24b28aa873af895809d1ffd27f64ea9a62553081)
def Claim_6667c13b2c24 : Prop :=
  ‖((13 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 32 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99678933) / 100000000 : ℝ) : ℂ) - (((8006887) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((7) / 25000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: a26484462fc14c775bce72606f3a675e61678da4be0f8aacdad4ef7449e0d1ed)
theorem prove_Claim_6667c13b2c24 : Claim_6667c13b2c24 :=
  by
    unfold Claim_6667c13b2c24
...
#rh_audit_axioms prove_Claim_6667c13b2c24
