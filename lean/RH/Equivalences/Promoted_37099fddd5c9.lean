...
-- claim: zcb98k0-rot-n3 (37099fddd5c9e862934567619b6d15d5b3af8aec4819b1b2ef0f8bf024a4fc4d)
def Claim_37099fddd5c9 : Prop :=
  ‖((3 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 64 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99985267) / 100000000 : ℝ) : ℂ) - (((858249) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 588e97e682031785c9a7bf5ab5c391bac0c83e6b92cbfa4b77231ded2bd326c7)
theorem prove_Claim_37099fddd5c9 : Claim_37099fddd5c9 :=
  by
    unfold Claim_37099fddd5c9
...
#rh_audit_axioms prove_Claim_37099fddd5c9
