...
-- claim: zcb21k3-rot-n10 (9b5c21f378f92164418f7ec4af3409371f1d43e0ec28be7860275bb8bd070233)
def Claim_9b5c21f378f9 : Prop :=
  ‖((10 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((98966259) / 100000000 : ℝ) : ℂ) - (((3585383) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 1250000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 48ce8a02bbd0fcc5ad08a49c105f98708046d55020607c9d07b2343156330cc7)
theorem prove_Claim_9b5c21f378f9 : Claim_9b5c21f378f9 :=
  by
    unfold Claim_9b5c21f378f9
...
#rh_audit_axioms prove_Claim_9b5c21f378f9
