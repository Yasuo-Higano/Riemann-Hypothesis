...
-- claim: zcb22k2-rot-n4 (0133726387b714e1b2f9b9175706b75d57365433027275561347058fd0246c21)
def Claim_0133726387b7 : Prop :=
  ‖((4 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49251169) / 50000000 : ℝ) : ℂ) - (((3448417) / 20000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: c6a8a6927ce770b616554f22f76a053a72d0d7d804d85f85cb8e32d3d69ecda6)
theorem prove_Claim_0133726387b7 : Claim_0133726387b7 :=
  by
    unfold Claim_0133726387b7
...
#rh_audit_axioms prove_Claim_0133726387b7
