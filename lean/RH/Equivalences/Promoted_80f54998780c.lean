...
-- claim: zcb30k2-rot-n22 (80f54998780c391b3a72254ca99ff5db0f1f650a0da4b9746b33a14576b1f724)
def Claim_80f54998780c : Prop :=
  ‖((22 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 40 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99701569) / 100000000 : ℝ) : ℂ) - (((3859959) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((19) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: d1745dcef7ffb37c2f626537ff6fe8ed4bdbb97b7040f48269044ad6c87a25d3)
theorem prove_Claim_80f54998780c : Claim_80f54998780c :=
  by
    unfold Claim_80f54998780c
...
#rh_audit_axioms prove_Claim_80f54998780c
