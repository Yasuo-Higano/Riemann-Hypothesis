...
-- claim: zcb22k2-rot-n2 (5f1e5946920e294a88e2ed4a7532c7c4f91d9c86b94c474f4ba55e2f8f683fef)
def Claim_5f1e5946920e : Prop :=
  ‖((2 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99624881) / 100000000 : ℝ) : ℂ) - (((8653503) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 889eb16e3df0f92b64f5cec515ecd89ae464c3d65e8258aad07a9ff82fda0bd5)
theorem prove_Claim_5f1e5946920e : Claim_5f1e5946920e :=
  by
    unfold Claim_5f1e5946920e
...
#rh_audit_axioms prove_Claim_5f1e5946920e
