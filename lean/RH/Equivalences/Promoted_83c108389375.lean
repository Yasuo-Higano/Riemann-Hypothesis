...
-- claim: zcb16k4-rot-n3 (83c10838937541a706b9c482d81f17d1dacc689c16e0ec36fc8fd2243c87c67a)
def Claim_83c108389375 : Prop :=
  ‖((3 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 32 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99941073) / 100000000 : ℝ) : ℂ) - (((3432489) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 86c7c183e814a9277102dd9b5eef967af9b88d3061689c3896988765ec0ef858)
theorem prove_Claim_83c108389375 : Claim_83c108389375 :=
  by
    unfold Claim_83c108389375
...
#rh_audit_axioms prove_Claim_83c108389375
