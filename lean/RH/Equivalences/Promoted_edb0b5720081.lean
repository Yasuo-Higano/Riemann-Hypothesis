...
-- claim: zl3b-rot-n34 (edb0b57200814da48dbbcbc2b7850ea72117c8b6d582892c5acf635ad3be5bd6)
def Claim_edb0b5720081 : Prop :=
  ‖((34 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 40 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99611651) / 100000000 : ℝ) : ℂ) - (((4402243) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((11) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: eb2f8d345c4e39f4b6e9ea5440a305f00869de65d27a5fd2e171aabf9181e8b6)
theorem prove_Claim_edb0b5720081 : Claim_edb0b5720081 :=
  by
    unfold Claim_edb0b5720081
...
#rh_audit_axioms prove_Claim_edb0b5720081
