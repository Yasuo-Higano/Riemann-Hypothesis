...
-- claim: zcoeff-n15-m5o8 (6f59f0eb3998cf892be289549b21d24d4b3bc3978df04370581ac017b14f5472)
def Claim_6f59f0eb3998 : Prop :=
  ((∑ n ∈ Finset.range 15, Real.log n * (n : ℝ) ^ (-((5) / 8 : ℝ))) ≤ ((711) / 100 : ℝ)) ∧ (15 / 16 * (Real.log 15 * (15 : ℝ) ^ (-((5) / 8 : ℝ))) + 11 / 16 * (Real.log 16 * (16 : ℝ) ^ (-((5) / 8 : ℝ))) + 5 / 16 * (Real.log 17 * (17 : ℝ) ^ (-((5) / 8 : ℝ))) + 1 / 16 * (Real.log 18 * (18 : ℝ) ^ (-((5) / 8 : ℝ))) ≤ ((201) / 200 : ℝ))

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-eta-grid, proof sha256: 995fce41fb585374c338cc84356552804a52483cadee5eb60e8ed880577cb5bc)
theorem prove_Claim_6f59f0eb3998 : Claim_6f59f0eb3998 :=
  by
    unfold Claim_6f59f0eb3998
...
#rh_audit_axioms prove_Claim_6f59f0eb3998
