...
-- claim: zcb25k3-rot-n8 (3d60295a42eb9c9eb77e9dc265eb2b5c5f561674850c2bc0a5494e14c035a199)
def Claim_3d60295a42eb : Prop :=
  ‖((8 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49578321) / 50000000 : ℝ) : ℂ) - (((6479977) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: f629f6a90405fd36ab500d4cf10f7677ef1690c7f8d9a443fd086cf4c8a592f5)
theorem prove_Claim_3d60295a42eb : Claim_3d60295a42eb :=
  by
    unfold Claim_3d60295a42eb
...
#rh_audit_axioms prove_Claim_3d60295a42eb
