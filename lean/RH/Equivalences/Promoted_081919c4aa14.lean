...
-- claim: zcb13k2-rot-n4 (081919c4aa14c8c91572e826fd0080138b88601d91ca58e6441935e01e1bad40)
def Claim_081919c4aa14 : Prop :=
  ‖((4 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49251169) / 50000000 : ℝ) : ℂ) - (((3448417) / 20000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: faef25fc8a7c181b19ccfa60346ba01b7a7fbef1dc5ade44e3bb87769894b87e)
theorem prove_Claim_081919c4aa14 : Claim_081919c4aa14 :=
  by
    unfold Claim_081919c4aa14
...
#rh_audit_axioms prove_Claim_081919c4aa14
