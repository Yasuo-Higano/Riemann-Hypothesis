...
-- claim: zcb29k4-rot-n10 (50b56282689e1766624dcf94aa6a8f3bd448275935c4d9d1e58430aafbdc312f)
def Claim_50b56282689e : Prop :=
  ‖((10 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 32 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((9974123) / 10000000 : ℝ) : ℂ) - (((7189369) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((3) / 6250000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: c45b0806720096c3a7fffd42e3b2dc8518cb0e747b232d52c8fa82552dc68c7c)
theorem prove_Claim_50b56282689e : Claim_50b56282689e :=
  by
    unfold Claim_50b56282689e
...
#rh_audit_axioms prove_Claim_50b56282689e
