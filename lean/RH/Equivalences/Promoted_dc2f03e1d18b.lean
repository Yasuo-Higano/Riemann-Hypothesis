...
-- claim: zcb98k0-rot-n12 (dc2f03e1d18b4afa6f55efef07c178bab258344b54f7d8620f602f7a5ea9601a)
def Claim_dc2f03e1d18b : Prop :=
  ‖((12 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 64 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49962317) / 50000000 : ℝ) : ℂ) - (((970423) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 3125000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 96da3548a6071bac834707b44f0f38f8089a083afe309b0d5b51b83da437f3fe)
theorem prove_Claim_dc2f03e1d18b : Claim_dc2f03e1d18b :=
  by
    unfold Claim_dc2f03e1d18b
...
#rh_audit_axioms prove_Claim_dc2f03e1d18b
