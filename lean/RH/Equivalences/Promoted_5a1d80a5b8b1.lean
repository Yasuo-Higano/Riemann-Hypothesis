...
-- claim: auto-exp-eta-partial-30-t14-term-26 (5a1d80a5b8b118ebb879593af5a478388bcbf7f5d27bcfe698ef102d0321c807)
def Claim_5a1d80a5b8b1 : Prop :=
  |Real.exp ((-81452419) / 50000000 : ℝ) - ((19611611) / 100000000 : ℝ)| ≤ ((117) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-exp-square, proof sha256: 91c67facd1ab57b48a20295c12971ac8d3d74380722297244a7651ba655f521b)
theorem prove_Claim_5a1d80a5b8b1 : Claim_5a1d80a5b8b1 :=
  by
    unfold Claim_5a1d80a5b8b1
    have hb : |Real.exp ((-81452419) / 100000000 : ℝ) - ((44284999) / 100000000 : ℝ)| ≤ ((131) / 50000000 : ℝ) := by
      have h := prove_Claim_5e362783d6de
      unfold Claim_5e362783d6de at h
      exact h
...
#rh_audit_axioms prove_Claim_5a1d80a5b8b1
