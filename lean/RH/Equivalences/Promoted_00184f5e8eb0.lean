...
-- claim: zcb14k2-rot-n17 (00184f5e8eb099e349e38be0a6ce727ed47f3f1f2713a3940272621e0a6bdd42)
def Claim_00184f5e8eb0 : Prop :=
  ‖((17 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((93794103) / 100000000 : ℝ) : ℂ) - (((34679479) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((43) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 0c525ebe8f602a699dc08edc6609a1939773e5b1df09d902498a8607c9b59244)
theorem prove_Claim_00184f5e8eb0 : Claim_00184f5e8eb0 :=
  by
    unfold Claim_00184f5e8eb0
...
#rh_audit_axioms prove_Claim_00184f5e8eb0
