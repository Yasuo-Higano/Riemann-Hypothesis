...
-- claim: zcb28k1-rot-n2 (e466661f629155092012d4e664cda80a4a14e158f23805ee361ac5a32e76b37b)
def Claim_e466661f6291 : Prop :=
  ‖((2 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 20 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99939949) / 100000000 : ℝ) : ℂ) - (((1732521) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: ccc2e605dc120d5238ec2683f394bef4fb708c06d7be7d0d4926b36e121d24ca)
theorem prove_Claim_e466661f6291 : Claim_e466661f6291 :=
  by
    unfold Claim_e466661f6291
...
#rh_audit_axioms prove_Claim_e466661f6291
