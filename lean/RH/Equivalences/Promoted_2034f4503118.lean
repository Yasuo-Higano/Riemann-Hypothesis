...
-- claim: zcb6k2-rot-n9 (2034f4503118b4eaa1b967f4b31f88a7a77c1d013e74d1c337cda899479bf4cc)
def Claim_2034f4503118 : Prop :=
  ‖((9 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((96251933) / 100000000 : ℝ) : ℂ) - (((27121309) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((127) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 303646a4ed09e90607ade2326f6ed7b1f019ff26f985588b18027ee1eef5d2e7)
theorem prove_Claim_2034f4503118 : Claim_2034f4503118 :=
  by
    unfold Claim_2034f4503118
...
#rh_audit_axioms prove_Claim_2034f4503118
