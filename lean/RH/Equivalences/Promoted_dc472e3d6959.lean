...
-- claim: auto-exp-eta-partial-30-t141-term-16 (dc472e3d6959dfc13587940acd9ceb8ee65342e58e4450957a893151fd9f7e91)
def Claim_dc472e3d6959 : Prop :=
  |Real.exp ((-34657359) / 25000000 : ℝ) - ((1) / 4 : ℝ)| ≤ ((29) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-exp-square, proof sha256: b2a64fd6dab89a97c1f3e5e80994899a45cfbedbad7bdf7408ac886edc7d5faa)
theorem prove_Claim_dc472e3d6959 : Claim_dc472e3d6959 :=
  by
    unfold Claim_dc472e3d6959
    have hb : |Real.exp ((-34657359) / 50000000 : ℝ) - ((1) / 2 : ℝ)| ≤ ((13) / 50000000 : ℝ) := by
      have h := prove_Claim_514276280e39
      unfold Claim_514276280e39 at h
      exact h
...
#rh_audit_axioms prove_Claim_dc472e3d6959
