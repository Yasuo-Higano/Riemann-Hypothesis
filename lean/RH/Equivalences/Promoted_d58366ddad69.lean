...
-- claim: zcb12k2-rot-n5 (d58366ddad690befc738a921043957431589a8035df0bf98683a6c1d94c6445a)
def Claim_d58366ddad69 : Prop :=
  ‖((5 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((6123947) / 6250000 : ℝ) : ℂ) - (((9991271) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((7) / 20000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 1a4cac834c6cc5defae885fca7a81bb39357d2f67b578c66c4c8bb8a19d32904)
theorem prove_Claim_d58366ddad69 : Claim_d58366ddad69 :=
  by
    unfold Claim_d58366ddad69
...
#rh_audit_axioms prove_Claim_d58366ddad69
