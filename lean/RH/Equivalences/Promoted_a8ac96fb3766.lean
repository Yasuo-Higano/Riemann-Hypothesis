...
-- claim: zcb21k2-rot-n18 (a8ac96fb376605fe05f9112e60aa98fcf2f53696d2b9bab4b2d6ca0b0cfd735c)
def Claim_a8ac96fb3766 : Prop :=
  ‖((18 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((9354393) / 10000000 : ℝ) : ℂ) - (((138081) / 390625 : ℝ) : ℂ) * Complex.I)‖ ≤ ((127) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 35b6c6905931c746f6990c8184ca70de5a3f8a4cc08a72eae1bc33f905bfb7f0)
theorem prove_Claim_a8ac96fb3766 : Claim_a8ac96fb3766 :=
  by
    unfold Claim_a8ac96fb3766
...
#rh_audit_axioms prove_Claim_a8ac96fb3766
