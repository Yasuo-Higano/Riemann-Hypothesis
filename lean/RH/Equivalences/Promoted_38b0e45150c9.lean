...
-- claim: zcb2k3-rot-n8 (38b0e45150c9bcfffb14e87d9aa02b3458736419bfc891ef9275c4f0df91d67f)
def Claim_38b0e45150c9 : Prop :=
  ‖((8 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49578321) / 50000000 : ℝ) : ℂ) - (((6479977) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: bbebfe56dcc03c8d0c2a2f36bfa58d4a07998d65cb68b6d11bb3f3381162d20e)
theorem prove_Claim_38b0e45150c9 : Claim_38b0e45150c9 :=
  by
    unfold Claim_38b0e45150c9
...
#rh_audit_axioms prove_Claim_38b0e45150c9
