...
-- claim: zcb14k2-rot-n18 (8267d771dcc0aad479075e4965b4c1c7a7a6f13001c371bd12d5deea5e1ce245)
def Claim_8267d771dcc0 : Prop :=
  ‖((18 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((9354393) / 10000000 : ℝ) : ℂ) - (((138081) / 390625 : ℝ) : ℂ) * Complex.I)‖ ≤ ((127) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 64bed5843543b458c969f0ff7623eba2dc2443e1954d36d1691a1ddab0b2c596)
theorem prove_Claim_8267d771dcc0 : Claim_8267d771dcc0 :=
  by
    unfold Claim_8267d771dcc0
...
#rh_audit_axioms prove_Claim_8267d771dcc0
