...
-- claim: zcb29k4-rot-n22 (4ff841f999866be0ff4dd6ecabe807c1054feaea080f593f2fbce305094f6a31)
def Claim_4ff841f99986 : Prop :=
  ‖((22 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 32 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((12441729) / 12500000 : ℝ) : ℂ) - (((4822247) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((21) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: bc6eeca1efabd00bdf9a488a5b1e17bb8307089e57f9fe7387bf4490e248901d)
theorem prove_Claim_4ff841f99986 : Claim_4ff841f99986 :=
  by
    unfold Claim_4ff841f99986
...
#rh_audit_axioms prove_Claim_4ff841f99986
