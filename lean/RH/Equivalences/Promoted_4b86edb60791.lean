...
-- claim: zcb30k3-rot-n19 (4b86edb60791d79896f97180d3e7e95c445a904b63b60043c391944031e36e06)
def Claim_4b86edb60791 : Prop :=
  ‖((19 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 80 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((3997291) / 4000000 : ℝ) : ℂ) - (((1839859) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((11) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: b03059a7f67bbfa8f72e39cccdf703c745b7778a4b2e7a4612f8cfe188f75c3c)
theorem prove_Claim_4b86edb60791 : Claim_4b86edb60791 :=
  by
    unfold Claim_4b86edb60791
...
#rh_audit_axioms prove_Claim_4b86edb60791
