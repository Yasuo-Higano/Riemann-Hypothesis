...
-- claim: zcb14k2-rot-n7 (4d290e52a621f2dbdd6afd1363f89307b639228261e623b6707826ded68ac425)
def Claim_4d290e52a621 : Prop :=
  ‖((7 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((48528151) / 50000000 : ℝ) : ℂ) - (((6021183) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((31) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 74098d11ea2fc2c42d447526ea161ec2b72ddd54697778bfc8d3e6829716d14e)
theorem prove_Claim_4d290e52a621 : Claim_4d290e52a621 :=
  by
    unfold Claim_4d290e52a621
...
#rh_audit_axioms prove_Claim_4d290e52a621
