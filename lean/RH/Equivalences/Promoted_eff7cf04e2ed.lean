...
-- claim: zcb20k3-rot-n16 (eff7cf04e2ed541ba6d030493ab6c0e23515b3b776123953ecaa52761e66c6fd)
def Claim_eff7cf04e2ed : Prop :=
  ‖((16 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49251169) / 50000000 : ℝ) : ℂ) - (((3448417) / 20000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: ab7c0c9830f542d1ccda18a9cfeae3ef22c1d5925ff6fd911b23efadd496938a)
theorem prove_Claim_eff7cf04e2ed : Claim_eff7cf04e2ed :=
  by
    unfold Claim_eff7cf04e2ed
...
#rh_audit_axioms prove_Claim_eff7cf04e2ed
