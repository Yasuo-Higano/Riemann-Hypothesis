...
-- claim: zcb14k2-rot-n12 (f0921fec6e673505980eabc55b927aa3bfe170c1115b17bcd1e4844415ca78a2)
def Claim_f0921fec6e67 : Prop :=
  ‖((12 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((95214627) / 100000000 : ℝ) : ℂ) - (((15282137) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((29) / 20000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: c8ab2040a261f9f6b83b8ee11e24310a865b65fd6ae2e182adb6e3ec59ec6889)
theorem prove_Claim_f0921fec6e67 : Claim_f0921fec6e67 :=
  by
    unfold Claim_f0921fec6e67
...
#rh_audit_axioms prove_Claim_f0921fec6e67
