...
-- claim: auto-exp-eta-partial-30-t142-term-26-s1 (beabc9a0a9337e0403a9cea52a75ea0813f45086ee9cf365ebbe5fcda15ed406)
def Claim_beabc9a0a933 : Prop :=
  |Real.exp ((-81452419) / 100000000 : ℝ) - ((44284999) / 100000000 : ℝ)| ≤ ((131) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-exp-square, proof sha256: 5209f095db288b54d74d6c6344473b68fbc364ba9b90281e8f0f4f9b1ba88604)
theorem prove_Claim_beabc9a0a933 : Claim_beabc9a0a933 :=
  by
    unfold Claim_beabc9a0a933
    have hb : |Real.exp ((-81452419) / 200000000 : ℝ) - ((2661879) / 4000000 : ℝ)| ≤ ((39) / 20000000 : ℝ) := by
      have h := prove_Claim_2fe593757682
      unfold Claim_2fe593757682 at h
      exact h
...
#rh_audit_axioms prove_Claim_beabc9a0a933
