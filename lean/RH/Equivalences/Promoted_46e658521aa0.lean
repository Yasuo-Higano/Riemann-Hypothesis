...
-- claim: zcb4k2-rot-n5 (46e658521aa01c0cb98f8de8114490fdc66a67b9a080da19ff7c56b44066a3e1)
def Claim_46e658521aa0 : Prop :=
  ‖((5 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((6123947) / 6250000 : ℝ) : ℂ) - (((9991271) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((7) / 20000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: f7a989d2a778802977835f2a854a9345cebfa585a9f3971093e094f14ff781c7)
theorem prove_Claim_46e658521aa0 : Claim_46e658521aa0 :=
  by
    unfold Claim_46e658521aa0
...
#rh_audit_axioms prove_Claim_46e658521aa0
