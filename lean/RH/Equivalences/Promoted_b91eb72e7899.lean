...
-- claim: zl3b-rot-n32 (b91eb72e789947a979afb74ceaa71293c5e3ff38430f2ef949c56055cc6a72ea)
def Claim_b91eb72e7899 : Prop :=
  ‖((32 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 40 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99624881) / 100000000 : ℝ) : ℂ) - (((8653503) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 4bb956ab9fc05fbcd5297d6f53e375e59078deb672eed378c31df9c556736b85)
theorem prove_Claim_b91eb72e7899 : Claim_b91eb72e7899 :=
  by
    unfold Claim_b91eb72e7899
...
#rh_audit_axioms prove_Claim_b91eb72e7899
