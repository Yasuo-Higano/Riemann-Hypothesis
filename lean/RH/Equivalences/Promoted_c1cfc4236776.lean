...
-- claim: zcb24k2-rot-n11 (c1cfc42367762806f78b8345a3910e89cecc6094084a1d2a28731fb46b5b5a73)
def Claim_c1cfc4236776 : Prop :=
  ‖((11 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((95541419) / 100000000 : ℝ) : ℂ) - (((2952689) / 10000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((119) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: edd1e74ae9edece1ae638cfd92ad23592fcfa71dd220342470a5c4bf34a0007b)
theorem prove_Claim_c1cfc4236776 : Claim_c1cfc4236776 :=
  by
    unfold Claim_c1cfc4236776
...
#rh_audit_axioms prove_Claim_c1cfc4236776
