...
-- claim: zcb3k3-rot-n6 (ad16e6f1ffe404c8131714181123a5f2a97324392db522d8ebafac15fa07357e)
def Claim_ad16e6f1ffe4 : Prop :=
  ‖((6 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99373623) / 100000000 : ℝ) : ℂ) - (((5587553) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: b0983396a7654d09c37dd86078f3f6363e7d7016b3afb00d3359fb0ef4dd5902)
theorem prove_Claim_ad16e6f1ffe4 : Claim_ad16e6f1ffe4 :=
  by
    unfold Claim_ad16e6f1ffe4
...
#rh_audit_axioms prove_Claim_ad16e6f1ffe4
