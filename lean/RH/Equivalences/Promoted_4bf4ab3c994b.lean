...
-- claim: zcb0k3-rot-n6 (4bf4ab3c994b124224dbc5a532cec9465a1d13b45580c1ac7c2ca5c6a818f182)
def Claim_4bf4ab3c994b : Prop :=
  ‖((6 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99373623) / 100000000 : ℝ) : ℂ) - (((5587553) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: ac165f01ecc9526d35ae5ce27db54e86fd0510e1cdeadb33bea636bc3c9d3636)
theorem prove_Claim_4bf4ab3c994b : Claim_4bf4ab3c994b :=
  by
    unfold Claim_4bf4ab3c994b
...
#rh_audit_axioms prove_Claim_4bf4ab3c994b
