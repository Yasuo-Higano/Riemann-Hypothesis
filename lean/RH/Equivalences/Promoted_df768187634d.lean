...
-- claim: zcb902k6-rot-n21 (df768187634d000829ec08f68741b0ffabb3e4974911d24730b5f636b4a7656c)
def Claim_df768187634d : Prop :=
  ‖((21 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 320 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49997737) / 50000000 : ℝ) : ℂ) - (((951399) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 418edc99c733c0250f4b3e12ab4436e49a934226d7f891ba3c64e38757abf27b)
theorem prove_Claim_df768187634d : Claim_df768187634d :=
  by
    unfold Claim_df768187634d
...
#rh_audit_axioms prove_Claim_df768187634d
