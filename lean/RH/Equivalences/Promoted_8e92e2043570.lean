...
-- claim: zcb15k2-rot-n16 (8e92e2043570d78b5521932d68957dd6cf2994344d7dbdc91a4e7f4c533bd376)
def Claim_8e92e2043570 : Prop :=
  ‖((16 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((9405421) / 10000000 : ℝ) : ℂ) - (((1061491) / 3125000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((19) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 685137d9aeb81dc004a74224197d8d55d439b00d0d36d2a1096fa4dc04f6511b)
theorem prove_Claim_8e92e2043570 : Claim_8e92e2043570 :=
  by
    unfold Claim_8e92e2043570
...
#rh_audit_axioms prove_Claim_8e92e2043570
