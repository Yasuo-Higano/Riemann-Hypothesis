...
-- claim: zcb29k4-rot-n2 (de9aa21b683b06817ffd9c339c7289ad71713668f6747ebde4fb5e7380156f3b)
def Claim_de9aa21b683b : Prop :=
  ‖((2 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 32 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99976541) / 100000000 : ℝ) : ℂ) - (((541479) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 4a0a6deb86df0e269c95e8a54e4e65b88d42e1f05722fea70ba0d1b28eb4f30c)
theorem prove_Claim_de9aa21b683b : Claim_de9aa21b683b :=
  by
    unfold Claim_de9aa21b683b
...
#rh_audit_axioms prove_Claim_de9aa21b683b
