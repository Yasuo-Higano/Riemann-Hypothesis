...
-- claim: zl3b-rot-n11 (5f8ae2fddb58f8c120d3dcdebcf76a35661dea193f23f933104e8c71d25ae540)
def Claim_5f8ae2fddb58 : Prop :=
  ‖((11 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 40 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99820369) / 100000000 : ℝ) : ℂ) - (((5991149) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((19) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: acef59cd85218e757aa2f06a51ded76c0fabf4d28f1500fda6ef7fb8085e7097)
theorem prove_Claim_5f8ae2fddb58 : Claim_5f8ae2fddb58 :=
  by
    unfold Claim_5f8ae2fddb58
...
#rh_audit_axioms prove_Claim_5f8ae2fddb58
