...
-- claim: zcb14k2-rot-n11 (01a0abf3b1f00c57316deab3db6707327c6166bdb8493061499cdd10e623831d)
def Claim_01a0abf3b1f0 : Prop :=
  ‖((11 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((95541419) / 100000000 : ℝ) : ℂ) - (((2952689) / 10000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((119) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: cf92847d5bd9597adc68bd3644d96f723f72c8353eee0ee5ee282dcb7f6db4b1)
theorem prove_Claim_01a0abf3b1f0 : Claim_01a0abf3b1f0 :=
  by
    unfold Claim_01a0abf3b1f0
...
#rh_audit_axioms prove_Claim_01a0abf3b1f0
