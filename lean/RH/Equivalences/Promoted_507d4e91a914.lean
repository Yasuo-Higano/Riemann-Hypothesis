...
-- claim: zcb5k2-rot-n5 (507d4e91a91450f8dde5d88271009a99b7c791050578f8e01019968163cd7e38)
def Claim_507d4e91a914 : Prop :=
  ‖((5 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((6123947) / 6250000 : ℝ) : ℂ) - (((9991271) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((7) / 20000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 0d5f4ad78ab0831f58c726349cdcb050e907db473f9211aaadb3a69b0ca06b3e)
theorem prove_Claim_507d4e91a914 : Claim_507d4e91a914 :=
  by
    unfold Claim_507d4e91a914
...
#rh_audit_axioms prove_Claim_507d4e91a914
