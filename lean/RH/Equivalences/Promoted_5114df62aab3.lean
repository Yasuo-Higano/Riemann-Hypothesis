...
-- claim: zcb15k3-rot-n14 (5114df62aab3d7cfe19cc13e59ccf074ae8280b99f0789d7dde90208b252823a)
def Claim_5114df62aab3 : Prop :=
  ‖((14 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49321401) / 50000000 : ℝ) : ℂ) - (((8209713) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 12500000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 700a0c5410ec3ddc34c79fbde8301c1ffe750bfb54dd67300309d3fb6af230aa)
theorem prove_Claim_5114df62aab3 : Claim_5114df62aab3 :=
  by
    unfold Claim_5114df62aab3
...
#rh_audit_axioms prove_Claim_5114df62aab3
