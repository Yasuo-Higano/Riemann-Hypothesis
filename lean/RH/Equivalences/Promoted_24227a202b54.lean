...
-- claim: zcb25k3-rot-n2 (24227a202b5454670c93fe7daf0e93a49b598232c3672832ef27a933f763e615)
def Claim_24227a202b54 : Prop :=
  ‖((2 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((780517) / 781250 : ℝ) : ℂ) - (((866163) / 20000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: cab17f5c4dda500cc4992adc390b9cc0e28f884c57a952f12770d796342bfaf4)
theorem prove_Claim_24227a202b54 : Claim_24227a202b54 :=
  by
    unfold Claim_24227a202b54
...
#rh_audit_axioms prove_Claim_24227a202b54
