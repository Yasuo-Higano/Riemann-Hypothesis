...
-- claim: zcb16k3-rot-n16 (21160051d22f8bd3b80424c4244afa3a990928e449752a3df069ed8c6737821b)
def Claim_21160051d22f : Prop :=
  ‖((16 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49251169) / 50000000 : ℝ) : ℂ) - (((3448417) / 20000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 5e7bb1433edffb122043275d556e78545ddfb45ddd659d20a9503b7810d1bacf)
theorem prove_Claim_21160051d22f : Claim_21160051d22f :=
  by
    unfold Claim_21160051d22f
...
#rh_audit_axioms prove_Claim_21160051d22f
