...
-- claim: zcb11k2-rot-n4 (98867964a614aba05594c523e0c05942d3d230f12d1d3bd2182d1dcd803906b9)
def Claim_98867964a614 : Prop :=
  ‖((4 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49251169) / 50000000 : ℝ) : ℂ) - (((3448417) / 20000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: b5651ff3b682c4777ab2a66720e824e5a2026c551effb4a39bddafbfa5ad7592)
theorem prove_Claim_98867964a614 : Claim_98867964a614 :=
  by
    unfold Claim_98867964a614
...
#rh_audit_axioms prove_Claim_98867964a614
