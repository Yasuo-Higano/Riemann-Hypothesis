...
-- claim: zcb1k2-rot-n11 (cca108612bacc8775551b9b06ecc97ad6f10a420426e4ed867af5fa02bcf84b1)
def Claim_cca108612bac : Prop :=
  ‖((11 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((95541419) / 100000000 : ℝ) : ℂ) - (((2952689) / 10000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((119) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 82286975d9ea006c409f5f29bc261d81c6926cec8c34f42312fedc8edb4b607a)
theorem prove_Claim_cca108612bac : Claim_cca108612bac :=
  by
    unfold Claim_cca108612bac
...
#rh_audit_axioms prove_Claim_cca108612bac
