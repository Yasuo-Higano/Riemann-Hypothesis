...
-- claim: zcb0k3-rot-n2 (482a065b6d362f32175c0c3a62a44f5a12732388388d6bd1511b4a0d699868c8)
def Claim_482a065b6d36 : Prop :=
  ‖((2 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((780517) / 781250 : ℝ) : ℂ) - (((866163) / 20000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: b0a0168f6f9641ae2768eeb5efce6f49ae37908103d4da02266e69fe8e7d2711)
theorem prove_Claim_482a065b6d36 : Claim_482a065b6d36 :=
  by
    unfold Claim_482a065b6d36
...
#rh_audit_axioms prove_Claim_482a065b6d36
