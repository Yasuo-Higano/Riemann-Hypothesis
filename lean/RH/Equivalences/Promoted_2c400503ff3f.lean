...
-- claim: zcb0k2-rot-n9 (2c400503ff3fd093f35b5b656b2190c98b31da47f38b3e014ffcd713b4a5ac99)
def Claim_2c400503ff3f : Prop :=
  ‖((9 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((96251933) / 100000000 : ℝ) : ℂ) - (((27121309) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((127) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 0d04d188d98241023166c56a583588c7cc5e1bed6e7c0a709b4e68fc7a43a1ae)
theorem prove_Claim_2c400503ff3f : Claim_2c400503ff3f :=
  by
    unfold Claim_2c400503ff3f
...
#rh_audit_axioms prove_Claim_2c400503ff3f
