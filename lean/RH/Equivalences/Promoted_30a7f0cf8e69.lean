...
-- claim: zcb25k2-rot-n18 (30a7f0cf8e69df6bba606bc8de8c98202c2db68a32482dbb21e50212ccd58f86)
def Claim_30a7f0cf8e69 : Prop :=
  ‖((18 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((9354393) / 10000000 : ℝ) : ℂ) - (((138081) / 390625 : ℝ) : ℂ) * Complex.I)‖ ≤ ((127) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 07a12f87e4ec83fe20c700e1911877ae95fecc1867e99dec5e878c18daa9a336)
theorem prove_Claim_30a7f0cf8e69 : Claim_30a7f0cf8e69 :=
  by
    unfold Claim_30a7f0cf8e69
...
#rh_audit_axioms prove_Claim_30a7f0cf8e69
