...
-- claim: zcb22k2-rot-n8 (1626782eb625175e3a04be078b8d024fec52f4b109043f5c1e4cd09603057538)
def Claim_1626782eb625 : Prop :=
  ‖((8 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((12080099) / 12500000 : ℝ) : ℂ) - (((25701309) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((19) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 00ab0d89bbde6123bfd7ee78584a395af75be6e5984e205a6a951293886e3610)
theorem prove_Claim_1626782eb625 : Claim_1626782eb625 :=
  by
    unfold Claim_1626782eb625
...
#rh_audit_axioms prove_Claim_1626782eb625
