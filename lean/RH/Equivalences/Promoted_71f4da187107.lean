...
-- claim: zcb0k2-rot-n7 (71f4da18710761def045d98bf04ddfad1d746fb61dd4911d0a62dc0639dc6f24)
def Claim_71f4da187107 : Prop :=
  ‖((7 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((48528151) / 50000000 : ℝ) : ℂ) - (((6021183) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((31) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 07b0812fdae8ceef2c8337df9e40b7def0dc1d3c0ef0ad4f0ec0ee2ffe4613fe)
theorem prove_Claim_71f4da187107 : Claim_71f4da187107 :=
  by
    unfold Claim_71f4da187107
...
#rh_audit_axioms prove_Claim_71f4da187107
