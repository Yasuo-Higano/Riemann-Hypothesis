...
-- claim: auto-exp-eta-partial-30-t142-term-4 (346de506bf3699a7ad872f784347607d962626aee41e3196b7f53f6f73f278b1)
def Claim_346de506bf36 : Prop :=
  |Real.exp ((-34657359) / 50000000 : ℝ) - ((1) / 2 : ℝ)| ≤ ((13) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-exp-square, proof sha256: 7f7f3dc43ad31d89f32d6e648d1ba8538808088e96ddb37ee3fddeb8620d4185)
theorem prove_Claim_346de506bf36 : Claim_346de506bf36 :=
  by
    unfold Claim_346de506bf36
    have hb : |Real.exp ((-34657359) / 100000000 : ℝ) - ((35355339) / 50000000 : ℝ)| ≤ ((1) / 6250000 : ℝ) := by
      have h := prove_Claim_7ef2c87a5962
      unfold Claim_7ef2c87a5962 at h
      exact h
...
#rh_audit_axioms prove_Claim_346de506bf36
