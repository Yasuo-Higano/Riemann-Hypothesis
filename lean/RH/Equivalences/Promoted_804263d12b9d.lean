...
-- claim: zcb0k2-b-n8 (804263d12b9d7f11cd9a7c142c94e66802baefd5801d09e08813a18e537420d5)
def Claim_804263d12b9d : Prop :=
  ‖((8 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((-1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49578321) / 50000000 : ℝ) : ℂ) - (((-6479977) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: de43589985bbcdf0a29c31a23349a759bac50c2a6ab9ba736fa540399f442481)
theorem prove_Claim_804263d12b9d : Claim_804263d12b9d :=
  by
    unfold Claim_804263d12b9d
    ...
    have hcosi := prove_Claim_a974fd78e18c ((-1299651) / 10000000 : ℝ) ((49578321) / 50000000 : ℝ) 14 ((1) / 50000000 : ℝ) ((1) / 100000000 : ℝ)
      (by rw [abs_of_nonpos (by norm_num : ((-1299651) / 10000000 : ℝ) ≤ 0)]; norm_num)
      (by norm_num [Finset.sum_range_succ, Finset.sum_range_zero, Nat.factorial])
      (by rw [abs_of_nonpos (by norm_num : ((-1299651) / 10000000 : ℝ) ≤ 0)]; norm_num)
    ...
    rw [abs_of_nonneg (by norm_num : (0:ℝ) ≤ (1 : ℝ)), abs_of_nonneg (by norm_num : (0:ℝ) ≤ ((49578321) / 50000000 : ℝ)), abs_of_nonpos (by norm_num : ((-6479977) / 50000000 : ℝ) ≤ 0)] at hmain
...
#rh_audit_axioms prove_Claim_804263d12b9d
