...
-- claim: zl3ch-rot-n35 (1ffdc4f75228a2932eb0c750563c79f97e41acfa44d8b0572bf3de2c464054f2)
def Claim_1ffdc4f75228 : Prop :=
  ‖((35 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 40 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((19921049) / 20000000 : ℝ) : ℂ) - (((2219167) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((7) / 12500000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 9c108de38d28649faaea057a14767c0b657bcb98b812c48327d0e48f6a7ea861)
theorem prove_Claim_1ffdc4f75228 : Claim_1ffdc4f75228 :=
  by
    unfold Claim_1ffdc4f75228
...
#rh_audit_axioms prove_Claim_1ffdc4f75228
