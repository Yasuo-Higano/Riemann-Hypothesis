...
-- claim: zcb30k4-rot-n20 (9066c168dd6251cfc6cc4ee448947ae9965f085849b99b03432e1adef52b3d1e)
def Claim_9066c168dd62 : Prop :=
  ‖((20 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 160 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((12497809) / 12500000 : ℝ) : ℂ) - (((1872223) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((3) / 12500000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 872b5688c8b025b5d6cd1605107ce36ec663ab14b00b518598b7e38fa36f81ff)
theorem prove_Claim_9066c168dd62 : Claim_9066c168dd62 :=
  by
    unfold Claim_9066c168dd62
...
#rh_audit_axioms prove_Claim_9066c168dd62
