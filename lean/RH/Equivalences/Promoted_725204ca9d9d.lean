...
-- claim: zcb30k3-rot-n28 (725204ca9d9d25e31160dc4c6162508c1fdae4895945c3ee2b55ba813465818c)
def Claim_725204ca9d9d : Prop :=
  ‖((28 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 80 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49956633) / 50000000 : ℝ) : ℂ) - (((4164053) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((7) / 25000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: f9eb3f9439f2014141524e70862bc6f264ca8e55326873d758e6fd2c73fee6a2)
theorem prove_Claim_725204ca9d9d : Claim_725204ca9d9d :=
  by
    unfold Claim_725204ca9d9d
...
#rh_audit_axioms prove_Claim_725204ca9d9d
