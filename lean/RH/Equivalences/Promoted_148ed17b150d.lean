...
-- claim: zcb4k2-rot-n4 (148ed17b150d62787a2b578089301921e07185e49716c073401b70cc2cef2acf)
def Claim_148ed17b150d : Prop :=
  ‖((4 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49251169) / 50000000 : ℝ) : ℂ) - (((3448417) / 20000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 28d987f2db75ed8f6244b6467327090734e69b3d9b613ce0fe9f39a2a7ea4e81)
theorem prove_Claim_148ed17b150d : Claim_148ed17b150d :=
  by
    unfold Claim_148ed17b150d
...
#rh_audit_axioms prove_Claim_148ed17b150d
