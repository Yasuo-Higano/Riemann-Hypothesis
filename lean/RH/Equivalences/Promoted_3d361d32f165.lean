...
-- claim: zcb28k1-rot-n9 (3d361d32f165d30b55c2436c23ee538cf7e021ef43eae5aeeac3c6abdb38ab41)
def Claim_3d361d32f165 : Prop :=
  ‖((9 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 20 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((24849283) / 25000000 : ℝ) : ℂ) - (((274101) / 2500000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((3) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 4bb0bec2a2f69b4ae16d019043835f8e009f4d955761db8b09d9bcfc2ac9e648)
theorem prove_Claim_3d361d32f165 : Claim_3d361d32f165 :=
  by
    unfold Claim_3d361d32f165
...
#rh_audit_axioms prove_Claim_3d361d32f165
