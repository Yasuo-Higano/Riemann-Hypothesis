...
-- claim: zcb19k4-rot-n3 (725379d38015cc8da6de3b5d85d0679e4345821d044f759b6a01526e9d07d53e)
def Claim_725379d38015 : Prop :=
  ‖((3 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 32 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99941073) / 100000000 : ℝ) : ℂ) - (((3432489) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: bc48bbd3a0261bca778931de79cd08b609c7e931b070c4cf930e03307acbdb75)
theorem prove_Claim_725379d38015 : Claim_725379d38015 :=
  by
    unfold Claim_725379d38015
...
#rh_audit_axioms prove_Claim_725379d38015
