...
-- claim: zcb26k3-rot-n10 (ec71f053204f6df820c5a52503d162426bd48991dd3f682746f734f59a750db1)
def Claim_ec71f053204f : Prop :=
  ‖((10 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((98966259) / 100000000 : ℝ) : ℂ) - (((3585383) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 1250000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 510e2cee56e0c45e00eeab065910b25d3d93b50d6de427f5ffb78cfd501669af)
theorem prove_Claim_ec71f053204f : Claim_ec71f053204f :=
  by
    unfold Claim_ec71f053204f
...
#rh_audit_axioms prove_Claim_ec71f053204f
