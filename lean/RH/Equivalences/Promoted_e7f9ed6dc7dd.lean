...
-- claim: zcb902k6-rot-n17 (e7f9ed6dc7dd71d676dee698681d96eeef8471a20f6ee42b38c9bc1e9595fb10)
def Claim_e7f9ed6dc7dd : Prop :=
  ‖((17 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 320 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99996081) / 100000000 : ℝ) : ℂ) - (((885367) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: a12df179d2c1205beca9d9d188a811fcb93a31e8b58b59f52c81565ac8afa9e2)
theorem prove_Claim_e7f9ed6dc7dd : Claim_e7f9ed6dc7dd :=
  by
    unfold Claim_e7f9ed6dc7dd
...
#rh_audit_axioms prove_Claim_e7f9ed6dc7dd
