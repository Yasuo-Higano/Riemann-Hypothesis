...
-- claim: zcb7k2-rot-n9 (becb8eef55828a2ae16eca905dd9f6f8cd016582a55b457d0b10c10009bf33d5)
def Claim_becb8eef5582 : Prop :=
  ‖((9 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((96251933) / 100000000 : ℝ) : ℂ) - (((27121309) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((127) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: e69804fb526b0a47de22c1802a352c441e6d617e7417b2ae11dfb92afbd216e3)
theorem prove_Claim_becb8eef5582 : Claim_becb8eef5582 :=
  by
    unfold Claim_becb8eef5582
...
#rh_audit_axioms prove_Claim_becb8eef5582
