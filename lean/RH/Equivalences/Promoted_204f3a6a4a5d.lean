...
-- claim: zcb0k2-rot-n11 (204f3a6a4a5dc9a77d8e96cb81b5fbc9e69efc23678b1b79e0b0b587ccfb3337)
def Claim_204f3a6a4a5d : Prop :=
  ‖((11 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((95541419) / 100000000 : ℝ) : ℂ) - (((2952689) / 10000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((119) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 52fe2b9ed953935910b62e51404fe32d8edccc8e864e04aee5a101c0904333f0)
theorem prove_Claim_204f3a6a4a5d : Claim_204f3a6a4a5d :=
  by
    unfold Claim_204f3a6a4a5d
...
#rh_audit_axioms prove_Claim_204f3a6a4a5d
