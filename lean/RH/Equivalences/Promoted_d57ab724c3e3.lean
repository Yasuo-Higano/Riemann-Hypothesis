...
-- claim: zcb2k3-rot-n3 (d57ab724c3e35ff44cf0b41cce751a7418cecd6270b2c3508fbeccf04034da61)
def Claim_d57ab724c3e3 : Prop :=
  ‖((3 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((2494109) / 2500000 : ℝ) : ℂ) - (((6860933) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 4ba29a6a94b804186d63c715cd4042f9d74e9e11e4fb14ce734995edf94b61aa)
theorem prove_Claim_d57ab724c3e3 : Claim_d57ab724c3e3 :=
  by
    unfold Claim_d57ab724c3e3
...
#rh_audit_axioms prove_Claim_d57ab724c3e3
