...
-- claim: zcb26k3-rot-n4 (083749d6fc9220482bf873f2cebe35a0e4a5d8089080db9a7e32328945125a0b)
def Claim_083749d6fc92 : Prop :=
  ‖((4 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99624881) / 100000000 : ℝ) : ℂ) - (((8653503) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 2957e8b2005d10abe065c3213948602710fb0f54a6bc5930d44883fc1b55844b)
theorem prove_Claim_083749d6fc92 : Claim_083749d6fc92 :=
  by
    unfold Claim_083749d6fc92
...
#rh_audit_axioms prove_Claim_083749d6fc92
