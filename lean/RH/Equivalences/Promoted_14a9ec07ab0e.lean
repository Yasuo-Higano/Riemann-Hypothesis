...
-- claim: zcb23k2-rot-n13 (14a9ec07ab0e733c94bd344135dd678832c8e40ebdd960d5477ea4500fa64bb9)
def Claim_14a9ec07ab0e : Prop :=
  ‖((13 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((94904061) / 100000000 : ℝ) : ℂ) - (((31515379) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((13) / 20000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 859fd9fbebf014ee4eac270360a66a8dcf7e3883a07db955349d0fcc868a1fec)
theorem prove_Claim_14a9ec07ab0e : Claim_14a9ec07ab0e :=
  by
    unfold Claim_14a9ec07ab0e
...
#rh_audit_axioms prove_Claim_14a9ec07ab0e
