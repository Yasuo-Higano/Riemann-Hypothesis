...
-- claim: zcb24k2-rot-n13 (f74722865c1abf81b096e9b89b90b7d41f7a1c4361c6ddde77507267916dd07f)
def Claim_f74722865c1a : Prop :=
  ‖((13 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((94904061) / 100000000 : ℝ) : ℂ) - (((31515379) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((13) / 20000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 40c5b47de8dbefcbba9b09ff5a5804b5f3c9076a4130978892193bf32eb8c200)
theorem prove_Claim_f74722865c1a : Claim_f74722865c1a :=
  by
    unfold Claim_f74722865c1a
...
#rh_audit_axioms prove_Claim_f74722865c1a
