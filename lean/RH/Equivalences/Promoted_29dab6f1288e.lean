...
-- claim: zcb24k2-rot-n16 (29dab6f1288ecf8a673ee94313ff30bf257599a975678662e6736d6ffc29f4b2)
def Claim_29dab6f1288e : Prop :=
  ‖((16 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((9405421) / 10000000 : ℝ) : ℂ) - (((1061491) / 3125000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((19) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 463d06caa7403863ff42829b58cc18c527d7c4b0700a8ba2eb67e6d502745d8a)
theorem prove_Claim_29dab6f1288e : Claim_29dab6f1288e :=
  by
    unfold Claim_29dab6f1288e
...
#rh_audit_axioms prove_Claim_29dab6f1288e
