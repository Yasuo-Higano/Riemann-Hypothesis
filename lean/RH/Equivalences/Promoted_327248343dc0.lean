...
-- claim: zcb26k4-rot-n5 (327248343dc0dff0d6c396b062ad007bdf6c13196c0917bbdeb4ed994ea6100c)
def Claim_327248343dc0 : Prop :=
  ‖((5 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 32 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((24968387) / 25000000 : ℝ) : ℂ) - (((2513687) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((11) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 340cf861140e363b69f738c71bdfd0cc5e9b45f45d2a402b2b89fe3b37d5c5aa)
theorem prove_Claim_327248343dc0 : Claim_327248343dc0 :=
  by
    unfold Claim_327248343dc0
...
#rh_audit_axioms prove_Claim_327248343dc0
