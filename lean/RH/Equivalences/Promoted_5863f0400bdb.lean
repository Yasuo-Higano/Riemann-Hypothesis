...
-- claim: zcb8k2-rot-n5 (5863f0400bdb909adb73b3a54cd5e60758a5beb2086a683595ea0dc848fceb63)
def Claim_5863f0400bdb : Prop :=
  ‖((5 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((6123947) / 6250000 : ℝ) : ℂ) - (((9991271) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((7) / 20000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 69357a1b133c70405c584552f6149b41864b783c198464415ade9beb2158eed1)
theorem prove_Claim_5863f0400bdb : Claim_5863f0400bdb :=
  by
    unfold Claim_5863f0400bdb
...
#rh_audit_axioms prove_Claim_5863f0400bdb
