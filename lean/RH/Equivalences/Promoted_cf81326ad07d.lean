...
-- claim: zcb13k2-rot-n9 (cf81326ad07d3957629ca82609fd3e5ef098cb3dbe12f3046efb648ac7a73b5c)
def Claim_cf81326ad07d : Prop :=
  ‖((9 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((96251933) / 100000000 : ℝ) : ℂ) - (((27121309) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((127) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 7a8902248e95122b8636d774862d429d3d72f6c9715b20ae7ce4a7788573abdc)
theorem prove_Claim_cf81326ad07d : Claim_cf81326ad07d :=
  by
    unfold Claim_cf81326ad07d
...
#rh_audit_axioms prove_Claim_cf81326ad07d
