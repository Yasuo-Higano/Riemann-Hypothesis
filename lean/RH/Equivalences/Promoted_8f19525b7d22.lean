...
-- claim: zcb22k2-rot-n9 (8f19525b7d2285beceaa3bd6b409c64c36f3a0a6dc0f1a49a9cc09a67dfff63d)
def Claim_8f19525b7d22 : Prop :=
  ‖((9 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((96251933) / 100000000 : ℝ) : ℂ) - (((27121309) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((127) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: e8e0470dfcff01be5bd801249af777f2a98d507539bbdb348cc4eaa4f2ab1df2)
theorem prove_Claim_8f19525b7d22 : Claim_8f19525b7d22 :=
  by
    unfold Claim_8f19525b7d22
...
#rh_audit_axioms prove_Claim_8f19525b7d22
