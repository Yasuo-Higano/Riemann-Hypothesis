...
-- claim: zcb29k6-rot-n16 (f7da32090fb51795dae547f2b30d0c98b02904e0a0252e1ef71cd84f5e19e5e9)
def Claim_f7da32090fb5 : Prop :=
  ‖((16 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 128 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99976541) / 100000000 : ℝ) : ℂ) - (((541479) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 9b25474e22a0fe46d000bbf66fc533580c95c8453bbcce6c6be48b402832ded1)
theorem prove_Claim_f7da32090fb5 : Claim_f7da32090fb5 :=
  by
    unfold Claim_f7da32090fb5
    ...
    have hv : |((1) / 128 : ℝ) * Real.log ((16 : ℕ) : ℝ) - ((433217) / 20000000 : ℝ)| ≤ ((1) / 50000000 : ℝ) :=
      hssb (Real.log ((16 : ℕ) : ℝ)) ((1386294361) / 500000000 : ℝ) ((1201) / 1000000000000 : ℝ) (((1) / 128 : ℝ)) ((433217) / 20000000 : ℝ) ((1) / 100000000 : ℝ) ((1) / 50000000 : ℝ) hlog
        (by rw [abs_le]; constructor <;> norm_num)
    ...
    have hmain := prove_Claim_fe51a39a688e 16 ((0 : ℝ)) (((1) / 128 : ℝ)) (0 : ℝ) (1 : ℝ) ((3) / 100000000 : ℝ) ((1) / 100000000 : ℝ) ((433217) / 20000000 : ℝ) ((99976541) / 100000000 : ℝ) ((3) / 100000000 : ℝ) ((541479) / 25000000 : ℝ) ((3) / 100000000 : ℝ) ((1) / 50000000 : ℝ)
    ...
    calc ‖((16 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 128 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99976541) / 100000000 : ℝ) : ℂ) - (((541479) / 25000000 : ℝ) : ℂ) * Complex.I)‖
...
#rh_audit_axioms prove_Claim_f7da32090fb5
