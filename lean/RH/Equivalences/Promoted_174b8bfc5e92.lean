...
-- claim: zcb16k3-rot-n6 (174b8bfc5e92cf3ab5dbb9bdf573ee92492bdab592841f3cd3dde2a585a0c61c)
def Claim_174b8bfc5e92 : Prop :=
  ‖((6 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99373623) / 100000000 : ℝ) : ℂ) - (((5587553) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: f06feac0f76d074fc4d83614acbabddad820f6ffab0502a9ed3726620e0ba711)
theorem prove_Claim_174b8bfc5e92 : Claim_174b8bfc5e92 :=
  by
    unfold Claim_174b8bfc5e92
...
#rh_audit_axioms prove_Claim_174b8bfc5e92
