...
-- claim: zcb1k3-rot-n3 (191d999419450eb6cf21623f0d6db6a1c517b28b0074db3f8379f449465634c6)
def Claim_191d99941945 : Prop :=
  ‖((3 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((2494109) / 2500000 : ℝ) : ℂ) - (((6860933) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: e21bc2df3d9bf1c179504c01bbbf0beb1921f710b139bb081d1b636402a018bb)
theorem prove_Claim_191d99941945 : Claim_191d99941945 :=
  by
    unfold Claim_191d99941945
...
#rh_audit_axioms prove_Claim_191d99941945
