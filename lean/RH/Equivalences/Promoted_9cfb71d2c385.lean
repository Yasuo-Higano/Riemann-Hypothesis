...
-- claim: zcb0k2-b-n3 (9cfb71d2c385875629461d5687d9a2ac456894505d36bb5a2c3c822ef1c53762)
def Claim_9cfb71d2c385 : Prop :=
  ‖((3 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((-1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((2494109) / 2500000 : ℝ) : ℂ) - (((-6860933) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 4f1ef13780f6731671f03a4115b670a708e57aaeaab73f84beb22f97bd9e355e)
theorem prove_Claim_9cfb71d2c385 : Claim_9cfb71d2c385 :=
  by
    unfold Claim_9cfb71d2c385
    ...
    have hcosi := prove_Claim_a974fd78e18c ((-6866327) / 100000000 : ℝ) ((2494109) / 2500000 : ℝ) 14 ((1) / 50000000 : ℝ) ((1) / 100000000 : ℝ)
      (by rw [abs_of_nonpos (by norm_num : ((-6866327) / 100000000 : ℝ) ≤ 0)]; norm_num)
      (by norm_num [Finset.sum_range_succ, Finset.sum_range_zero, Nat.factorial])
      (by rw [abs_of_nonpos (by norm_num : ((-6866327) / 100000000 : ℝ) ≤ 0)]; norm_num)
    ...
    rw [abs_of_nonneg (by norm_num : (0:ℝ) ≤ (1 : ℝ)), abs_of_nonneg (by norm_num : (0:ℝ) ≤ ((2494109) / 2500000 : ℝ)), abs_of_nonpos (by norm_num : ((-6860933) / 100000000 : ℝ) ≤ 0)] at hmain
...
#rh_audit_axioms prove_Claim_9cfb71d2c385
