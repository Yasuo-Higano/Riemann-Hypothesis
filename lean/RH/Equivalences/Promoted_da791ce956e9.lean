...
-- claim: zcb21k3-rot-n16 (da791ce956e91ed65811a8a3f4569b8e80242df146e2f0c80218be2e8cea96b5)
def Claim_da791ce956e9 : Prop :=
  ‖((16 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49251169) / 50000000 : ℝ) : ℂ) - (((3448417) / 20000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 79ab5ce912e2d30b87deb250fc53129b1450298d401cb7ce4ee80ef3585b22c5)
theorem prove_Claim_da791ce956e9 : Claim_da791ce956e9 :=
  by
    unfold Claim_da791ce956e9
...
#rh_audit_axioms prove_Claim_da791ce956e9
