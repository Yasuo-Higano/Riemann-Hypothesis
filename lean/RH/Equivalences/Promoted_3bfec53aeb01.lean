...
-- claim: zcb0k3-b-n5 (3bfec53aeb0130b3a785d0ccbea18b2f21c67f71b84fb49414e0033f896556fa)
def Claim_3bfec53aeb01 : Prop :=
  ‖((5 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((-1) / 32 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((24968387) / 25000000 : ℝ) : ℂ) - (((-2513687) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((11) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 0f1ad25121ad64eb36de62b48c9c4ce8ba3e7bd6cdcd8524ddeccb47daf17fa5)
theorem prove_Claim_3bfec53aeb01 : Claim_3bfec53aeb01 :=
  by
    unfold Claim_3bfec53aeb01
    ...
    have hcosi := prove_Claim_a974fd78e18c ((-2514747) / 50000000 : ℝ) ((24968387) / 25000000 : ℝ) 14 ((1) / 50000000 : ℝ) ((1) / 100000000 : ℝ)
      (by rw [abs_of_nonpos (by norm_num : ((-2514747) / 50000000 : ℝ) ≤ 0)]; norm_num)
      (by norm_num [Finset.sum_range_succ, Finset.sum_range_zero, Nat.factorial])
      (by rw [abs_of_nonpos (by norm_num : ((-2514747) / 50000000 : ℝ) ≤ 0)]; norm_num)
    ...
    rw [abs_of_nonneg (by norm_num : (0:ℝ) ≤ (1 : ℝ)), abs_of_nonneg (by norm_num : (0:ℝ) ≤ ((24968387) / 25000000 : ℝ)), abs_of_nonpos (by norm_num : ((-2513687) / 50000000 : ℝ) ≤ 0)] at hmain
...
#rh_audit_axioms prove_Claim_3bfec53aeb01
