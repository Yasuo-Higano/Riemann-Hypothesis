...
-- claim: zcb23k2-rot-n2 (81496fab50e4b2c804b0caa5072d0974bd065737fd74853787b4611274241f7f)
def Claim_81496fab50e4 : Prop :=
  ‖((2 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99624881) / 100000000 : ℝ) : ℂ) - (((8653503) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 1373bc07949469492bad51adb85cc59a87ebf902f863b81ad40288a43e5f7af6)
theorem prove_Claim_81496fab50e4 : Claim_81496fab50e4 :=
  by
    unfold Claim_81496fab50e4
...
#rh_audit_axioms prove_Claim_81496fab50e4
