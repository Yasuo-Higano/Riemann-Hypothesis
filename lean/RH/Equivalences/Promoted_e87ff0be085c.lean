...
-- claim: zcb0k2-b-n2 (e87ff0be085cdffb21aeaf2297966b9de6a9370ca7ba5275e56a41be16e8dc18)
def Claim_e87ff0be085c : Prop :=
  ‖((2 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((-1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((780517) / 781250 : ℝ) : ℂ) - (((-866163) / 20000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 0c069d02f68a9d9b04a5ec9f17f998fc1c5b222c732adbfdf9ac5959862f0275)
theorem prove_Claim_e87ff0be085c : Claim_e87ff0be085c :=
  by
    unfold Claim_e87ff0be085c
...
#rh_audit_axioms prove_Claim_e87ff0be085c
