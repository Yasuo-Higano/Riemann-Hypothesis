...
-- claim: zcb20k3-rot-n12 (45469a935c4a3937c2cff9a6c648bc292ced4bf6da9bb5cfa0fdf4f0c51b2190)
def Claim_45469a935c4a : Prop :=
  ‖((12 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49398207) / 50000000 : ℝ) : ℂ) - (((1933539) / 12500000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 1250000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 12a3a793749ba07784f214af9a94261db9f1f6f915da3342d9f0cd63e640f408)
theorem prove_Claim_45469a935c4a : Claim_45469a935c4a :=
  by
    unfold Claim_45469a935c4a
...
#rh_audit_axioms prove_Claim_45469a935c4a
