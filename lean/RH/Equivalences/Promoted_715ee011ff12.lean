...
-- claim: zcb99k0-rot-n3 (715ee011ff1252d4f6bbc2449d134b6823b2de0eb0f36ec5d10768d76955dcdd)
def Claim_715ee011ff12 : Prop :=
  ‖((3 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 64 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99985267) / 100000000 : ℝ) : ℂ) - (((858249) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: c7776ba53be9f0d1d410a1a656c1f94f421cd3221731e7d53b3db0ccf9ecfb24)
theorem prove_Claim_715ee011ff12 : Claim_715ee011ff12 :=
  by
    unfold Claim_715ee011ff12
...
#rh_audit_axioms prove_Claim_715ee011ff12
