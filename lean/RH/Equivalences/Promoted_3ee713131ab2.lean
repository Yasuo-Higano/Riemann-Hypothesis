...
-- claim: zcb29k4-rot-n8 (3ee713131ab255871cd34514cce0f045d87e76267f1d911ba35dfdc974ba7ee2)
def Claim_3ee713131ab2 : Prop :=
  ‖((8 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 32 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49894469) / 50000000 : ℝ) : ℂ) - (((6493683) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 4850dca3a091f1ca0e44ffab5507fcfdf1e8da8d86e78e9902caaf7825550f1c)
theorem prove_Claim_3ee713131ab2 : Claim_3ee713131ab2 :=
  by
    unfold Claim_3ee713131ab2
...
#rh_audit_axioms prove_Claim_3ee713131ab2
