...
-- claim: zc-b28-c4-cell-j5 (780d523249adc834a93aaae48e8d1f112f42fb4aa7b50b591b4f8cd8447e1d9b)
def Claim_780d523249ad : Prop :=
  ∀ s : ℂ, ((1951) / 3200 : ℝ) ≤ s.re → s.re ≤ ((989) / 1600 : ℝ) → ((561) / 40 : ℝ) ≤ s.im → s.im ≤ ((449) / 32 : ℝ) → RH.dirichletEtaEntire s ≠ 0

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-eta-grid, proof sha256: 10ca18b4f451a3cbcc167e4a7221656784cd92e2f79caa8568077015beb35d12)
theorem prove_Claim_780d523249ad : Claim_780d523249ad :=
  by
    unfold Claim_780d523249ad
    ...
    have cell5 : ∀ s : ℂ, ((1951) / 3200 : ℝ) ≤ s.re → s.re ≤ ((989) / 1600 : ℝ) → ((561) / 40 : ℝ) ≤ s.im → s.im ≤ ((449) / 32 : ℝ) → RH.dirichletEtaEntire s ≠ 0 := by
      ...
      intro s h1 h2 h3 h4
      have hb0 : ‖s‖ ≤ ((2809) / 200 : ℝ) := by
        apply pnri _ (((989) / 1600 : ℝ) + 0) (((449) / 32 : ℝ)) _ ?_ ?_ (by norm_num) (by norm_num)
        · rw [abs_le]
          constructor <;> linarith
        · rw [abs_le]
          constructor <;> linarith
      have hb1 : ‖s + 1‖ ≤ ((35311) / 2500 : ℝ) := by
        apply pnri _ (((989) / 1600 : ℝ) + 1) (((449) / 32 : ℝ)) _ ?_ ?_ (by norm_num) (by norm_num)
      ...
      have hb2 : ‖s + 2‖ ≤ ((8921) / 625 : ℝ) := by
        apply pnri _ (((989) / 1600 : ℝ) + 2) (((449) / 32 : ℝ)) _ ?_ ?_ (by norm_num) (by norm_num)
        · simp only [Complex.add_re, Complex.one_re, Complex.re_ofNat]
          rw [abs_le]
          constructor <;> linarith
        · simp only [Complex.add_im, Complex.one_im, Complex.im_ofNat]
      ...
      have hb3 : ‖s + 3‖ ≤ ((18113) / 1250 : ℝ) := by
        apply pnri _ (((989) / 1600 : ℝ) + 3) (((449) / 32 : ℝ)) _ ?_ ?_ (by norm_num) (by norm_num)
        · simp only [Complex.add_re, Complex.one_re, Complex.re_ofNat]
          rw [abs_le]
          constructor <;> linarith
        · simp only [Complex.add_im, Complex.one_im, Complex.im_ofNat]
          rw [abs_le]
          constructor <;> linarith
      have hE := punif s 30 ((2809) / 200 : ℝ) ((35311) / 2500 : ℝ) ((8921) / 625 : ℝ) ((18113) / 1250 : ℝ) ((27943) / 1250000 : ℝ)
      ...
      have hd : ‖s - ((((39) / 64 : ℝ) : ℂ) + (((4489) / 320 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9293) / 1000000 : ℝ) := by
      ...
      have hlb : ((32829) / 125000 : ℝ) ≤ ‖((((38431) / 200000 : ℝ) : ℂ) + (((-35807) / 200000 : ℝ) : ℂ) * Complex.I)‖ := by
        ...
        norm_num [Complex.normSq_apply, Complex.add_re, Complex.add_im, Complex.sub_re,
            Complex.sub_im, Complex.mul_re, Complex.mul_im, Complex.I_re, Complex.I_im,
            Complex.ofReal_re, Complex.ofReal_im]
      exact pnzc (RH.dirichletEtaEntire s) ((∑ n ∈ Finset.range 30, (-1 : ℂ) ^ (n + 1) * ((n : ℕ) : ℂ) ^ (-(s))) + (-1 : ℂ) ^ (30 + 1) * (((30 : ℕ) : ℂ) ^ (-(s)) / 2 + (((30 : ℕ) : ℂ) ^ (-(s)) - (((30 + 1 : ℕ)) : ℂ) ^ (-(s))) / 4 + (((30 : ℕ) : ℂ) ^ (-(s)) - 2 * (((30 + 1 : ℕ)) : ℂ) ^ (-(s)) + (((30 + 2 : ℕ)) : ℂ) ^ (-(s))) / 8 + (((30 : ℕ) : ℂ) ^ (-(s)) - 3 * (((30 + 1 : ℕ)) : ℂ) ^ (-(s)) + 3 * (((30 + 2 : ℕ)) : ℂ) ^ (-(s)) - (((30 + 3 : ℕ)) : ℂ) ^ (-(s))) / 16)) ((∑ n ∈ Finset.range 30, (-1 : ℂ) ^ (n + 1) * ((n : ℕ) : ℂ) ^ (-((((39) / 64 : ℝ) : ℂ) + (((4489) / 320 : ℝ) : ℂ) * Complex.I))) + (-1 : ℂ) ^ (30 + 1) * (((30 : ℕ) : ℂ) ^ (-((((39) / 64 : ℝ) : ℂ) + (((4489) / 320 : ℝ) : ℂ) * Complex.I)) / 2 + (((30 : ℕ) : ℂ) ^ (-((((39) / 64 : ℝ) : ℂ) + (((4489) / 320 : ℝ) : ℂ) * Complex.I)) - (((30 + 1 : ℕ)) : ℂ) ^ (-((((39) / 64 : ℝ) : ℂ) + (((4489) / 320 : ℝ) : ℂ) * Complex.I))) / 4 + (((30 : ℕ) : ℂ) ^ (-((((39) / 64 : ℝ) : ℂ) + (((4489) / 320 : ℝ) : ℂ) * Complex.I)) - 2 * (((30 + 1 : ℕ)) : ℂ) ^ (-((((39) / 64 : ℝ) : ℂ) + (((4489) / 320 : ℝ) : ℂ) * Complex.I)) + (((30 + 2 : ℕ)) : ℂ) ^ (-((((39) / 64 : ℝ) : ℂ) + (((4489) / 320 : ℝ) : ℂ) * Complex.I))) / 8 + (((30 : ℕ) : ℂ) ^ (-((((39) / 64 : ℝ) : ℂ) + (((4489) / 320 : ℝ) : ℂ) * Complex.I)) - 3 * (((30 + 1 : ℕ)) : ℂ) ^ (-((((39) / 64 : ℝ) : ℂ) + (((4489) / 320 : ℝ) : ℂ) * Complex.I)) + 3 * (((30 + 2 : ℕ)) : ℂ) ^ (-((((39) / 64 : ℝ) : ℂ) + (((4489) / 320 : ℝ) : ℂ) * Complex.I)) - (((30 + 3 : ℕ)) : ℂ) ^ (-((((39) / 64 : ℝ) : ℂ) + (((4489) / 320 : ℝ) : ℂ) * Complex.I))) / 16)) ((((38431) / 200000 : ℝ) : ℂ) + (((-35807) / 200000 : ℝ) : ℂ) * Complex.I) ((27943) / 1250000 : ℝ) ((188073) / 1000000 : ℝ) ((498213) / 100000000 : ℝ) ((32829) / 125000 : ℝ) hE hLip hW hlb (by norm_num)
    intro s h1 h2 h3 h4
    exact cell5 s h1 h2 h3 h4
-- END UNTRUSTED PROOF

#rh_audit_axioms prove_Claim_780d523249ad
