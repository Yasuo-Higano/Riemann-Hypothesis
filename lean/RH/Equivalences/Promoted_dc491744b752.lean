...
-- claim: zcb25k2-rot-n4 (dc491744b7524b1a57789accbadab2639b930b3fa9ec0efa37e58fe281b0873d)
def Claim_dc491744b752 : Prop :=
  ‖((4 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49251169) / 50000000 : ℝ) : ℂ) - (((3448417) / 20000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: a3963e35fc626f98e4a128d6c34b9d3e01fab4dda188d18200161b49b867d4b0)
theorem prove_Claim_dc491744b752 : Claim_dc491744b752 :=
  by
    unfold Claim_dc491744b752
...
#rh_audit_axioms prove_Claim_dc491744b752
