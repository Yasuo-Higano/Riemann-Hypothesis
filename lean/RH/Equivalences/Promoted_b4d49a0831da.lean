...
-- claim: zcb28k4-rot-n32 (b4d49a0831daa5e7bb08d62489e4b71e9df46219fb1ef40ad664bfaf36598b98)
def Claim_b4d49a0831da : Prop :=
  ‖((32 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 160 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99976541) / 100000000 : ℝ) : ℂ) - (((541479) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: e2226b048bef10ce5261cbec00821751d7f818cd204df28f6ab04270f12f4848)
theorem prove_Claim_b4d49a0831da : Claim_b4d49a0831da :=
  by
    unfold Claim_b4d49a0831da
    ...
    have hv : |((1) / 160 : ℝ) * Real.log ((32 : ℕ) : ℝ) - ((433217) / 20000000 : ℝ)| ≤ ((1) / 50000000 : ℝ) :=
      hssb (Real.log ((32 : ℕ) : ℝ)) ((1386294361) / 400000000 : ℝ) ((1501) / 1000000000000 : ℝ) (((1) / 160 : ℝ)) ((433217) / 20000000 : ℝ) ((1) / 100000000 : ℝ) ((1) / 50000000 : ℝ) hlog
        (by rw [abs_le]; constructor <;> norm_num)
    ...
    have hmain := prove_Claim_fe51a39a688e 32 ((0 : ℝ)) (((1) / 160 : ℝ)) (0 : ℝ) (1 : ℝ) ((3) / 100000000 : ℝ) ((1) / 100000000 : ℝ) ((433217) / 20000000 : ℝ) ((99976541) / 100000000 : ℝ) ((3) / 100000000 : ℝ) ((541479) / 25000000 : ℝ) ((3) / 100000000 : ℝ) ((1) / 50000000 : ℝ)
    ...
    calc ‖((32 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 160 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99976541) / 100000000 : ℝ) : ℂ) - (((541479) / 25000000 : ℝ) : ℂ) * Complex.I)‖
...
#rh_audit_axioms prove_Claim_b4d49a0831da
