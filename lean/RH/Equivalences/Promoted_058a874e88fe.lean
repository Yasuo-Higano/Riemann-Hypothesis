...
-- claim: zcb30k2-rot-n25 (058a874e88fe3ba0449b41a114cb2bd839305387a4cad5f34d0048a3b1bbf1e5)
def Claim_058a874e88fe : Prop :=
  ‖((25 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 40 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((24919097) / 25000000 : ℝ) : ℂ) - (((803851) / 10000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 2000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 888bdae4fe7bc3fd3e8130395cde62849d6232c7281d8e5fea345f87f78c990f)
theorem prove_Claim_058a874e88fe : Claim_058a874e88fe :=
  by
    unfold Claim_058a874e88fe
...
#rh_audit_axioms prove_Claim_058a874e88fe
