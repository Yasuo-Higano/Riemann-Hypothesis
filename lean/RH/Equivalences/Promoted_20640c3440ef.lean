...
-- claim: zcb29k4-rot-n13 (20640c3440ef6777892f01d68e2ef4cd97e64d6d518dab70974dd584ee6394b2)
def Claim_20640c3440ef : Prop :=
  ‖((13 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 32 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99678933) / 100000000 : ℝ) : ℂ) - (((8006887) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((7) / 25000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 62e26bb02a37f957b984dcd3bdace676daa55d7b3f9aac934c8c15079a6d1cd0)
theorem prove_Claim_20640c3440ef : Claim_20640c3440ef :=
  by
    unfold Claim_20640c3440ef
...
#rh_audit_axioms prove_Claim_20640c3440ef
