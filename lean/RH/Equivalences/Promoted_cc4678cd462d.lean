...
-- claim: zcb99k0-rot-n4 (cc4678cd462dfd1c85c09362add21c2e54ec61de1baae704c3b4a9c766225ef0)
def Claim_cc4678cd462d : Prop :=
  ‖((4 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 64 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99976541) / 100000000 : ℝ) : ℂ) - (((541479) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 1800e0ba6219106f16548c1ad85ee711d1f0b0072912352acb5c61582aae1b95)
theorem prove_Claim_cc4678cd462d : Claim_cc4678cd462d :=
  by
    unfold Claim_cc4678cd462d
    ...
    have hv : |((1) / 64 : ℝ) * Real.log ((4 : ℕ) : ℝ) - ((433217) / 20000000 : ℝ)| ≤ ((1) / 50000000 : ℝ) :=
      hssb (Real.log ((4 : ℕ) : ℝ)) ((1386294361) / 1000000000 : ℝ) ((601) / 1000000000000 : ℝ) (((1) / 64 : ℝ)) ((433217) / 20000000 : ℝ) ((1) / 100000000 : ℝ) ((1) / 50000000 : ℝ) hlog
        (by rw [abs_le]; constructor <;> norm_num)
    ...
    have hmain := prove_Claim_fe51a39a688e 4 ((0 : ℝ)) (((1) / 64 : ℝ)) (0 : ℝ) (1 : ℝ) ((3) / 100000000 : ℝ) ((1) / 100000000 : ℝ) ((433217) / 20000000 : ℝ) ((99976541) / 100000000 : ℝ) ((3) / 100000000 : ℝ) ((541479) / 25000000 : ℝ) ((3) / 100000000 : ℝ) ((1) / 50000000 : ℝ)
    ...
    calc ‖((4 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 64 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99976541) / 100000000 : ℝ) : ℂ) - (((541479) / 25000000 : ℝ) : ℂ) * Complex.I)‖
...
#rh_audit_axioms prove_Claim_cc4678cd462d
