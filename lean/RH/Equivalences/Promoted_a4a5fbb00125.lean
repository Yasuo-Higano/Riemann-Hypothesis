...
-- claim: zcb10k2-rot-n5 (a4a5fbb0012541fc0ce12fd18ea71601995d795bbe2e746a653c70a23ae5c041)
def Claim_a4a5fbb00125 : Prop :=
  ‖((5 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((6123947) / 6250000 : ℝ) : ℂ) - (((9991271) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((7) / 20000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 73ee94bb0889bd744195cc71e03596344dfe1dd643635f0d598bf7bc5b125dec)
theorem prove_Claim_a4a5fbb00125 : Claim_a4a5fbb00125 :=
  by
    unfold Claim_a4a5fbb00125
...
#rh_audit_axioms prove_Claim_a4a5fbb00125
