...
-- claim: zcb22k2-rot-n12 (267d2606048870852d9006c7ab79ac18fd8242a29ee11638656a1519f78c3d79)
def Claim_267d26060488 : Prop :=
  ‖((12 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((95214627) / 100000000 : ℝ) : ℂ) - (((15282137) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((29) / 20000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: e918684591c9d2327d7c6684d6df06de9a322fa9ff647555ed7d09ac4e4b01fd)
theorem prove_Claim_267d26060488 : Claim_267d26060488 :=
  by
    unfold Claim_267d26060488
...
#rh_audit_axioms prove_Claim_267d26060488
