...
-- claim: zcb26k4-rot-n8 (ce16240b7ab009a22d4fccce0bc53018d60efc2edd00ab8e021c77b4be953230)
def Claim_ce16240b7ab0 : Prop :=
  ‖((8 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 32 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49894469) / 50000000 : ℝ) : ℂ) - (((6493683) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: c142f04a304c1e189e1a14d5933aa938e01c2d46c51f73f7ba6b0a9a32ecf106)
theorem prove_Claim_ce16240b7ab0 : Claim_ce16240b7ab0 :=
  by
    unfold Claim_ce16240b7ab0
    ...
    have hcosi := prove_Claim_a974fd78e18c ((1299651) / 20000000 : ℝ) ((49894469) / 50000000 : ℝ) 14 ((1) / 50000000 : ℝ) ((1) / 100000000 : ℝ)
      (by rw [abs_of_nonneg (by norm_num : (0:ℝ) ≤ ((1299651) / 20000000 : ℝ))]; norm_num)
      (by norm_num [Finset.sum_range_succ, Finset.sum_range_zero, Nat.factorial])
      (by rw [abs_of_nonneg (by norm_num : (0:ℝ) ≤ ((1299651) / 20000000 : ℝ))]; norm_num)
    ...
    rw [abs_of_nonneg (by norm_num : (0:ℝ) ≤ (1 : ℝ)), abs_of_nonneg (by norm_num : (0:ℝ) ≤ ((49894469) / 50000000 : ℝ)), abs_of_nonneg (by norm_num : (0:ℝ) ≤ ((6493683) / 100000000 : ℝ))] at hmain
...
#rh_audit_axioms prove_Claim_ce16240b7ab0
