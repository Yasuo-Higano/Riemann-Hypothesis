...
-- claim: zcb26k4-rot-n4 (2d398ef96a35eb5f4f2829af777c59016093a3d6b4147a7e0b0f9ce62cec8277)
def Claim_2d398ef96a35 : Prop :=
  ‖((4 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 32 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((780517) / 781250 : ℝ) : ℂ) - (((866163) / 20000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 45ad1bea5df7eda1c245f13051c2d2865168d41db5f87abfd6ddd44f1d98c296)
theorem prove_Claim_2d398ef96a35 : Claim_2d398ef96a35 :=
  by
    unfold Claim_2d398ef96a35
...
#rh_audit_axioms prove_Claim_2d398ef96a35
