...
-- claim: zcb8k2-rot-n9 (f490dcc2bc9d8c978be3506b2ea7089d2b792e5d288664c8da88c3bb78db89b2)
def Claim_f490dcc2bc9d : Prop :=
  ‖((9 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((96251933) / 100000000 : ℝ) : ℂ) - (((27121309) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((127) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: e0f638281c53737278e4e19c41c4d53c84be88057194cd240fd25af3d3b11bbd)
theorem prove_Claim_f490dcc2bc9d : Claim_f490dcc2bc9d :=
  by
    unfold Claim_f490dcc2bc9d
...
#rh_audit_axioms prove_Claim_f490dcc2bc9d
