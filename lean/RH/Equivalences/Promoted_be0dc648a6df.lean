...
-- claim: zcb25k2-rot-n5 (be0dc648a6df80bbce6c06b4b5091a1a4eb39fce9d807ac0231949f10f9ed661)
def Claim_be0dc648a6df : Prop :=
  ‖((5 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((6123947) / 6250000 : ℝ) : ℂ) - (((9991271) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((7) / 20000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 15b77daff2c3f09cab5114a7fb96d51a5f83d872db7d9e21e5049d9bf8c8f59c)
theorem prove_Claim_be0dc648a6df : Claim_be0dc648a6df :=
  by
    unfold Claim_be0dc648a6df
...
#rh_audit_axioms prove_Claim_be0dc648a6df
