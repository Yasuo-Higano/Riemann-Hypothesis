...
-- claim: zcb5k2-rot-n7 (f7d50b167ad2bf5e1023c6cde003ff0f208c0a1885bb0804354e8f10846c705e)
def Claim_f7d50b167ad2 : Prop :=
  ‖((7 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((48528151) / 50000000 : ℝ) : ℂ) - (((6021183) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((31) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 44eff09ce3b304c687475b0663e1cca7ee58a1b4ce463f5a0cc3c48bd4585df8)
theorem prove_Claim_f7d50b167ad2 : Claim_f7d50b167ad2 :=
  by
    unfold Claim_f7d50b167ad2
...
#rh_audit_axioms prove_Claim_f7d50b167ad2
