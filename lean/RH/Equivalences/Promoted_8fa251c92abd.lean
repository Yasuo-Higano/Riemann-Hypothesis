...
-- claim: zcb21k3-rot-n8 (8fa251c92abd6a616e468dd7babf08bbc3a5e7e6fc17bb31cd77abf8563b617e)
def Claim_8fa251c92abd : Prop :=
  ‖((8 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49578321) / 50000000 : ℝ) : ℂ) - (((6479977) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: c853157a6220f70ad6a817c99ec206c6ad2cf51a08c272cb30e50c6b78919277)
theorem prove_Claim_8fa251c92abd : Claim_8fa251c92abd :=
  by
    unfold Claim_8fa251c92abd
...
#rh_audit_axioms prove_Claim_8fa251c92abd
