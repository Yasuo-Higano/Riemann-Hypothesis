...
-- claim: zeta-value-ball-at-half-half-n6 (756813841f25850bb6a508338b3b087f7c4a3fc725f3f0f9db9f15406270aedd)
def Claim_756813841f25 : Prop :=
  ‖riemannZeta ((((1) / 2 : ℝ) : ℂ) + (((1) / 2 : ℝ) : ℂ) * Complex.I) - ((1 : ℂ) - (((35355339) / 25000000 : ℝ) : ℂ) * ((((9405421) / 10000000 : ℝ) : ℂ) - (((1061491) / 3125000 : ℝ) : ℂ) * Complex.I))⁻¹ * (1 - (((35355339) / 50000000 : ℝ) : ℂ) * ((((9405421) / 10000000 : ℝ) : ℂ) - (((1061491) / 3125000 : ℝ) : ℂ) * Complex.I) + (((28867513) / 50000000 : ℝ) : ℂ) * ((((42644349) / 50000000 : ℝ) : ℂ) - (((52209559) / 100000000 : ℝ) : ℂ) * Complex.I) - (((1) / 2 : ℝ) : ℂ) * ((((7692389) / 10000000 : ℝ) : ℂ) - (((998377) / 1562500 : ℝ) : ℂ) * Complex.I) + (((22360679) / 50000000 : ℝ) : ℂ) * ((((34665689) / 50000000 : ℝ) : ℂ) - (((2251987) / 3125000 : ℝ) : ℂ) * Complex.I))‖ ≤ ((293) / 100 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: claude-fable-5-inline, proof sha256: 157159bf82173c476c0071f5c2081126cedf1a77e4130766edb744bb15ca19fe)
theorem prove_Claim_756813841f25 : Claim_756813841f25 :=
  by
    unfold Claim_756813841f25
    have h4 := prove_Claim_95f2436187a7
    unfold Claim_95f2436187a7 at h4
    have heta := prove_Claim_d70f8f7a4033
    unfold Claim_d70f8f7a4033 at heta
    ...
    calc ‖((1 : ℂ) - (2 : ℂ) ^ ((1 : ℂ) - SS))⁻¹ * RH.dirichletEtaEntire SS
        ...
        ≤ ‖((1 : ℂ) - W4)⁻¹‖ * ((17) / 10 : ℝ)
          ...
          + (((307) / 25000000 : ℝ) / (((58) / 100 : ℝ) * (((58) / 100 : ℝ) + ((307) / 25000000 : ℝ))))
            * ((17) / 10 : ℝ) := hmul
      _ ≤ ((293) / 100 : ℝ) := by
          have t1 := mul_le_mul_of_nonneg_right hinvnorm (by norm_num : (0:ℝ) ≤ ((17) / 10 : ℝ))
          ...
          have t3 : ((84) / 100 : ℝ) * (((307) / 25000000 : ℝ) / (((58) / 100 : ℝ) * (((58) / 100 : ℝ) + ((307) / 25000000 : ℝ))))
              + (((307) / 25000000 : ℝ) / (((58) / 100 : ℝ) * (((58) / 100 : ℝ) + ((307) / 25000000 : ℝ)))) * ((17) / 10 : ℝ)
              ≤ ((1) / 1000 : ℝ) := by norm_num
          have t4 : ((172) / 100 : ℝ) * ((17) / 10 : ℝ) ≤ ((2924) / 1000 : ℝ) := by norm_num
          linarith [t1, t2, t3, t4]
-- END UNTRUSTED PROOF

#rh_audit_axioms prove_Claim_756813841f25
