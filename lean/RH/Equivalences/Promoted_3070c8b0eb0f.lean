...
-- claim: zcb29k5-rot-n6 (3070c8b0eb0ff0daaf216c5dc5d763e8e5d72e1249ace3131e9266e379715c62)
def Claim_3070c8b0eb0f : Prop :=
  ‖((6 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 64 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99960813) / 100000000 : ℝ) : ℂ) - (((1399629) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 6adebf3d7c17fffd45db43231d0d9fe03976174b19ec5171ff5adae8759dff49)
theorem prove_Claim_3070c8b0eb0f : Claim_3070c8b0eb0f :=
  by
    unfold Claim_3070c8b0eb0f
...
#rh_audit_axioms prove_Claim_3070c8b0eb0f
