...
-- claim: zcb1k2-rot-n5 (cad33451e9871394c9c1b67f29971bd6e29ae9c65ba4a75850970dbf64c1b861)
def Claim_cad33451e987 : Prop :=
  ‖((5 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((6123947) / 6250000 : ℝ) : ℂ) - (((9991271) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((7) / 20000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 0da93b736f316ac0ab23fa924eb23647c62316c495f723541c5d1864efdd7ee1)
theorem prove_Claim_cad33451e987 : Claim_cad33451e987 :=
  by
    unfold Claim_cad33451e987
...
#rh_audit_axioms prove_Claim_cad33451e987
