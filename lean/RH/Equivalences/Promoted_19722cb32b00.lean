...
-- claim: zcb30k4-rot-n19 (19722cb32b00aae13a7789b46c6f01ec6d18de7f15d29046abea9755d2b6476f)
def Claim_19722cb32b00 : Prop :=
  ‖((19 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 160 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99983067) / 100000000 : ℝ) : ℂ) - (((184017) / 10000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: e5fa4541817629e4c5a1db07e2b5deb25f3fbfa4a5e9754b8e5f7f6792432138)
theorem prove_Claim_19722cb32b00 : Claim_19722cb32b00 :=
  by
    unfold Claim_19722cb32b00
...
#rh_audit_axioms prove_Claim_19722cb32b00
