...
-- claim: zcb23k2-rot-n4 (86cde4f3f817f47c34df696c1cb1cdb6ffbde1fe68ce5211c901d68626ba0293)
def Claim_86cde4f3f817 : Prop :=
  ‖((4 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49251169) / 50000000 : ℝ) : ℂ) - (((3448417) / 20000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 5031f7ce1fce202377cc062c0bd950d7be86cd611ff60014fbbfc85ed77ddd3b)
theorem prove_Claim_86cde4f3f817 : Claim_86cde4f3f817 :=
  by
    unfold Claim_86cde4f3f817
...
#rh_audit_axioms prove_Claim_86cde4f3f817
