...
-- claim: rotor-test-n2 (3bd2556c7a6f7771c1b6b20eab14ac893d109e8f01d1d4ce3a28d4417e5ffdd4)
def Claim_3bd2556c7a6f : Prop :=
  ‖((2 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((17) / 200 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99826487) / 100000000 : ℝ) : ℂ) - (((5888343) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 2e06f668d4329e7f75e1d54d3be635afd0d2c040a3098b05b47970096a1019ef)
theorem prove_Claim_3bd2556c7a6f : Claim_3bd2556c7a6f :=
  by
    unfold Claim_3bd2556c7a6f
    ...
    have hexpi := prove_Claim_c3c6011aaeb0 (0 : ℝ) (1 : ℝ) 12 ((1) / 50000000 : ℝ) ((1) / 100000000 : ℝ)
      (by rw [abs_of_nonneg (by norm_num : (0:ℝ) ≤ (0 : ℝ))]; norm_num)
      (by norm_num [Finset.sum_range_succ, Finset.sum_range_zero, Nat.factorial])
      (by rw [abs_of_nonneg (by norm_num : (0:ℝ) ≤ (0 : ℝ))]; norm_num)
    have hexp : |Real.exp (0 : ℝ) - (1 : ℝ)| ≤ ((3) / 100000000 : ℝ) := by linarith [hexpi]
    have hcosi := prove_Claim_a974fd78e18c ((5891751) / 100000000 : ℝ) ((99826487) / 100000000 : ℝ) 12 ((1) / 50000000 : ℝ) ((1) / 100000000 : ℝ)
    ...
    have hsini := prove_Claim_720f6be7fec9 ((5891751) / 100000000 : ℝ) ((5888343) / 100000000 : ℝ) 12 ((1) / 50000000 : ℝ) ((1) / 100000000 : ℝ)
      (by rw [abs_of_nonneg (by norm_num : (0:ℝ) ≤ ((5891751) / 100000000 : ℝ))]; norm_num)
      (by norm_num [Finset.sum_range_succ, Finset.sum_range_zero, Nat.factorial])
      (by rw [abs_of_nonneg (by norm_num : (0:ℝ) ≤ ((5891751) / 100000000 : ℝ))]; norm_num)
...
#rh_audit_axioms prove_Claim_3bd2556c7a6f
