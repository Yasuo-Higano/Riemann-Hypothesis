...
-- claim: zcb21k3-rot-n15 (013440f982179cedaa1f0b551f4abf11561ac752bf5398234ec734325f182df1)
def Claim_013440f98217 : Prop :=
  ‖((15 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((19714217) / 20000000 : ℝ) : ℂ) - (((8422311) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((3) / 10000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 8ef81dd61ae3acab9b27f1782e525750d02514f1b84ac918fbb5972c721555d4)
theorem prove_Claim_013440f98217 : Claim_013440f98217 :=
  by
    unfold Claim_013440f98217
...
#rh_audit_axioms prove_Claim_013440f98217
