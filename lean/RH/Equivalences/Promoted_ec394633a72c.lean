...
-- claim: zcb28k2-rot-n24 (ec394633a72c549dbada75b32466c6dfe195ebb83feb60d83322b9146b280f03)
def Claim_ec394633a72c : Prop :=
  ‖((24 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 40 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((4984227) / 5000000 : ℝ) : ℂ) - (((396839) / 5000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((21) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: a48e8a4f1bc2ec072eb913f6cb3befd64046b6a309466b6dc0f22b421fad81a0)
theorem prove_Claim_ec394633a72c : Claim_ec394633a72c :=
  by
    unfold Claim_ec394633a72c
...
#rh_audit_axioms prove_Claim_ec394633a72c
