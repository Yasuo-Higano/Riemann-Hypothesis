...
-- claim: auto-exp-eta-partial-30-t142-term-23-s1 (fbb9351505c6873d44adc66a27e2fde95d40ff9e558e9476a0c603e947243d90)
def Claim_fbb9351505c6 : Prop :=
  |Real.exp ((-39193683) / 50000000 : ℝ) - ((22831687) / 50000000 : ℝ)| ≤ ((73) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-exp-square, proof sha256: 067bb99b754b2fe6d685efcb61862f792ececdf045b50b6dccc1193058a2cd2b)
theorem prove_Claim_fbb9351505c6 : Claim_fbb9351505c6 :=
  by
    unfold Claim_fbb9351505c6
    have hb : |Real.exp ((-39193683) / 100000000 : ℝ) - ((1689367) / 2500000 : ℝ)| ≤ ((53) / 50000000 : ℝ) := by
      have h := prove_Claim_d47de4bc7fc9
      unfold Claim_d47de4bc7fc9 at h
      exact h
...
#rh_audit_axioms prove_Claim_fbb9351505c6
