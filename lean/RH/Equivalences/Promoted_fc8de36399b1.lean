...
-- claim: zl3ch-rot-n4 (fc8de36399b1806fb32d76b36cd3b9f775112153279969344d602eb9eee9b0c6)
def Claim_fc8de36399b1 : Prop :=
  ‖((4 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 40 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99939949) / 100000000 : ℝ) : ℂ) - (((1732521) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 2aa15cac3756ab206f6363e35c48380edca8812a468d902cd6bd43524ea22b4e)
theorem prove_Claim_fc8de36399b1 : Claim_fc8de36399b1 :=
  by
    unfold Claim_fc8de36399b1
...
#rh_audit_axioms prove_Claim_fc8de36399b1
