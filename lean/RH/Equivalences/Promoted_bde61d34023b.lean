...
-- claim: zcb30k5-rot-n18 (bde61d34023bc438acfd59985fc91e18f14bc85b7759cc4fb33ef3566ec35735)
def Claim_bde61d34023b : Prop :=
  ‖((18 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 320 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99995921) / 100000000 : ℝ) : ℂ) - (((903229) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: e852c55402e472decc5f88c78a66de7e92c23774c52a423e2f54b534a75e3491)
theorem prove_Claim_bde61d34023b : Claim_bde61d34023b :=
  by
    unfold Claim_bde61d34023b
...
#rh_audit_axioms prove_Claim_bde61d34023b
