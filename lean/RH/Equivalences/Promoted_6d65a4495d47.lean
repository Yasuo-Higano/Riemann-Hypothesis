...
-- claim: zcb15k3-rot-n13 (6d65a4495d472cc0702d5c733a47fa22b0931143921afde52960f5038b5e05ff)
def Claim_6d65a4495d47 : Prop :=
  ‖((13 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((19743559) / 20000000 : ℝ) : ℂ) - (((399059) / 2500000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 2500000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: f3e395c322f06cdb4cc989425ab26df69e18476811b228e6ebddab4d82f84323)
theorem prove_Claim_6d65a4495d47 : Claim_6d65a4495d47 :=
  by
    unfold Claim_6d65a4495d47
...
#rh_audit_axioms prove_Claim_6d65a4495d47
