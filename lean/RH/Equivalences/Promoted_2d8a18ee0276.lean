...
-- claim: zcb25k2-rot-n16 (2d8a18ee0276c5ba40daec974833147b0013ed09716a5d3e11e32861f01d24aa)
def Claim_2d8a18ee0276 : Prop :=
  ‖((16 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((9405421) / 10000000 : ℝ) : ℂ) - (((1061491) / 3125000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((19) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 602cc5408ddc950023fa84eddfecc6a46314d2ed9835843a915aae8f4e430d23)
theorem prove_Claim_2d8a18ee0276 : Claim_2d8a18ee0276 :=
  by
    unfold Claim_2d8a18ee0276
...
#rh_audit_axioms prove_Claim_2d8a18ee0276
