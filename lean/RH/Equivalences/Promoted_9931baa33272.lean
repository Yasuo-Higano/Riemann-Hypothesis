...
-- claim: zgt1-b-n4 (9931baa332728df423a4f662eefc72d968bd579677c92c49e81db1ba4666dbfe)
def Claim_9931baa33272 : Prop :=
  ‖((4 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((17) / 400 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99826487) / 100000000 : ℝ) : ℂ) - (((5888343) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: e852ccb4bf36a065578faba18a07f62bc6240f5d1e842e8748724f0f0945219b)
theorem prove_Claim_9931baa33272 : Claim_9931baa33272 :=
  by
    unfold Claim_9931baa33272
    ...
    have hv : |((17) / 400 : ℝ) * Real.log ((4 : ℕ) : ℝ) - ((5891751) / 100000000 : ℝ)| ≤ ((1) / 50000000 : ℝ) :=
      hssb (Real.log ((4 : ℕ) : ℝ)) ((1386294361) / 1000000000 : ℝ) ((601) / 1000000000000 : ℝ) (((17) / 400 : ℝ)) ((5891751) / 100000000 : ℝ) ((1) / 100000000 : ℝ) ((1) / 50000000 : ℝ) hlog
        (by rw [abs_le]; constructor <;> norm_num)
    ...
    have hmain := prove_Claim_fe51a39a688e 4 ((0 : ℝ)) (((17) / 400 : ℝ)) (0 : ℝ) (1 : ℝ) ((3) / 100000000 : ℝ) ((1) / 100000000 : ℝ) ((5891751) / 100000000 : ℝ) ((99826487) / 100000000 : ℝ) ((3) / 100000000 : ℝ) ((5888343) / 100000000 : ℝ) ((3) / 100000000 : ℝ) ((1) / 50000000 : ℝ)
    ...
    calc ‖((4 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((17) / 400 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99826487) / 100000000 : ℝ) : ℂ) - (((5888343) / 100000000 : ℝ) : ℂ) * Complex.I)‖
...
#rh_audit_axioms prove_Claim_9931baa33272
