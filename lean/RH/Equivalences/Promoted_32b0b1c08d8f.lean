...
-- claim: zl3b-rot-n9 (32b0b1c08d8f509b839a48c57d486cde0a8640086bde2b66bb14dc56de43e6e4)
def Claim_32b0b1c08d8f : Prop :=
  ‖((9 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 40 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99849169) / 100000000 : ℝ) : ℂ) - (((5490301) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((19) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: bfa2898ded873d44390a777a451a16535e9115798411700c290244facfd3c8c5)
theorem prove_Claim_32b0b1c08d8f : Claim_32b0b1c08d8f :=
  by
    unfold Claim_32b0b1c08d8f
...
#rh_audit_axioms prove_Claim_32b0b1c08d8f
