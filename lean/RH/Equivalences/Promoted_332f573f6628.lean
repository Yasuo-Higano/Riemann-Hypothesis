...
-- claim: zcb0k2-rot-n2 (332f573f6628ce479f32f5f692b1305b20af280da7e49983b1a5db321d0da216)
def Claim_332f573f6628 : Prop :=
  ‖((2 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99624881) / 100000000 : ℝ) : ℂ) - (((8653503) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: c657df8cfedb33872e783ab875ea156d0339cfa0cf7443890fb89a71fe6723f1)
theorem prove_Claim_332f573f6628 : Claim_332f573f6628 :=
  by
    unfold Claim_332f573f6628
...
#rh_audit_axioms prove_Claim_332f573f6628
