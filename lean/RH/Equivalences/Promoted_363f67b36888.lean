...
-- claim: zcb30k1-rot-n24 (363f67b368882b56f7c7d3e654dcc1f7f2e3b35eba2267970e1ccf0160e9ae54)
def Claim_363f67b36888 : Prop :=
  ‖((24 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 20 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((98740151) / 100000000 : ℝ) : ℂ) - (((3164697) / 20000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((17) / 25000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 86d3199eae43630a8395e38db8342a8489aba134d5086ebff265f4cae8eb4996)
theorem prove_Claim_363f67b36888 : Claim_363f67b36888 :=
  by
    unfold Claim_363f67b36888
...
#rh_audit_axioms prove_Claim_363f67b36888
