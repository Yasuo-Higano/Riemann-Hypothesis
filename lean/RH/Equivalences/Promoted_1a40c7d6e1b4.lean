...
-- claim: zcb0k3-rot-n8 (1a40c7d6e1b4540c7c4b325c91bf9ad2bb365b896dfb6f897b45a384dd3b788c)
def Claim_1a40c7d6e1b4 : Prop :=
  ‖((8 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49578321) / 50000000 : ℝ) : ℂ) - (((6479977) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: b93ce7b42462905ed7de850ba7cc21a7815037556cee64efe026fd398dfb9d94)
theorem prove_Claim_1a40c7d6e1b4 : Claim_1a40c7d6e1b4 :=
  by
    unfold Claim_1a40c7d6e1b4
...
#rh_audit_axioms prove_Claim_1a40c7d6e1b4
