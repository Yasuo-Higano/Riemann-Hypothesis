...
-- claim: zcb24k2-rot-n7 (1780086189123e94711aaca4cb64107792d64bfd5777ecb7bc68d40bca1d4636)
def Claim_178008618912 : Prop :=
  ‖((7 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((48528151) / 50000000 : ℝ) : ℂ) - (((6021183) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((31) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: f589eefa157cf30d17cbbc000e95d8dd1fbc3f0f9b62c141598e5d97f711a10f)
theorem prove_Claim_178008618912 : Claim_178008618912 :=
  by
    unfold Claim_178008618912
...
#rh_audit_axioms prove_Claim_178008618912
