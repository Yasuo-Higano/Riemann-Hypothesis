...
-- claim: zcb0k2-rot-n8 (7bd2edd6d180ad926e1558da6dd785f9d55e87cedb2052c1a31807e9af12f5bc)
def Claim_7bd2edd6d180 : Prop :=
  ‖((8 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((12080099) / 12500000 : ℝ) : ℂ) - (((25701309) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((19) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 5372d174ddc39e6d5966e546886815856597f11f8768b3cda51fcf31641e7663)
theorem prove_Claim_7bd2edd6d180 : Claim_7bd2edd6d180 :=
  by
    unfold Claim_7bd2edd6d180
...
#rh_audit_axioms prove_Claim_7bd2edd6d180
