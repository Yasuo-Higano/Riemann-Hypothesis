...
-- claim: zcb4k3-rot-n2 (f924d361cbfb05ec0795b7cbe4c0335f941fb11542df3f63be0dce52e33fcccc)
def Claim_f924d361cbfb : Prop :=
  ‖((2 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((780517) / 781250 : ℝ) : ℂ) - (((866163) / 20000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: a466a6b11a08aa96e8b73d569f08a9458473571802e06474bb6a942d068921cd)
theorem prove_Claim_f924d361cbfb : Claim_f924d361cbfb :=
  by
    unfold Claim_f924d361cbfb
...
#rh_audit_axioms prove_Claim_f924d361cbfb
