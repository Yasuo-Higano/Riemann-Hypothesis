...
-- claim: zcb19k4-rot-n13 (8e742edbcf25e32d1390335b621c2551509ba788a8398f9b69bd941cea4c7e86)
def Claim_8e742edbcf25 : Prop :=
  ‖((13 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 32 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99678933) / 100000000 : ℝ) : ℂ) - (((8006887) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((7) / 25000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 1b5a02506f6095f740b166b7b36a5c0bd5208dd338830b831e7d7ff5b037d1d9)
theorem prove_Claim_8e742edbcf25 : Claim_8e742edbcf25 :=
  by
    unfold Claim_8e742edbcf25
...
#rh_audit_axioms prove_Claim_8e742edbcf25
