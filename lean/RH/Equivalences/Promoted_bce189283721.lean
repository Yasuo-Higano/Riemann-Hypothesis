...
-- claim: zcb2k2-rot-n8 (bce189283721d810e0c3df1c9bd42224a62d7978396587ece7a407ca4720ecba)
def Claim_bce189283721 : Prop :=
  ‖((8 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((12080099) / 12500000 : ℝ) : ℂ) - (((25701309) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((19) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: b3bf47d78f8b1eeb49dc93bd0256e34cc5f542f2aba13ffe63d5a040a1a5e4ab)
theorem prove_Claim_bce189283721 : Claim_bce189283721 :=
  by
    unfold Claim_bce189283721
...
#rh_audit_axioms prove_Claim_bce189283721
