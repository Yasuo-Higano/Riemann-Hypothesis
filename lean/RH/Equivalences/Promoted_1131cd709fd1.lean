...
-- claim: zcb10k2-rot-n2 (1131cd709fd12921e31514ca76c2eeda5b87c664f6d40daef22999a051714237)
def Claim_1131cd709fd1 : Prop :=
  ‖((2 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99624881) / 100000000 : ℝ) : ℂ) - (((8653503) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: fbe885356b9e352ebd785abb3f49ce0309a92f942c956aed3818e90e057648be)
theorem prove_Claim_1131cd709fd1 : Claim_1131cd709fd1 :=
  by
    unfold Claim_1131cd709fd1
...
#rh_audit_axioms prove_Claim_1131cd709fd1
