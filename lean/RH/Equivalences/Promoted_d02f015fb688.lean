...
-- claim: zgpv5-c2 (d02f015fb6883212b26291fb4ccd9893d4785e3478ba409817d5d46b6bbc1233)
def Claim_d02f015fb688 : Prop :=
  (‖((5 : ℝ) : ℂ) ^ (2 : ℕ) / ∏ k ∈ Finset.range 3, ((((5) / 4 : ℝ) : ℂ) + (((7) / 1 : ℝ) : ℂ) * Complex.I + (k : ℂ)) - ((((-6172784849) / 125000000000 : ℝ) : ℂ) + (((18708789293) / 500000000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((763) / 1000000000000000 : ℝ)) ∧ (‖(∑ k ∈ Finset.range 3, 1 / ((((5) / 4 : ℝ) : ℂ) + (((7) / 1 : ℝ) : ℂ) * Complex.I + (k : ℂ))) - ((((120904909027) / 1000000000000 : ℝ) : ℂ) + (((-48180737509) / 125000000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((13) / 8000000000000 : ℝ)) ∧ (‖(∑ m ∈ Finset.range 3, (((5 : ℝ) : ℂ) ^ m / ∏ k ∈ Finset.range (m + 1), ((((5) / 4 : ℝ) : ℂ) + (((7) / 1 : ℝ) : ℂ) * Complex.I + (k : ℂ))) * (∑ k ∈ Finset.range (m + 1), 1 / ((((5) / 4 : ℝ) : ℂ) + (((7) / 1 : ℝ) : ℂ) * Complex.I + (k : ℂ)))) - ((((-27714514559) / 1000000000000 : ℝ) : ℂ) + (((36374988671) / 1000000000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((2919) / 1000000000000000 : ℝ)) ∧ (‖(∑ m ∈ Finset.range 3, ((5 : ℝ) : ℂ) ^ m / ∏ k ∈ Finset.range (m + 1), ((((5) / 4 : ℝ) : ℂ) + (((7) / 1 : ℝ) : ℂ) * Complex.I + (k : ℂ))) - ((((-27285872791) / 250000000000 : ℝ) : ℂ) + (((-72919353637) / 500000000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((2271) / 1000000000000000 : ℝ))

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-gamma-kummer-deriv, proof sha256: a54c74611881d2aa1f14b34a852e5fb1623d81c8a2cc2fc15be90d0c1a4100cd)
theorem prove_Claim_d02f015fb688 : Claim_d02f015fb688 :=
  by
    unfold Claim_d02f015fb688
    have hsre : (0:ℝ) < ((((5) / 4 : ℝ) : ℂ) + (((7) / 1 : ℝ) : ℂ) * Complex.I).re := by
      norm_num [Complex.add_re, Complex.mul_re, Complex.I_re, Complex.I_im,
        Complex.ofReal_re, Complex.ofReal_im]
    have hprev := prove_Claim_de4812d0bc3e
    unfold Claim_de4812d0bc3e at hprev
    obtain ⟨hT0, hH0, hW0, hS0⟩ := hprev
    ...
    have hseS1 : ((((24721878863) / 1000000000000 : ℝ) : ℂ) + (((-4326328801) / 31250000000 : ℝ) : ℂ) * Complex.I) + ((((-16896618247) / 200000000000 : ℝ) : ℂ) + (((-11203441057) / 250000000000 : ℝ) : ℂ) * Complex.I) = ((((-14940303093) / 250000000000 : ℝ) : ℂ) + (((-9162814293) / 50000000000 : ℝ) : ℂ) * Complex.I) := by
      norm_num [Complex.ext_iff, Complex.add_re, Complex.add_im, Complex.mul_re, Complex.mul_im,
        Complex.I_re, Complex.I_im, Complex.ofReal_re, Complex.ofReal_im,
        Complex.natCast_re, Complex.natCast_im]
    have hS1 : ‖(∑ m ∈ Finset.range 2, ((5 : ℝ) : ℂ) ^ m / ∏ k ∈ Finset.range (m + 1), ((((5) / 4 : ℝ) : ℂ) + (((7) / 1 : ℝ) : ℂ) * Complex.I + (k : ℂ))) - ((((-14940303093) / 250000000000 : ℝ) : ℂ) + (((-9162814293) / 50000000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((377) / 250000000000000 : ℝ) := by
      rw [hss1]
      have hbaS1 := prove_Claim_e6b33ba17416
      ...
      rw [hseS1] at hbaS1
      refine le_trans hbaS1 (by norm_num)
    ...
    have hseS2 : ((((-14940303093) / 250000000000 : ℝ) : ℂ) + (((-9162814293) / 50000000000 : ℝ) : ℂ) * Complex.I) + ((((-6172784849) / 125000000000 : ℝ) : ℂ) + (((18708789293) / 500000000000 : ℝ) : ℂ) * Complex.I) = ((((-27285872791) / 250000000000 : ℝ) : ℂ) + (((-72919353637) / 500000000000 : ℝ) : ℂ) * Complex.I) := by
      norm_num [Complex.ext_iff, Complex.add_re, Complex.add_im, Complex.mul_re, Complex.mul_im,
        Complex.I_re, Complex.I_im, Complex.ofReal_re, Complex.ofReal_im,
        Complex.natCast_re, Complex.natCast_im]
    have hS2 : ‖(∑ m ∈ Finset.range 3, ((5 : ℝ) : ℂ) ^ m / ∏ k ∈ Finset.range (m + 1), ((((5) / 4 : ℝ) : ℂ) + (((7) / 1 : ℝ) : ℂ) * Complex.I + (k : ℂ))) - ((((-27285872791) / 250000000000 : ℝ) : ℂ) + (((-72919353637) / 500000000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((2271) / 1000000000000000 : ℝ) := by
      rw [hss2]
      have hbaS2 := prove_Claim_e6b33ba17416
      ...
      rw [hseS2] at hbaS2
      refine le_trans hbaS2 (by norm_num)
    exact ⟨hT2, hH2, hW2, hS2⟩
-- END UNTRUSTED PROOF

#rh_audit_axioms prove_Claim_d02f015fb688
