...
-- claim: zl3b-rot-n4 (0f0a1a620da9e37a61b3d930b9ad169f6e1265df4175bc8b17c10b7fb0ee8a0a)
def Claim_0f0a1a620da9 : Prop :=
  ‖((4 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 40 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99939949) / 100000000 : ℝ) : ℂ) - (((1732521) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 2d7aa9837ff419e58a5560f5583402db6a2c839d0b5b645bca131a31eb8e4dcf)
theorem prove_Claim_0f0a1a620da9 : Claim_0f0a1a620da9 :=
  by
    unfold Claim_0f0a1a620da9
...
#rh_audit_axioms prove_Claim_0f0a1a620da9
