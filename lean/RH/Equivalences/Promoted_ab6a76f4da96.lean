...
-- claim: zcb29k4-rot-n3 (ab6a76f4da96d02a951996c2057392347bcd7a43e896e0dcbf7c8a6f3b0786c2)
def Claim_ab6a76f4da96 : Prop :=
  ‖((3 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 32 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99941073) / 100000000 : ℝ) : ℂ) - (((3432489) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: e6981e097e103131a0513da0c3acd9aae8d9e86ffba367eaa27436907b123bc4)
theorem prove_Claim_ab6a76f4da96 : Claim_ab6a76f4da96 :=
  by
    unfold Claim_ab6a76f4da96
...
#rh_audit_axioms prove_Claim_ab6a76f4da96
