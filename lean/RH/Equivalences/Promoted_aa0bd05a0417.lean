...
-- claim: zcb12k2-rot-n2 (aa0bd05a0417b7bb726c7a7416f037e03ed068b195889d1bdd9444512d1b354b)
def Claim_aa0bd05a0417 : Prop :=
  ‖((2 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99624881) / 100000000 : ℝ) : ℂ) - (((8653503) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: ead8ec1318ec998ccae2cdffe1da01004771900df9d340bd3ccabc719287ad1a)
theorem prove_Claim_aa0bd05a0417 : Claim_aa0bd05a0417 :=
  by
    unfold Claim_aa0bd05a0417
...
#rh_audit_axioms prove_Claim_aa0bd05a0417
