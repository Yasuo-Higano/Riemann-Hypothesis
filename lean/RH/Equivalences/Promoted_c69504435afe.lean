...
-- claim: zcb3k3-rot-n4 (c69504435afe37eba6122dad47c4d8906b000cc93f243b274f357ffbdb0ac141)
def Claim_c69504435afe : Prop :=
  ‖((4 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99624881) / 100000000 : ℝ) : ℂ) - (((8653503) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 9caea18e0553f4f63aab370ed7fc844de29bced21088c455022fae20cda295b6)
theorem prove_Claim_c69504435afe : Claim_c69504435afe :=
  by
    unfold Claim_c69504435afe
...
#rh_audit_axioms prove_Claim_c69504435afe
