...
-- claim: zcb20k3-rot-n13 (a57d041e3a2af3ca444c7f7a02a035d95705d370d904d55b1570ec0920893900)
def Claim_a57d041e3a2a : Prop :=
  ‖((13 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((19743559) / 20000000 : ℝ) : ℂ) - (((399059) / 2500000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 2500000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 2eb4864de46c8d3d478a3d0e6b4b409cb430414176cd4258d34d44d4aeb8c667)
theorem prove_Claim_a57d041e3a2a : Claim_a57d041e3a2a :=
  by
    unfold Claim_a57d041e3a2a
...
#rh_audit_axioms prove_Claim_a57d041e3a2a
