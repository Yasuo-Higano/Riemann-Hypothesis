...
-- claim: zcb23k2-rot-n8 (cd1c98d4a7a7905ea3f254bbf11290bef423315cec4193bf677926d30eb81b4d)
def Claim_cd1c98d4a7a7 : Prop :=
  ‖((8 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((12080099) / 12500000 : ℝ) : ℂ) - (((25701309) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((19) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 0b619c2d3ff67a8b44abbefa22d4a8e6ce8ef95fab68da89f27d398159b09511)
theorem prove_Claim_cd1c98d4a7a7 : Claim_cd1c98d4a7a7 :=
  by
    unfold Claim_cd1c98d4a7a7
...
#rh_audit_axioms prove_Claim_cd1c98d4a7a7
