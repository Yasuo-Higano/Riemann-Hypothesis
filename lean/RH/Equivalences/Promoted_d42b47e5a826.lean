...
-- claim: cpow-halfplane-lipschitz (d42b47e5a826e017b8b59c6a0f0922877e436a550c4b2bcadb6437e67db22ce7)
def Claim_d42b47e5a826 : Prop :=
  ∀ (n : ℕ) (s : ℂ) (w : ℂ) (m : ℝ), (2 ≤ n) → (m ≤ s.re) → (m ≤ w.re) → ‖((n : ℕ) : ℂ) ^ (-s) - ((n : ℕ) : ℂ) ^ (-w)‖ ≤ (Real.log n * (n : ℝ) ^ (-m)) * ‖s - w‖

-- BEGIN UNTRUSTED PROOF (prover: fable-loop49, proof sha256: b3555c089958d159977301d98b82fb876e1faf8b2a1549ea2f632258bc123828)
theorem prove_Claim_d42b47e5a826 : Claim_d42b47e5a826 :=
  by
    intro n s w m h2 hs hw
    ...
    have hmem_s : s ∈ HP := hs
    have hmem_w : w ∈ HP := hw
    exact hconv.norm_image_sub_le_of_norm_hasFDerivWithin_le hder hbound hmem_w hmem_s
-- END UNTRUSTED PROOF

#rh_audit_axioms prove_Claim_d42b47e5a826
