...
-- claim: zcb0k3-rot-n3 (1511e7d22699bd16520f337f9d492de3f23097c54aa74adeac522cea6160e4b5)
def Claim_1511e7d22699 : Prop :=
  ‖((3 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((2494109) / 2500000 : ℝ) : ℂ) - (((6860933) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: b63a1d0bf8d58178c450be435afa0196a1848bfd8dc3abe8be92bc2f047d32d8)
theorem prove_Claim_1511e7d22699 : Claim_1511e7d22699 :=
  by
    unfold Claim_1511e7d22699
...
#rh_audit_axioms prove_Claim_1511e7d22699
