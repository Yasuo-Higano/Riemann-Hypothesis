...
-- claim: zcb25k3-rot-n6 (0954d1385bcc758d46dd5d5e94fa0bf4d9fdda1afa57c6c9a7158302e0fd2a86)
def Claim_0954d1385bcc : Prop :=
  ‖((6 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99373623) / 100000000 : ℝ) : ℂ) - (((5587553) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: a4cd09c22a95152f6a9bdb2f811be1f8e2d7084f48d1dd28ba0ffd7cca0df739)
theorem prove_Claim_0954d1385bcc : Claim_0954d1385bcc :=
  by
    unfold Claim_0954d1385bcc
...
#rh_audit_axioms prove_Claim_0954d1385bcc
