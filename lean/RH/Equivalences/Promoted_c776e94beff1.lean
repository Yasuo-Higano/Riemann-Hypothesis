...
-- claim: zcb15k3-rot-n15 (c776e94beff191c69243975c97841b0887f930d278ce818af6a6bc949746ce15)
def Claim_c776e94beff1 : Prop :=
  ‖((15 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((19714217) / 20000000 : ℝ) : ℂ) - (((8422311) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((3) / 10000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 9f542f36eab25fa0109c052d3c525971e2755a0fb9603cc6a4acb12d2797071d)
theorem prove_Claim_c776e94beff1 : Claim_c776e94beff1 :=
  by
    unfold Claim_c776e94beff1
...
#rh_audit_axioms prove_Claim_c776e94beff1
