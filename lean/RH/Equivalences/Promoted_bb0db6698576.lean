...
-- claim: zcb3k2-rot-n8 (bb0db6698576c411eca1edfaca7408dc7bd4ff2b261fe5a048a7a3edc413a042)
def Claim_bb0db6698576 : Prop :=
  ‖((8 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((12080099) / 12500000 : ℝ) : ℂ) - (((25701309) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((19) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 43425c615750783a1f88eb64909d64d2376315b1bf69d1421a6200d1d98b808b)
theorem prove_Claim_bb0db6698576 : Claim_bb0db6698576 :=
  by
    unfold Claim_bb0db6698576
...
#rh_audit_axioms prove_Claim_bb0db6698576
