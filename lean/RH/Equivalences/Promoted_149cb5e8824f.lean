...
-- claim: auto-exp-eta-partial-30-t142-term-16-s1 (149cb5e8824fe738a397ecdd1b3495f2810ce370d6d0d71eaa514f843e480b31)
def Claim_149cb5e8824f : Prop :=
  |Real.exp ((-34657359) / 50000000 : ℝ) - ((1) / 2 : ℝ)| ≤ ((13) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-exp-square, proof sha256: f6f3e0d55baf639390000d4adcbc764a269d985fea1e179d7ea989237bd0c210)
theorem prove_Claim_149cb5e8824f : Claim_149cb5e8824f :=
  by
    unfold Claim_149cb5e8824f
    have hb : |Real.exp ((-34657359) / 100000000 : ℝ) - ((35355339) / 50000000 : ℝ)| ≤ ((1) / 6250000 : ℝ) := by
      have h := prove_Claim_8bb687351d94
      unfold Claim_8bb687351d94 at h
      exact h
...
#rh_audit_axioms prove_Claim_149cb5e8824f
