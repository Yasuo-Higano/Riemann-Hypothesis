...
-- claim: zcb6k2-rot-n4 (65f0d7131410de22e7aa013cd5cbd2dca61437bf8cf4d78e2a021721468f5ada)
def Claim_65f0d7131410 : Prop :=
  ‖((4 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49251169) / 50000000 : ℝ) : ℂ) - (((3448417) / 20000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 8f8abccd1a6c001755f3f97aed3b89a3f26087c855392c23d0fd15a0aa97732c)
theorem prove_Claim_65f0d7131410 : Claim_65f0d7131410 :=
  by
    unfold Claim_65f0d7131410
...
#rh_audit_axioms prove_Claim_65f0d7131410
