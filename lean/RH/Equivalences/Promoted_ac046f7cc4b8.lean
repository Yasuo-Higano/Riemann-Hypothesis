...
-- claim: zcb25k2-rot-n11 (ac046f7cc4b86d8c82696332a626bba53cbbf557e4958ba4da413b99b7c96abc)
def Claim_ac046f7cc4b8 : Prop :=
  ‖((11 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((95541419) / 100000000 : ℝ) : ℂ) - (((2952689) / 10000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((119) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 6922599b7f76c53bcda38c60aa43634a515e5ae291888cc8caf3bcefa9fd0050)
theorem prove_Claim_ac046f7cc4b8 : Claim_ac046f7cc4b8 :=
  by
    unfold Claim_ac046f7cc4b8
...
#rh_audit_axioms prove_Claim_ac046f7cc4b8
