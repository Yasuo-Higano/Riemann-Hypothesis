...
-- claim: zcb25k3-rot-n3 (21fcc61859301eea7efbe76d3104577080146f00cae1596f2081c11fd8c721b1)
def Claim_21fcc6185930 : Prop :=
  ‖((3 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((2494109) / 2500000 : ℝ) : ℂ) - (((6860933) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: ffbba8f31ea13e83a24ba93ed2a35d513faf62837e6088ce1e2bb2d286ed7cd8)
theorem prove_Claim_21fcc6185930 : Claim_21fcc6185930 :=
  by
    unfold Claim_21fcc6185930
...
#rh_audit_axioms prove_Claim_21fcc6185930
