...
-- claim: zcb5k2-rot-n4 (4169c55a5401604ff153e911488e6509783c06ae49c28103b2625481afef0b5e)
def Claim_4169c55a5401 : Prop :=
  ‖((4 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49251169) / 50000000 : ℝ) : ℂ) - (((3448417) / 20000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 063e997859599e9603b2cce8984912b540b1176417a2b3c973c6cdae68893998)
theorem prove_Claim_4169c55a5401 : Claim_4169c55a5401 :=
  by
    unfold Claim_4169c55a5401
...
#rh_audit_axioms prove_Claim_4169c55a5401
