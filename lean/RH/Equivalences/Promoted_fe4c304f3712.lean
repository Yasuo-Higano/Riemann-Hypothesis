...
-- claim: zcb902k6-rot-n29 (fe4c304f3712d20e8792ee5a042af6d974df96c8a5437e818b9eefdd6cdf9bff)
def Claim_fe4c304f3712 : Prop :=
  ‖((29 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 320 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((3124827) / 3125000 : ℝ) : ℂ) - (((1052261) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((11) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 86fc9a3f3d11af273b492cb466893bc6cdcf0b536de2c74d0919333af415ab6a)
theorem prove_Claim_fe4c304f3712 : Claim_fe4c304f3712 :=
  by
    unfold Claim_fe4c304f3712
...
#rh_audit_axioms prove_Claim_fe4c304f3712
