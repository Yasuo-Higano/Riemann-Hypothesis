...
-- claim: zcb10k2-rot-n9 (b74e17939939e65fe495545d21dccf2c8bf67b1a45c9802f7bb1f42b75906297)
def Claim_b74e17939939 : Prop :=
  ‖((9 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((96251933) / 100000000 : ℝ) : ℂ) - (((27121309) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((127) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: b0d6415006b1917eb4c6a7f2a8c2fbb16ae736f447fff1213e04e74cb92e307f)
theorem prove_Claim_b74e17939939 : Claim_b74e17939939 :=
  by
    unfold Claim_b74e17939939
...
#rh_audit_axioms prove_Claim_b74e17939939
