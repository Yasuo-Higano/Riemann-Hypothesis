...
-- claim: zcb99k0-rot-n17 (d1151a07341e98148b1500b2b01c8fdbefda8905d8808e3b4d52d340dc96e627)
def Claim_d1151a07341e : Prop :=
  ‖((17 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 64 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99902029) / 100000000 : ℝ) : ℂ) - (((88509) / 2000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: e377c31228e6e172985cdd8f6161b26a816b472fe8dddc46af7bd93f0b0e9feb)
theorem prove_Claim_d1151a07341e : Claim_d1151a07341e :=
  by
    unfold Claim_d1151a07341e
...
#rh_audit_axioms prove_Claim_d1151a07341e
