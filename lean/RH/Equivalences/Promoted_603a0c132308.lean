...
-- claim: zcb21k2-rot-n14 (603a0c132308fcb0d9fece980915e0afa90483535cd65a0e693aada3bdac6f95)
def Claim_603a0c132308 : Prop :=
  ‖((14 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((94608049) / 100000000 : ℝ) : ℂ) - (((8098291) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((127) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: aecc4c5a6e6199d013ef611fa6be3c69a6d7efcb9025307c7b923613ee6d6b3d)
theorem prove_Claim_603a0c132308 : Claim_603a0c132308 :=
  by
    unfold Claim_603a0c132308
...
#rh_audit_axioms prove_Claim_603a0c132308
