...
-- claim: zcb98k0-rot-n4 (84bc4454750882a099ebb90cb1c80358f8aea572f4a9f64ebcfe3dac4d628240)
def Claim_84bc44547508 : Prop :=
  ‖((4 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 64 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99976541) / 100000000 : ℝ) : ℂ) - (((541479) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: dae818de6ab0e340100e944293e3971ef4435f95ff9e234e50d7cbcfda4083fe)
theorem prove_Claim_84bc44547508 : Claim_84bc44547508 :=
  by
    unfold Claim_84bc44547508
...
#rh_audit_axioms prove_Claim_84bc44547508
