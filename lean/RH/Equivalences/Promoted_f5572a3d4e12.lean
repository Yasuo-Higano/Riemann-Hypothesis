...
-- claim: zcb24k2-rot-n5 (f5572a3d4e1269b9648c27e9e20baf48276c53d46f08a67c7aa28521cefa2a43)
def Claim_f5572a3d4e12 : Prop :=
  ‖((5 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((6123947) / 6250000 : ℝ) : ℂ) - (((9991271) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((7) / 20000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 19d36c3bbafb56e04ea01be84c5a33446b8561c13c59ec55efc7941d57e7ed58)
theorem prove_Claim_f5572a3d4e12 : Claim_f5572a3d4e12 :=
  by
    unfold Claim_f5572a3d4e12
...
#rh_audit_axioms prove_Claim_f5572a3d4e12
