...
-- claim: auto-exp-eta-partial-30-t142-term-11 (e34fb34c8140143621f7b497128970e18d3ab5dbaa7f93acb7d34fa0bea0a20d)
def Claim_e34fb34c8140 : Prop :=
  |Real.exp ((-119894781) / 100000000 : ℝ) - ((30151129) / 100000000 : ℝ)| ≤ ((3) / 25000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-exp-square, proof sha256: 65403c252abc56c7e034fe0d408aba416a68be3f43f6e3d8b62c73f4f126b970)
theorem prove_Claim_e34fb34c8140 : Claim_e34fb34c8140 :=
  by
    unfold Claim_e34fb34c8140
    have hb : |Real.exp ((-119894781) / 200000000 : ℝ) - ((13727511) / 25000000 : ℝ)| ≤ ((9) / 100000000 : ℝ) := by
      have h := prove_Claim_3d2166d04329
      unfold Claim_3d2166d04329 at h
      exact h
...
#rh_audit_axioms prove_Claim_e34fb34c8140
