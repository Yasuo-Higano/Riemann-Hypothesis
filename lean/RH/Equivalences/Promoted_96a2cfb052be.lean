...
-- claim: zcb13k2-rot-n5 (96a2cfb052be1d080e59bfc14e528edb48f29d5dfd0d4b24f62bbdfab04b05f0)
def Claim_96a2cfb052be : Prop :=
  ‖((5 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((6123947) / 6250000 : ℝ) : ℂ) - (((9991271) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((7) / 20000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 30822a4e566ad60d7213b531d5bb469316ee8ca5548957dbd7f5a2f6ce7bf389)
theorem prove_Claim_96a2cfb052be : Claim_96a2cfb052be :=
  by
    unfold Claim_96a2cfb052be
...
#rh_audit_axioms prove_Claim_96a2cfb052be
