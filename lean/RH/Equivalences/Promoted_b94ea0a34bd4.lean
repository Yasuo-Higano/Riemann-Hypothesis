...
-- claim: zcb14k2-rot-n8 (b94ea0a34bd46a77165278ae098118cf82eaf5878fb99571fd87e3bd1c755b47)
def Claim_b94ea0a34bd4 : Prop :=
  ‖((8 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((12080099) / 12500000 : ℝ) : ℂ) - (((25701309) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((19) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: e75fb8a4a0a64258f5777bed97d5ec1369d5c1063375bf902387067a666296df)
theorem prove_Claim_b94ea0a34bd4 : Claim_b94ea0a34bd4 :=
  by
    unfold Claim_b94ea0a34bd4
...
#rh_audit_axioms prove_Claim_b94ea0a34bd4
