...
-- claim: zcb15k2-rot-n17 (08517240256bd8e9feeb53a4539ffcae912054451e47e2ab531c3713c0a5037d)
def Claim_08517240256b : Prop :=
  ‖((17 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((93794103) / 100000000 : ℝ) : ℂ) - (((34679479) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((43) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 1299aca699a71145b24e9f3e02ca91d015a1fb75dde7a43f8d777d8f7d9c720b)
theorem prove_Claim_08517240256b : Claim_08517240256b :=
  by
    unfold Claim_08517240256b
...
#rh_audit_axioms prove_Claim_08517240256b
