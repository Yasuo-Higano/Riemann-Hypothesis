...
-- claim: zcb30k4-rot-n28 (35e7510128b4a77283351b8d79ce9b9c6068fecca270fbfa904db3dc18cc4fe2)
def Claim_35e7510128b4 : Prop :=
  ‖((28 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 160 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49989157) / 50000000 : ℝ) : ℂ) - (((2082477) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((11) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 96901f6f4f29395be88660d259ce1b3bb8c4b33c30e6cbc78b2eb18b301fb730)
theorem prove_Claim_35e7510128b4 : Claim_35e7510128b4 :=
  by
    unfold Claim_35e7510128b4
...
#rh_audit_axioms prove_Claim_35e7510128b4
