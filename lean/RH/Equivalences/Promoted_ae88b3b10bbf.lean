...
-- claim: zcb10k2-rot-n7 (ae88b3b10bbfb02e6ba3d3a0fd7b52327a289707650085634cdd595a3f858f5a)
def Claim_ae88b3b10bbf : Prop :=
  ‖((7 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((48528151) / 50000000 : ℝ) : ℂ) - (((6021183) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((31) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 1ba3f1bd39c62a58cfd78f4e57154b84b950b6d71cff390a11e26b853928afe6)
theorem prove_Claim_ae88b3b10bbf : Claim_ae88b3b10bbf :=
  by
    unfold Claim_ae88b3b10bbf
...
#rh_audit_axioms prove_Claim_ae88b3b10bbf
