...
-- claim: zcb12k2-rot-n7 (827a3c0fde7e112c065ec44125a937c51c72953f83f049915db946d516a8d7e2)
def Claim_827a3c0fde7e : Prop :=
  ‖((7 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((48528151) / 50000000 : ℝ) : ℂ) - (((6021183) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((31) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: e43a9874d3331ca489fcbd397b104d9d86d4742e1f0465c52c6d9f2085f9171c)
theorem prove_Claim_827a3c0fde7e : Claim_827a3c0fde7e :=
  by
    unfold Claim_827a3c0fde7e
...
#rh_audit_axioms prove_Claim_827a3c0fde7e
