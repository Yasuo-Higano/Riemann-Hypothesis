...
-- claim: zcb13k2-rot-n7 (144ec9604eda92b13b0327759d40f5816ea77498f92bc4c56fc2325c52f39df7)
def Claim_144ec9604eda : Prop :=
  ‖((7 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((48528151) / 50000000 : ℝ) : ℂ) - (((6021183) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((31) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 60f2d12755663a8992d59c502138bd26d8e6ebad546ab30498b784057fb464a7)
theorem prove_Claim_144ec9604eda : Claim_144ec9604eda :=
  by
    unfold Claim_144ec9604eda
...
#rh_audit_axioms prove_Claim_144ec9604eda
