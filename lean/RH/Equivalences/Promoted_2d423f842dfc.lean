...
-- claim: zcb30k1-rot-n17 (2d423f842dfc202096ddb7bf288ff6b74e6fdcacaac28d4706f971a2d3bdd976)
def Claim_2d423f842dfc : Prop :=
  ‖((17 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 20 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((9899829) / 10000000 : ℝ) : ℂ) - (((14118733) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((7) / 25000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: d4e0f7677ea37dde1423b533f01972fd9d304987a7b0ea6a66b94b5a4be60851)
theorem prove_Claim_2d423f842dfc : Claim_2d423f842dfc :=
  by
    unfold Claim_2d423f842dfc
...
#rh_audit_axioms prove_Claim_2d423f842dfc
