...
-- claim: zcb15k2-rot-n18 (fec88af30d9e3f46a80634c1d65fa4e70f8eb51fab61f81827d2e9581f2ba176)
def Claim_fec88af30d9e : Prop :=
  ‖((18 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((9354393) / 10000000 : ℝ) : ℂ) - (((138081) / 390625 : ℝ) : ℂ) * Complex.I)‖ ≤ ((127) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 81a9990fcad552605328885bba1bc110bcd3b85eadfa9c39afcc130610359daa)
theorem prove_Claim_fec88af30d9e : Claim_fec88af30d9e :=
  by
    unfold Claim_fec88af30d9e
...
#rh_audit_axioms prove_Claim_fec88af30d9e
