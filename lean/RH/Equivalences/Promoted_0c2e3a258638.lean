...
-- claim: zc-b8-c0-cell-j1 (0c2e3a25863859271a046b1e6845adf4ed8ac9922add32022e101320ea31d81c)
def Claim_0c2e3a258638 : Prop :=
  ∀ s : ℂ, ((1) / 2 : ℝ) ≤ s.re → s.re ≤ ((5) / 8 : ℝ) → ((4) / 1 : ℝ) ≤ s.im → s.im ≤ ((33) / 8 : ℝ) → RH.dirichletEtaEntire s ≠ 0

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-eta-grid, proof sha256: ff8b312ab9b72131a8b44113493a4cbd24824c5c4d0a576512a0428ac0780c9f)
theorem prove_Claim_0c2e3a258638 : Claim_0c2e3a258638 :=
  by
    unfold Claim_0c2e3a258638
...
#rh_audit_axioms prove_Claim_0c2e3a258638
