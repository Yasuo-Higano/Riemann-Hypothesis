...
-- claim: zcb14k2-rot-n14 (69eef222c60627d8d4e2b9774ee6973448471943c0c4a4954e70bc1cfd3de2e8)
def Claim_69eef222c606 : Prop :=
  ‖((14 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((94608049) / 100000000 : ℝ) : ℂ) - (((8098291) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((127) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 7c0e5d2d0ea0cdbea812c01277c4d7ad9773cce93798acb3334374ec6853ff34)
theorem prove_Claim_69eef222c606 : Claim_69eef222c606 :=
  by
    unfold Claim_69eef222c606
...
#rh_audit_axioms prove_Claim_69eef222c606
