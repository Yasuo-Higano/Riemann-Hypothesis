...
-- claim: zcb26k3-rot-n16 (538be1e10ab3ada6db72d3023df1b78ee503f76a8a991f701c0b7dd45e4a9ee7)
def Claim_538be1e10ab3 : Prop :=
  ‖((16 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49251169) / 50000000 : ℝ) : ℂ) - (((3448417) / 20000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: d82c7134a469f91beda4716990d5ffd89c13235f796d39f401414b78a5d5daee)
theorem prove_Claim_538be1e10ab3 : Claim_538be1e10ab3 :=
  by
    unfold Claim_538be1e10ab3
...
#rh_audit_axioms prove_Claim_538be1e10ab3
