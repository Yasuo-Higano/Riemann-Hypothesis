...
-- claim: zcb16k3-rot-n4 (6be4ca3ba5b6ad9e5454544c0185eb08c3ed9796d710fca0de5603b861eb653d)
def Claim_6be4ca3ba5b6 : Prop :=
  ‖((4 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99624881) / 100000000 : ℝ) : ℂ) - (((8653503) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 18e948cd70020743311712016721b2d2f795b24dd062c4399a5c94f918869617)
theorem prove_Claim_6be4ca3ba5b6 : Claim_6be4ca3ba5b6 :=
  by
    unfold Claim_6be4ca3ba5b6
...
#rh_audit_axioms prove_Claim_6be4ca3ba5b6
