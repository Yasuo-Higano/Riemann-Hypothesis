...
-- claim: zcb28k2-rot-n22 (867394d492afe7e5e6d5609bdb3c99e44667c0a7158864188b32da991ddbb1fd)
def Claim_867394d492af : Prop :=
  ‖((22 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 40 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99701569) / 100000000 : ℝ) : ℂ) - (((3859959) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((19) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 2702c68e673fd96bf198de34e890935108b4b671f4c5e675c180caec29b97b21)
theorem prove_Claim_867394d492af : Claim_867394d492af :=
  by
    unfold Claim_867394d492af
...
#rh_audit_axioms prove_Claim_867394d492af
