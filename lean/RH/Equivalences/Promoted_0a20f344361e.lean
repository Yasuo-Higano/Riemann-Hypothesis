...
-- claim: zcb2k2-rot-n9 (0a20f344361e4c6839247cbbf63f76cdd1543f8b7c32d6eace68cd7057788d1a)
def Claim_0a20f344361e : Prop :=
  ‖((9 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((96251933) / 100000000 : ℝ) : ℂ) - (((27121309) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((127) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 51dc27c75848239abf88f9511bc96b69ccdd6ee5ec58f115df65ffedae853b31)
theorem prove_Claim_0a20f344361e : Claim_0a20f344361e :=
  by
    unfold Claim_0a20f344361e
...
#rh_audit_axioms prove_Claim_0a20f344361e
