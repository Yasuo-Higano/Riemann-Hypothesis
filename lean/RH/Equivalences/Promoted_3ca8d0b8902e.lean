...
-- claim: zcb7k2-rot-n8 (3ca8d0b8902ed69d28cb449e4da73d022b9950a9da72a498afce7ddc2294e00b)
def Claim_3ca8d0b8902e : Prop :=
  ‖((8 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((12080099) / 12500000 : ℝ) : ℂ) - (((25701309) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((19) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 074f1d23941a3ead5898b362e44a5e346e43a4a97c6a1af8f0cb398304fb6e3e)
theorem prove_Claim_3ca8d0b8902e : Claim_3ca8d0b8902e :=
  by
    unfold Claim_3ca8d0b8902e
...
#rh_audit_axioms prove_Claim_3ca8d0b8902e
