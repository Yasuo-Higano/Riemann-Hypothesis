...
-- claim: zl3ch-rot-n12 (8a94f6d16b13cf9af52f89ad86b67f5f3c399df9907b682db649f63ea1f454f6)
def Claim_8a94f6d16b13 : Prop :=
  ‖((12 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 40 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99807101) / 100000000 : ℝ) : ℂ) - (((6208273) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((21) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: e3592ea525f0e8e0e1b889a50a56556617974cc79a718c8e845fae5ed3d46c6b)
theorem prove_Claim_8a94f6d16b13 : Claim_8a94f6d16b13 :=
  by
    unfold Claim_8a94f6d16b13
...
#rh_audit_axioms prove_Claim_8a94f6d16b13
