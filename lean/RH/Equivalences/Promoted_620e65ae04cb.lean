...
-- claim: zc-b28-c1-cell-j1 (620e65ae04cb06f6bd27ea020ce6e8ae036ee6b2f415418799acfdcd02715625)
def Claim_620e65ae04cb : Prop :=
  ∀ s : ℂ, ((939) / 1600 : ℝ) ≤ s.re → s.re ≤ ((1901) / 3200 : ℝ) → ((14) / 1 : ℝ) ≤ s.im → s.im ≤ ((2241) / 160 : ℝ) → RH.dirichletEtaEntire s ≠ 0

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-eta-grid, proof sha256: 12320609fb586b9119970862f6c9181881857774c29020ea0ca2e1bd00695201)
theorem prove_Claim_620e65ae04cb : Claim_620e65ae04cb :=
  by
    unfold Claim_620e65ae04cb
    ...
    have cell1 : ∀ s : ℂ, ((939) / 1600 : ℝ) ≤ s.re → s.re ≤ ((1901) / 3200 : ℝ) → ((14) / 1 : ℝ) ≤ s.im → s.im ≤ ((2241) / 160 : ℝ) → RH.dirichletEtaEntire s ≠ 0 := by
      ...
      intro s h1 h2 h3 h4
      have hb0 : ‖s‖ ≤ ((14019) / 1000 : ℝ) := by
        apply pnri _ (((1901) / 3200 : ℝ) + 0) (((2241) / 160 : ℝ)) _ ?_ ?_ (by norm_num) (by norm_num)
        · rw [abs_le]
          constructor <;> linarith
        · rw [abs_le]
          constructor <;> linarith
      have hb1 : ‖s + 1‖ ≤ ((17621) / 1250 : ℝ) := by
        apply pnri _ (((1901) / 3200 : ℝ) + 1) (((2241) / 160 : ℝ)) _ ?_ ?_ (by norm_num) (by norm_num)
        ...
        · simp only [Complex.add_im, Complex.one_im, Complex.im_ofNat]
          rw [abs_le]
          constructor <;> linarith
      have hb2 : ‖s + 2‖ ≤ ((71223) / 5000 : ℝ) := by
        apply pnri _ (((1901) / 3200 : ℝ) + 2) (((2241) / 160 : ℝ)) _ ?_ ?_ (by norm_num) (by norm_num)
        · simp only [Complex.add_re, Complex.one_re, Complex.re_ofNat]
          rw [abs_le]
          constructor <;> linarith
        · simp only [Complex.add_im, Complex.one_im, Complex.im_ofNat]
          rw [abs_le]
          constructor <;> linarith
      have hb3 : ‖s + 3‖ ≤ ((72301) / 5000 : ℝ) := by
        apply pnri _ (((1901) / 3200 : ℝ) + 3) (((2241) / 160 : ℝ)) _ ?_ ?_ (by norm_num) (by norm_num)
        · simp only [Complex.add_re, Complex.one_re, Complex.re_ofNat]
          rw [abs_le]
          constructor <;> linarith
        · simp only [Complex.add_im, Complex.one_im, Complex.im_ofNat]
          rw [abs_le]
          constructor <;> linarith
      have hE := punif s 30 ((14019) / 1000 : ℝ) ((17621) / 1250 : ℝ) ((71223) / 5000 : ℝ) ((72301) / 5000 : ℝ) ((110889) / 5000000 : ℝ)
      ...
      have hd : ‖s - ((((19) / 32 : ℝ) : ℂ) + (((4481) / 320 : ℝ) : ℂ) * Complex.I)‖ ≤ ((7553) / 1000000 : ℝ) := by
      ...
      have hlb : ((140597) / 500000 : ℝ) ≤ ‖((((34547) / 200000 : ℝ) : ℂ) + (((-221887) / 1000000 : ℝ) : ℂ) * Complex.I)‖ := by
        ...
        norm_num [Complex.normSq_apply, Complex.add_re, Complex.add_im, Complex.sub_re,
            Complex.sub_im, Complex.mul_re, Complex.mul_im, Complex.I_re, Complex.I_im,
            Complex.ofReal_re, Complex.ofReal_im]
      exact pnzc (RH.dirichletEtaEntire s) ((∑ n ∈ Finset.range 30, (-1 : ℂ) ^ (n + 1) * ((n : ℕ) : ℂ) ^ (-(s))) + (-1 : ℂ) ^ (30 + 1) * (((30 : ℕ) : ℂ) ^ (-(s)) / 2 + (((30 : ℕ) : ℂ) ^ (-(s)) - (((30 + 1 : ℕ)) : ℂ) ^ (-(s))) / 4 + (((30 : ℕ) : ℂ) ^ (-(s)) - 2 * (((30 + 1 : ℕ)) : ℂ) ^ (-(s)) + (((30 + 2 : ℕ)) : ℂ) ^ (-(s))) / 8 + (((30 : ℕ) : ℂ) ^ (-(s)) - 3 * (((30 + 1 : ℕ)) : ℂ) ^ (-(s)) + 3 * (((30 + 2 : ℕ)) : ℂ) ^ (-(s)) - (((30 + 3 : ℕ)) : ℂ) ^ (-(s))) / 16)) ((∑ n ∈ Finset.range 30, (-1 : ℂ) ^ (n + 1) * ((n : ℕ) : ℂ) ^ (-((((19) / 32 : ℝ) : ℂ) + (((4481) / 320 : ℝ) : ℂ) * Complex.I))) + (-1 : ℂ) ^ (30 + 1) * (((30 : ℕ) : ℂ) ^ (-((((19) / 32 : ℝ) : ℂ) + (((4481) / 320 : ℝ) : ℂ) * Complex.I)) / 2 + (((30 : ℕ) : ℂ) ^ (-((((19) / 32 : ℝ) : ℂ) + (((4481) / 320 : ℝ) : ℂ) * Complex.I)) - (((30 + 1 : ℕ)) : ℂ) ^ (-((((19) / 32 : ℝ) : ℂ) + (((4481) / 320 : ℝ) : ℂ) * Complex.I))) / 4 + (((30 : ℕ) : ℂ) ^ (-((((19) / 32 : ℝ) : ℂ) + (((4481) / 320 : ℝ) : ℂ) * Complex.I)) - 2 * (((30 + 1 : ℕ)) : ℂ) ^ (-((((19) / 32 : ℝ) : ℂ) + (((4481) / 320 : ℝ) : ℂ) * Complex.I)) + (((30 + 2 : ℕ)) : ℂ) ^ (-((((19) / 32 : ℝ) : ℂ) + (((4481) / 320 : ℝ) : ℂ) * Complex.I))) / 8 + (((30 : ℕ) : ℂ) ^ (-((((19) / 32 : ℝ) : ℂ) + (((4481) / 320 : ℝ) : ℂ) * Complex.I)) - 3 * (((30 + 1 : ℕ)) : ℂ) ^ (-((((19) / 32 : ℝ) : ℂ) + (((4481) / 320 : ℝ) : ℂ) * Complex.I)) + 3 * (((30 + 2 : ℕ)) : ℂ) ^ (-((((19) / 32 : ℝ) : ℂ) + (((4481) / 320 : ℝ) : ℂ) * Complex.I)) - (((30 + 3 : ℕ)) : ℂ) ^ (-((((19) / 32 : ℝ) : ℂ) + (((4481) / 320 : ℝ) : ℂ) * Complex.I))) / 16)) ((((34547) / 200000 : ℝ) : ℂ) + (((-221887) / 1000000 : ℝ) : ℂ) * Complex.I) ((110889) / 5000000 : ℝ) ((152859) / 1000000 : ℝ) ((498156) / 100000000 : ℝ) ((140597) / 500000 : ℝ) hE hLip hW hlb (by norm_num)
    intro s h1 h2 h3 h4
    exact cell1 s h1 h2 h3 h4
-- END UNTRUSTED PROOF

#rh_audit_axioms prove_Claim_620e65ae04cb
