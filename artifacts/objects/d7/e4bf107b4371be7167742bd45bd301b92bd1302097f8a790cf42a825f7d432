...
-- claim: zcb16k3-rot-n10 (bdff1d1fe2791348d455fc8ada3b5e8da38ce4b9bd1dc6af8b3a1e2ae1f8e16b)
def Claim_bdff1d1fe279 : Prop :=
  ‖((10 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((98966259) / 100000000 : ℝ) : ℂ) - (((3585383) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 1250000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: ba72e96222ec47e580f325a0118a317ce275a435232d1ff6dc4c31c1f724d91e)
theorem prove_Claim_bdff1d1fe279 : Claim_bdff1d1fe279 :=
  by
    unfold Claim_bdff1d1fe279
...
#rh_audit_axioms prove_Claim_bdff1d1fe279
