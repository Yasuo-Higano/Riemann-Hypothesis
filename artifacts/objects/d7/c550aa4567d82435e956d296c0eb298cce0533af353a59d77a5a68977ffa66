...
-- claim: zcb9k2-rot-n8 (eaa8d62c4124f5fc4ee83070bc5244f9fbe5bad4c8c94c4a7f30598bb0ef04c6)
def Claim_eaa8d62c4124 : Prop :=
  ‖((8 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((12080099) / 12500000 : ℝ) : ℂ) - (((25701309) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((19) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: f5ea1ea23cd44eb058c163015a584b72bff940e74bf201c1be93a34d89ace0b0)
theorem prove_Claim_eaa8d62c4124 : Claim_eaa8d62c4124 :=
  by
    unfold Claim_eaa8d62c4124
...
#rh_audit_axioms prove_Claim_eaa8d62c4124
