...
-- claim: zcb24k2-rot-n14 (6cfbc394b89b09c0d5a1d666a223317ef11bd382717afd494eda2b405b54ef4f)
def Claim_6cfbc394b89b : Prop :=
  ‖((14 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((94608049) / 100000000 : ℝ) : ℂ) - (((8098291) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((127) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: ae11428686d4f1fe4e86bf7c3ea8b930706773c79990d51f79e8ec1bcd332872)
theorem prove_Claim_6cfbc394b89b : Claim_6cfbc394b89b :=
  by
    unfold Claim_6cfbc394b89b
...
#rh_audit_axioms prove_Claim_6cfbc394b89b
