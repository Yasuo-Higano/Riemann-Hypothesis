...
-- claim: zcoeff-n15-m7o8 (30347dbd50b8808c695e0cc75c5d5f26e1078fb695257fe4d3356c9368154490)
def Claim_30347dbd50b8 : Prop :=
  ((∑ n ∈ Finset.range 15, Real.log n * (n : ℝ) ^ (-((7) / 8 : ℝ))) ≤ ((4429) / 1000 : ℝ)) ∧ (15 / 16 * (Real.log 15 * (15 : ℝ) ^ (-((7) / 8 : ℝ))) + 11 / 16 * (Real.log 16 * (16 : ℝ) ^ (-((7) / 8 : ℝ))) + 5 / 16 * (Real.log 17 * (17 : ℝ) ^ (-((7) / 8 : ℝ))) + 1 / 16 * (Real.log 18 * (18 : ℝ) ^ (-((7) / 8 : ℝ))) ≤ ((103) / 200 : ℝ))

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-eta-grid, proof sha256: 8af02b663992541156f5de6402f362f1905e2cf08d7161059109520920f21b3b)
theorem prove_Claim_30347dbd50b8 : Claim_30347dbd50b8 :=
  by
    unfold Claim_30347dbd50b8
...
#rh_audit_axioms prove_Claim_30347dbd50b8
