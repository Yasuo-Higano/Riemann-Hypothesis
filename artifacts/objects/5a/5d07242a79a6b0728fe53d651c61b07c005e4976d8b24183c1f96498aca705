...
-- claim: zcb25k3-rot-n10 (d031c42d05c2c419826c1603c551df4c4c2ec44c45985d28cbd86e6fddf6ad48)
def Claim_d031c42d05c2 : Prop :=
  ‖((10 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((98966259) / 100000000 : ℝ) : ℂ) - (((3585383) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 1250000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 1326fdd30173da05b0211663dd7706a00247801f0884aeffa3a94e4a0171962d)
theorem prove_Claim_d031c42d05c2 : Claim_d031c42d05c2 :=
  by
    unfold Claim_d031c42d05c2
...
#rh_audit_axioms prove_Claim_d031c42d05c2
