...
-- claim: zcb7k2-rot-n11 (35683954c711405792022914886258419cb244a00a18de75bcedee6489783a54)
def Claim_35683954c711 : Prop :=
  ‖((11 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((95541419) / 100000000 : ℝ) : ℂ) - (((2952689) / 10000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((119) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: fc4e2a21357357857523562d9036854628a33ee2db4bac1c1cf9d52b74af19d4)
theorem prove_Claim_35683954c711 : Claim_35683954c711 :=
  by
    unfold Claim_35683954c711
...
#rh_audit_axioms prove_Claim_35683954c711
