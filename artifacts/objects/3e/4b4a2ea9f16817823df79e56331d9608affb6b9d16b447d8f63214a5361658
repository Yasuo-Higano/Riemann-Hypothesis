...
-- claim: zcb25k3-rot-n12 (8cd7a63389b1e1b146ddafea80a03eb6ec982c6daefa6febb318da00f1c6cb07)
def Claim_8cd7a63389b1 : Prop :=
  ‖((12 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49398207) / 50000000 : ℝ) : ℂ) - (((1933539) / 12500000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 1250000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: aad1718201a832b32c17de045f9c5fbf3019b5aebc86a3fd14700dc204cab9f3)
theorem prove_Claim_8cd7a63389b1 : Claim_8cd7a63389b1 :=
  by
    unfold Claim_8cd7a63389b1
...
#rh_audit_axioms prove_Claim_8cd7a63389b1
