...
-- claim: zcb0k3-rot-n10 (79aa2507f2b5913c585d852cc85a967ea9d85463795987b5ce8062e6005ff4f8)
def Claim_79aa2507f2b5 : Prop :=
  ‖((10 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((98966259) / 100000000 : ℝ) : ℂ) - (((3585383) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 1250000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: de41eee1d27f4800bfe823d49d9ce8fada21328ef85f0416251be98e7c6f8f8f)
theorem prove_Claim_79aa2507f2b5 : Claim_79aa2507f2b5 :=
  by
    unfold Claim_79aa2507f2b5
...
#rh_audit_axioms prove_Claim_79aa2507f2b5
