...
-- claim: zcb28k3-rot-n16 (f3922cfe2a95fcb5e210a8898b47c4cc6c458514ff3f5292fbc2d2a212ac9488)
def Claim_f3922cfe2a95 : Prop :=
  ‖((16 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 80 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99939949) / 100000000 : ℝ) : ℂ) - (((1732521) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: b3ed13096cbe683fba1c40bed473ae5c97a86dba28653cff5fd2f9bbd054d562)
theorem prove_Claim_f3922cfe2a95 : Claim_f3922cfe2a95 :=
  by
    unfold Claim_f3922cfe2a95
    ...
    have hv : |((1) / 80 : ℝ) * Real.log ((16 : ℕ) : ℝ) - ((433217) / 12500000 : ℝ)| ≤ ((1) / 50000000 : ℝ) :=
      hssb (Real.log ((16 : ℕ) : ℝ)) ((1386294361) / 500000000 : ℝ) ((1201) / 1000000000000 : ℝ) (((1) / 80 : ℝ)) ((433217) / 12500000 : ℝ) ((1) / 100000000 : ℝ) ((1) / 50000000 : ℝ) hlog
        (by rw [abs_le]; constructor <;> norm_num)
    ...
    have hmain := prove_Claim_fe51a39a688e 16 ((0 : ℝ)) (((1) / 80 : ℝ)) (0 : ℝ) (1 : ℝ) ((3) / 100000000 : ℝ) ((1) / 100000000 : ℝ) ((433217) / 12500000 : ℝ) ((99939949) / 100000000 : ℝ) ((3) / 100000000 : ℝ) ((1732521) / 50000000 : ℝ) ((3) / 100000000 : ℝ) ((1) / 50000000 : ℝ)
    ...
    calc ‖((16 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 80 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99939949) / 100000000 : ℝ) : ℂ) - (((1732521) / 50000000 : ℝ) : ℂ) * Complex.I)‖
...
#rh_audit_axioms prove_Claim_f3922cfe2a95
