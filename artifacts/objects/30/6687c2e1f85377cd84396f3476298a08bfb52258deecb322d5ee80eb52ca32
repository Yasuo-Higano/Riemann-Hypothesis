...
-- claim: auto-exp-eta-partial-30-t14-term-15-s1 (e5be8f0a4a5ba6ca2b928ba209e5d2cf09d8975214911135247a4aadfdd96867)
def Claim_e5be8f0a4a5b : Prop :=
  |Real.exp ((-3385063) / 5000000 : ℝ) - ((6351659) / 12500000 : ℝ)| ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-exp-square, proof sha256: 85913983a1eae25e4c02b32279fe5861a2a8cc0356aae64d43382aa8529bb981)
theorem prove_Claim_e5be8f0a4a5b : Claim_e5be8f0a4a5b :=
  by
    unfold Claim_e5be8f0a4a5b
    have hb : |Real.exp ((-3385063) / 10000000 : ℝ) - ((71283429) / 100000000 : ℝ)| ≤ ((3) / 25000000 : ℝ) := by
      have h := prove_Claim_34d8c99b088a
      unfold Claim_34d8c99b088a at h
      exact h
...
#rh_audit_axioms prove_Claim_e5be8f0a4a5b
