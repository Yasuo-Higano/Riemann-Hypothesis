...
-- claim: zcb7k2-rot-n5 (e38dbe5e68fa5396bf92e3ccf72e0163fe10e8b868d7fee0912c34daf913483e)
def Claim_e38dbe5e68fa : Prop :=
  ‖((5 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((6123947) / 6250000 : ℝ) : ℂ) - (((9991271) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((7) / 20000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: a8833aa02681eed807503d6582b1a8f25fa0dec476a7b06c7f145a11ebdee4c4)
theorem prove_Claim_e38dbe5e68fa : Claim_e38dbe5e68fa :=
  by
    unfold Claim_e38dbe5e68fa
...
#rh_audit_axioms prove_Claim_e38dbe5e68fa
