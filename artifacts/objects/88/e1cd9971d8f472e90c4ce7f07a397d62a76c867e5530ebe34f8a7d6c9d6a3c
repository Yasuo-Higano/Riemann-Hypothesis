...
-- claim: zc-b28-c3-cell-j9 (09e31e1f2e330a8a1a7a9364f907c35dfa6bbe3775ede401a62d5f497350c335)
def Claim_09e31e1f2e33 : Prop :=
  ∀ s : ℂ, ((77) / 128 : ℝ) ≤ s.re → s.re ≤ ((1951) / 3200 : ℝ) → ((281) / 20 : ℝ) ≤ s.im → s.im ≤ ((2249) / 160 : ℝ) → RH.dirichletEtaEntire s ≠ 0

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-eta-grid, proof sha256: a1389f6bcb2eb60ed410b9399c76ee728498e6e2d906fa5e203a1098830d30f1)
theorem prove_Claim_09e31e1f2e33 : Claim_09e31e1f2e33 :=
  by
    unfold Claim_09e31e1f2e33
    ...
    have cell9 : ∀ s : ℂ, ((77) / 128 : ℝ) ≤ s.re → s.re ≤ ((1951) / 3200 : ℝ) → ((281) / 20 : ℝ) ≤ s.im → s.im ≤ ((2249) / 160 : ℝ) → RH.dirichletEtaEntire s ≠ 0 := by
      ...
      intro s h1 h2 h3 h4
      have hb0 : ‖s‖ ≤ ((17587) / 1250 : ℝ) := by
        apply pnri _ (((1951) / 3200 : ℝ) + 0) (((2249) / 160 : ℝ)) _ ?_ ?_ (by norm_num) (by norm_num)
        · rw [abs_le]
          constructor <;> linarith
        · rw [abs_le]
          constructor <;> linarith
      have hb1 : ‖s + 1‖ ≤ ((141483) / 10000 : ℝ) := by
        apply pnri _ (((1951) / 3200 : ℝ) + 1) (((2249) / 160 : ℝ)) _ ?_ ?_ (by norm_num) (by norm_num)
        ...
        · simp only [Complex.add_im, Complex.one_im, Complex.im_ofNat]
          rw [abs_le]
          constructor <;> linarith
      have hb2 : ‖s + 2‖ ≤ ((71483) / 5000 : ℝ) := by
        apply pnri _ (((1951) / 3200 : ℝ) + 2) (((2249) / 160 : ℝ)) _ ?_ ?_ (by norm_num) (by norm_num)
        · simp only [Complex.add_re, Complex.one_re, Complex.re_ofNat]
          rw [abs_le]
          constructor <;> linarith
        · simp only [Complex.add_im, Complex.one_im, Complex.im_ofNat]
          rw [abs_le]
          constructor <;> linarith
      have hb3 : ‖s + 3‖ ≤ ((1161) / 80 : ℝ) := by
        apply pnri _ (((1951) / 3200 : ℝ) + 3) (((2249) / 160 : ℝ)) _ ?_ ?_ (by norm_num) (by norm_num)
        · simp only [Complex.add_re, Complex.one_re, Complex.re_ofNat]
          rw [abs_le]
          constructor <;> linarith
        · simp only [Complex.add_im, Complex.one_im, Complex.im_ofNat]
          rw [abs_le]
          constructor <;> linarith
      have hE := punif s 30 ((17587) / 1250 : ℝ) ((141483) / 10000 : ℝ) ((71483) / 5000 : ℝ) ((1161) / 80 : ℝ) ((112509) / 5000000 : ℝ)
      ...
      have hd : ‖s - ((((39) / 64 : ℝ) : ℂ) + (((4497) / 320 : ℝ) : ℂ) * Complex.I)‖ ≤ ((263) / 31250 : ℝ) := by
      ...
      have hlb : ((58717) / 250000 : ℝ) ≤ ‖((((188651) / 1000000 : ℝ) : ℂ) + (((-139911) / 1000000 : ℝ) : ℂ) * Complex.I)‖ := by
        ...
        norm_num [Complex.normSq_apply, Complex.add_re, Complex.add_im, Complex.sub_re,
            Complex.sub_im, Complex.mul_re, Complex.mul_im, Complex.I_re, Complex.I_im,
            Complex.ofReal_re, Complex.ofReal_im]
      exact pnzc (RH.dirichletEtaEntire s) ((∑ n ∈ Finset.range 30, (-1 : ℂ) ^ (n + 1) * ((n : ℕ) : ℂ) ^ (-(s))) + (-1 : ℂ) ^ (30 + 1) * (((30 : ℕ) : ℂ) ^ (-(s)) / 2 + (((30 : ℕ) : ℂ) ^ (-(s)) - (((30 + 1 : ℕ)) : ℂ) ^ (-(s))) / 4 + (((30 : ℕ) : ℂ) ^ (-(s)) - 2 * (((30 + 1 : ℕ)) : ℂ) ^ (-(s)) + (((30 + 2 : ℕ)) : ℂ) ^ (-(s))) / 8 + (((30 : ℕ) : ℂ) ^ (-(s)) - 3 * (((30 + 1 : ℕ)) : ℂ) ^ (-(s)) + 3 * (((30 + 2 : ℕ)) : ℂ) ^ (-(s)) - (((30 + 3 : ℕ)) : ℂ) ^ (-(s))) / 16)) ((∑ n ∈ Finset.range 30, (-1 : ℂ) ^ (n + 1) * ((n : ℕ) : ℂ) ^ (-((((39) / 64 : ℝ) : ℂ) + (((4497) / 320 : ℝ) : ℂ) * Complex.I))) + (-1 : ℂ) ^ (30 + 1) * (((30 : ℕ) : ℂ) ^ (-((((39) / 64 : ℝ) : ℂ) + (((4497) / 320 : ℝ) : ℂ) * Complex.I)) / 2 + (((30 : ℕ) : ℂ) ^ (-((((39) / 64 : ℝ) : ℂ) + (((4497) / 320 : ℝ) : ℂ) * Complex.I)) - (((30 + 1 : ℕ)) : ℂ) ^ (-((((39) / 64 : ℝ) : ℂ) + (((4497) / 320 : ℝ) : ℂ) * Complex.I))) / 4 + (((30 : ℕ) : ℂ) ^ (-((((39) / 64 : ℝ) : ℂ) + (((4497) / 320 : ℝ) : ℂ) * Complex.I)) - 2 * (((30 + 1 : ℕ)) : ℂ) ^ (-((((39) / 64 : ℝ) : ℂ) + (((4497) / 320 : ℝ) : ℂ) * Complex.I)) + (((30 + 2 : ℕ)) : ℂ) ^ (-((((39) / 64 : ℝ) : ℂ) + (((4497) / 320 : ℝ) : ℂ) * Complex.I))) / 8 + (((30 : ℕ) : ℂ) ^ (-((((39) / 64 : ℝ) : ℂ) + (((4497) / 320 : ℝ) : ℂ) * Complex.I)) - 3 * (((30 + 1 : ℕ)) : ℂ) ^ (-((((39) / 64 : ℝ) : ℂ) + (((4497) / 320 : ℝ) : ℂ) * Complex.I)) + 3 * (((30 + 2 : ℕ)) : ℂ) ^ (-((((39) / 64 : ℝ) : ℂ) + (((4497) / 320 : ℝ) : ℂ) * Complex.I)) - (((30 + 3 : ℕ)) : ℂ) ^ (-((((39) / 64 : ℝ) : ℂ) + (((4497) / 320 : ℝ) : ℂ) * Complex.I))) / 16)) ((((188651) / 1000000 : ℝ) : ℂ) + (((-139911) / 1000000 : ℝ) : ℂ) * Complex.I) ((112509) / 5000000 : ℝ) ((6813) / 40000 : ℝ) ((500132) / 100000000 : ℝ) ((58717) / 250000 : ℝ) hE hLip hW hlb (by norm_num)
    intro s h1 h2 h3 h4
    exact cell9 s h1 h2 h3 h4
-- END UNTRUSTED PROOF

#rh_audit_axioms prove_Claim_09e31e1f2e33
