...
-- claim: zcb22k2-rot-n16 (939bded1f7b4ec62407fbf2c1c7bae5e6c396ab6f56c85c4a7565db8b4c0e6d0)
def Claim_939bded1f7b4 : Prop :=
  ‖((16 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((9405421) / 10000000 : ℝ) : ℂ) - (((1061491) / 3125000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((19) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: cd25cc1fd3195111c6144e88b7da3c33cb501457476eb462e2281c532b6fae53)
theorem prove_Claim_939bded1f7b4 : Claim_939bded1f7b4 :=
  by
    unfold Claim_939bded1f7b4
...
#rh_audit_axioms prove_Claim_939bded1f7b4
