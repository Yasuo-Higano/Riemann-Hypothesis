...
-- claim: zcb15k2-rot-n12 (c0bc222b69563d868bdd3b383a42b766a4f84d12fe52da24951a89be1958d0f4)
def Claim_c0bc222b6956 : Prop :=
  ‖((12 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((95214627) / 100000000 : ℝ) : ℂ) - (((15282137) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((29) / 20000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 7526ac69c581dcae0df50ba268d5fb30672d0a992942f5f8e1503550658b1924)
theorem prove_Claim_c0bc222b6956 : Claim_c0bc222b6956 :=
  by
    unfold Claim_c0bc222b6956
...
#rh_audit_axioms prove_Claim_c0bc222b6956
