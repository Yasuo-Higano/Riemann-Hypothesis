...
-- claim: zcb20k3-rot-n3 (e93ea8d3eb7ae153408ed1aac6e1a975ddbeb36894239298b8dbd6d61866c194)
def Claim_e93ea8d3eb7a : Prop :=
  ‖((3 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((2494109) / 2500000 : ℝ) : ℂ) - (((6860933) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 8b6a60fc0806d7150388a52e0edb3a41cd733f4907f3d5dbac26c86fc1b6e5ff)
theorem prove_Claim_e93ea8d3eb7a : Claim_e93ea8d3eb7a :=
  by
    unfold Claim_e93ea8d3eb7a
...
#rh_audit_axioms prove_Claim_e93ea8d3eb7a
