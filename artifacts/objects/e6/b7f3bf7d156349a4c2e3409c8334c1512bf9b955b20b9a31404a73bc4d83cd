...
-- claim: zcb15k3-rot-n10 (ee7e582d18d19ccc2d74ac26867fa09e29c5b980420f447d503d178c5b6d1b4a)
def Claim_ee7e582d18d1 : Prop :=
  ‖((10 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((98966259) / 100000000 : ℝ) : ℂ) - (((3585383) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 1250000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 2b441c9baa584accfcf43b94e1322cc6534184f3acdc7ee6d5ecb71ace6df89b)
theorem prove_Claim_ee7e582d18d1 : Claim_ee7e582d18d1 :=
  by
    unfold Claim_ee7e582d18d1
...
#rh_audit_axioms prove_Claim_ee7e582d18d1
