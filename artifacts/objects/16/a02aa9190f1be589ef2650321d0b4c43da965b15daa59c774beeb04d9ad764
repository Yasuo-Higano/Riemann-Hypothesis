...
-- claim: zcb20k3-rot-n15 (5722cc08bed276dabbc2f7fdeaae847ba363ef86dae113f161c0f559866bd3e8)
def Claim_5722cc08bed2 : Prop :=
  ‖((15 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((19714217) / 20000000 : ℝ) : ℂ) - (((8422311) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((3) / 10000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 9309b9dd1c25049eade8c1535f3d98ed792890520f213956012c6c0a0ef89716)
theorem prove_Claim_5722cc08bed2 : Claim_5722cc08bed2 :=
  by
    unfold Claim_5722cc08bed2
...
#rh_audit_axioms prove_Claim_5722cc08bed2
