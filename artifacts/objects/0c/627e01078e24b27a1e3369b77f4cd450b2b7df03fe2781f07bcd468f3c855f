...
-- claim: zcb23k2-rot-n16 (d1068fab5b651f084e080c0624ce8bf5883c974aa9035b009b623eb5885d1613)
def Claim_d1068fab5b65 : Prop :=
  ‖((16 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((9405421) / 10000000 : ℝ) : ℂ) - (((1061491) / 3125000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((19) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 079551d878d0275c203b0e77124b82ce90855a35ac6b47605e026d44c362ca8a)
theorem prove_Claim_d1068fab5b65 : Claim_d1068fab5b65 :=
  by
    unfold Claim_d1068fab5b65
...
#rh_audit_axioms prove_Claim_d1068fab5b65
