...
-- claim: zcb19k4-rot-n4 (651cccd1f91c1c90a2f824e9a28bb9db8e1aa646e0ede3d03ea7ab784f58fc23)
def Claim_651cccd1f91c : Prop :=
  ‖((4 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 32 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((780517) / 781250 : ℝ) : ℂ) - (((866163) / 20000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 48e782fd779f545cb523e980d122330af5f65473f484c1102cb4176f1eaed991)
theorem prove_Claim_651cccd1f91c : Claim_651cccd1f91c :=
  by
    unfold Claim_651cccd1f91c
...
#rh_audit_axioms prove_Claim_651cccd1f91c
