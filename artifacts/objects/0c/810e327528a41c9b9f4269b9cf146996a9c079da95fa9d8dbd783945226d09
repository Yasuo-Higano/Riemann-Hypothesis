...
-- claim: zcb21k3-rot-n13 (b095c4d89d7b5686a469faf809ed260566e3a6286f209bee5a6b60949038c56a)
def Claim_b095c4d89d7b : Prop :=
  ‖((13 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((19743559) / 20000000 : ℝ) : ℂ) - (((399059) / 2500000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 2500000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 70e0b8752e9ec86c0c5a970a1769f7ee1b0baa24d6dab0b7c574da4528a1b4ee)
theorem prove_Claim_b095c4d89d7b : Claim_b095c4d89d7b :=
  by
    unfold Claim_b095c4d89d7b
...
#rh_audit_axioms prove_Claim_b095c4d89d7b
