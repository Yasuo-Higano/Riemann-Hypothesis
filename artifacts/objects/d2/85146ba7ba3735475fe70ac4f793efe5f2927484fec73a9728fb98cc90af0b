...
-- claim: zl3coeff-k12-m7o8 (3eb3fa257ed3c974dc9acf58b7aa8d96f03319c9d612adf10c7676ea3407bd9a)
def Claim_3eb3fa257ed3 : Prop :=
  (∑ k ∈ Finset.range 12, (Real.log ((3 * k + 1 : ℕ)) * (((3 * k + 1 : ℕ)) : ℝ) ^ (-(((7) / 8 : ℝ))) + Real.log ((3 * k + 2 : ℕ)) * (((3 * k + 2 : ℕ)) : ℝ) ^ (-(((7) / 8 : ℝ))) + 2 * (Real.log ((3 * k + 3 : ℕ)) * (((3 * k + 3 : ℕ)) : ℝ) ^ (-(((7) / 8 : ℝ)))))) ≤ ((2341) / 200 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-lam3, proof sha256: 2535dc3c90af8a2fbe261760c42637dfaefebb208db69104c68f924aecb2b390)
theorem prove_Claim_3eb3fa257ed3 : Claim_3eb3fa257ed3 :=
  by
    unfold Claim_3eb3fa257ed3
...
#rh_audit_axioms prove_Claim_3eb3fa257ed3
