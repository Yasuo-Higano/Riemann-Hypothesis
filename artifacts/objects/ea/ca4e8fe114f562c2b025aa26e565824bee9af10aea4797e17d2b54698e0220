...
-- claim: zcb28k1-rot-n6 (a6bcb34d1c7fd558548814561c5ba2e7b9022de3209423606bcb2a3f547fdb90)
def Claim_a6bcb34d1c7f : Prop :=
  ‖((6 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 20 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((12449871) / 12500000 : ℝ) : ℂ) - (((4473409) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: c913fbaa703d8f37d63233d441991dad0b19dc662b63f16714d3c159570108ca)
theorem prove_Claim_a6bcb34d1c7f : Claim_a6bcb34d1c7f :=
  by
    unfold Claim_a6bcb34d1c7f
...
#rh_audit_axioms prove_Claim_a6bcb34d1c7f
