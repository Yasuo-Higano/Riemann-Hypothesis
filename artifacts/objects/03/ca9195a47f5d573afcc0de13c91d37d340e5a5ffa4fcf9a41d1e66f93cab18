...
-- claim: zcoeff-n30-m1o2 (46271ba3f616ae6946cc508db91786e64eaf4820d81826f27e55d30c7cec701f)
def Claim_46271ba3f616 : Prop :=
  ((∑ n ∈ Finset.range 30, Real.log n * (n : ℝ) ^ (-((1) / 2 : ℝ))) ≤ ((9491) / 500 : ℝ)) ∧ (15 / 16 * (Real.log 30 * (30 : ℝ) ^ (-((1) / 2 : ℝ))) + 11 / 16 * (Real.log 31 * (31 : ℝ) ^ (-((1) / 2 : ℝ))) + 5 / 16 * (Real.log 32 * (32 : ℝ) ^ (-((1) / 2 : ℝ))) + 1 / 16 * (Real.log 33 * (33 : ℝ) ^ (-((1) / 2 : ℝ))) ≤ ((157) / 125 : ℝ))

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-eta-grid, proof sha256: 59a01e85896c6ed3473cc8659fd1d6d3e2403a2810094e1a2e621700909a99f3)
theorem prove_Claim_46271ba3f616 : Claim_46271ba3f616 :=
  by
    unfold Claim_46271ba3f616
...
#rh_audit_axioms prove_Claim_46271ba3f616
