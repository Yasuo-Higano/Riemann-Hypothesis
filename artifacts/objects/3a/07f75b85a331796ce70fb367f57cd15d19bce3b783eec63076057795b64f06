...
-- claim: zcb14k2-rot-n5 (428b72519bfc19c27b381eef812c802bf8e3ee08708cab55b2b03b09f42b4ebc)
def Claim_428b72519bfc : Prop :=
  ‖((5 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((6123947) / 6250000 : ℝ) : ℂ) - (((9991271) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((7) / 20000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: f24edbf2bdd510ec2fd164a5dc98052e964f570ed86e70e5772a40346baed4d9)
theorem prove_Claim_428b72519bfc : Claim_428b72519bfc :=
  by
    unfold Claim_428b72519bfc
...
#rh_audit_axioms prove_Claim_428b72519bfc
