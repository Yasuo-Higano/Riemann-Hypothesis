...
-- claim: zcb21k2-rot-n8 (a7fe458abb9e480a67955585c778893bc1404ba5a885a2ca3aa427dcc4620073)
def Claim_a7fe458abb9e : Prop :=
  ‖((8 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((12080099) / 12500000 : ℝ) : ℂ) - (((25701309) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((19) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 37ecf03c6e693577c08a1f974a7c832174f27ef38d0f4ea0c75c4ef03052b28a)
theorem prove_Claim_a7fe458abb9e : Claim_a7fe458abb9e :=
  by
    unfold Claim_a7fe458abb9e
...
#rh_audit_axioms prove_Claim_a7fe458abb9e
