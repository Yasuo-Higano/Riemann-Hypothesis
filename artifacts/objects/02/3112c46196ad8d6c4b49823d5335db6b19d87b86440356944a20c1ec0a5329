...
-- claim: zcb1k3-rot-n2 (02717bbde0aa3ae79300720979a24478322ce76bc33e44356b48d2950b42bb8c)
def Claim_02717bbde0aa : Prop :=
  ‖((2 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((780517) / 781250 : ℝ) : ℂ) - (((866163) / 20000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: fb5b9cdfb478e763c245943408a4330f2a882cf8147e4df459afbe34c2097fb7)
theorem prove_Claim_02717bbde0aa : Claim_02717bbde0aa :=
  by
    unfold Claim_02717bbde0aa
...
#rh_audit_axioms prove_Claim_02717bbde0aa
