...
-- claim: auto-exp-eta-partial-30-t142-term-15-s1 (2d73a8a6e00847bd08a3ec884da09ae4064637f6b03447f81aef155e92b2f1f5)
def Claim_2d73a8a6e008 : Prop :=
  |Real.exp ((-3385063) / 5000000 : ℝ) - ((6351659) / 12500000 : ℝ)| ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-exp-square, proof sha256: 1052bf1c25ea9057b5b79a2c93322f709e9195abf630e5914ba6ebb06aaf794d)
theorem prove_Claim_2d73a8a6e008 : Claim_2d73a8a6e008 :=
  by
    unfold Claim_2d73a8a6e008
    have hb : |Real.exp ((-3385063) / 10000000 : ℝ) - ((71283429) / 100000000 : ℝ)| ≤ ((3) / 25000000 : ℝ) := by
      have h := prove_Claim_619616e7b36d
      unfold Claim_619616e7b36d at h
      exact h
...
#rh_audit_axioms prove_Claim_2d73a8a6e008
