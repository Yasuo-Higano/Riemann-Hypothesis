...
-- claim: zcb30k3-rot-n27 (0fd60c1f2cab506adeaf288c6f1c3cfb1343127dff7999a9f4ed47f91c2a05bb)
def Claim_0fd60c1f2cab : Prop :=
  ‖((27 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 80 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((24978787) / 25000000 : ℝ) : ℂ) - (((514829) / 12500000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((3) / 12500000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 92b3a8e0437c3c06c2e15c024e8ad94c82cc376e1515183a57be266d5d3710c5)
theorem prove_Claim_0fd60c1f2cab : Claim_0fd60c1f2cab :=
  by
    unfold Claim_0fd60c1f2cab
...
#rh_audit_axioms prove_Claim_0fd60c1f2cab
