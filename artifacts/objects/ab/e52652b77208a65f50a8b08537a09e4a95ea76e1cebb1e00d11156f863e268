...
-- claim: zcb22k2-rot-n13 (066e9c320ac518ddba26e1a9d56a65f8f63718f78fb2038856ae6c9f7f235118)
def Claim_066e9c320ac5 : Prop :=
  ‖((13 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((94904061) / 100000000 : ℝ) : ℂ) - (((31515379) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((13) / 20000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 5a3485168b59528bbb2b8c9958837bccd160291fbdbe2d3f4c1f93912f084939)
theorem prove_Claim_066e9c320ac5 : Claim_066e9c320ac5 :=
  by
    unfold Claim_066e9c320ac5
...
#rh_audit_axioms prove_Claim_066e9c320ac5
