...
-- claim: zcb16k4-rot-n5 (bfbc22c49688e2bd158d67b54b61def07e6a20502a015789af69a719c992655a)
def Claim_bfbc22c49688 : Prop :=
  ‖((5 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 32 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((24968387) / 25000000 : ℝ) : ℂ) - (((2513687) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((11) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 582e785f582dd810f24a612a0f1c6cf0da360912bd104b53bf989923825602a4)
theorem prove_Claim_bfbc22c49688 : Claim_bfbc22c49688 :=
  by
    unfold Claim_bfbc22c49688
...
#rh_audit_axioms prove_Claim_bfbc22c49688
