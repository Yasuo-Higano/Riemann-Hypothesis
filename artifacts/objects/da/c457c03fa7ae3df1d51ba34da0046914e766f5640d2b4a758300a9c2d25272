...
-- claim: zcb30k5-rot-n22 (08bd85029e740ddc0a4d1eb80f9e674e3180540f89355eb30b8d3b13694f60d2)
def Claim_08bd85029e74 : Prop :=
  ‖((22 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 320 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((19999067) / 20000000 : ℝ) : ℂ) - (((60371) / 6250000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 01ac656b5c72e3e09d3f4c4af91bc07bed2bb4feba5f13a6a13c8d06f3191594)
theorem prove_Claim_08bd85029e74 : Claim_08bd85029e74 :=
  by
    unfold Claim_08bd85029e74
...
#rh_audit_axioms prove_Claim_08bd85029e74
