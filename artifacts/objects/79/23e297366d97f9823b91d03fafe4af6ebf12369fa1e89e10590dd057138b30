...
-- claim: zcb0k2-b-n6 (4d753eb617cf18fc684d2feb1912f37303300e45ae6ba017e986d842b094e834)
def Claim_4d753eb617cf : Prop :=
  ‖((6 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((-1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99373623) / 100000000 : ℝ) : ℂ) - (((-5587553) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: d1a2aec6518c85ebb25ffac316bb7517c6552a9b92737c0461da4eb01fc9867e)
theorem prove_Claim_4d753eb617cf : Claim_4d753eb617cf :=
  by
    unfold Claim_4d753eb617cf
    ...
    have hcosi := prove_Claim_a974fd78e18c ((-11198497) / 100000000 : ℝ) ((99373623) / 100000000 : ℝ) 14 ((1) / 50000000 : ℝ) ((1) / 100000000 : ℝ)
      (by rw [abs_of_nonpos (by norm_num : ((-11198497) / 100000000 : ℝ) ≤ 0)]; norm_num)
      (by norm_num [Finset.sum_range_succ, Finset.sum_range_zero, Nat.factorial])
      (by rw [abs_of_nonpos (by norm_num : ((-11198497) / 100000000 : ℝ) ≤ 0)]; norm_num)
    ...
    rw [abs_of_nonneg (by norm_num : (0:ℝ) ≤ (1 : ℝ)), abs_of_nonneg (by norm_num : (0:ℝ) ≤ ((99373623) / 100000000 : ℝ)), abs_of_nonpos (by norm_num : ((-5587553) / 50000000 : ℝ) ≤ 0)] at hmain
...
#rh_audit_axioms prove_Claim_4d753eb617cf
