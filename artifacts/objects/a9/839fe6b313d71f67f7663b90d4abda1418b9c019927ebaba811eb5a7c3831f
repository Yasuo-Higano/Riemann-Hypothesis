...
-- claim: zcb9k2-rot-n11 (23804aec9ccb1c599fb7922395d22ecb609deb84797b6e8bb6622dbfa660b68f)
def Claim_23804aec9ccb : Prop :=
  ‖((11 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((95541419) / 100000000 : ℝ) : ℂ) - (((2952689) / 10000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((119) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: c5abc7f57f8980da44d91f20dee5f8bf28f8122a969f262b38a9482c0a0abefa)
theorem prove_Claim_23804aec9ccb : Claim_23804aec9ccb :=
  by
    unfold Claim_23804aec9ccb
...
#rh_audit_axioms prove_Claim_23804aec9ccb
