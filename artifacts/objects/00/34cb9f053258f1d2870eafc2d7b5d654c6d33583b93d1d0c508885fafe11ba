...
-- claim: zcb30k4-rot-n32 (0218b7c6056a2b14dec3de36084ed8f532873c9cd63589d7de506c48e839cb28)
def Claim_0218b7c6056a : Prop :=
  ‖((32 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 160 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99976541) / 100000000 : ℝ) : ℂ) - (((541479) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 89a46acdf98652295e1e7201e8dcb659a2a159510cf6b9de6e2a205f54a96182)
theorem prove_Claim_0218b7c6056a : Claim_0218b7c6056a :=
  by
    unfold Claim_0218b7c6056a
...
#rh_audit_axioms prove_Claim_0218b7c6056a
