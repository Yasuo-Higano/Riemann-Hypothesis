...
-- claim: zcb23k2-rot-n14 (fd795fee76af2fe21f65507a6330c1ee307d756015e7cda1c301c8dabb2a99c2)
def Claim_fd795fee76af : Prop :=
  ‖((14 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((94608049) / 100000000 : ℝ) : ℂ) - (((8098291) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((127) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: fddf17a91af509133bf9a277656d90e96dd5ee43e6db4f9d931a3ab4cebc40ef)
theorem prove_Claim_fd795fee76af : Claim_fd795fee76af :=
  by
    unfold Claim_fd795fee76af
...
#rh_audit_axioms prove_Claim_fd795fee76af
