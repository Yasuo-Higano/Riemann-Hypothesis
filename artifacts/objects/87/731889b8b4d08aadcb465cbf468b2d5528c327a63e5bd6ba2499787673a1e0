...
-- claim: zcb16k3-rot-n3 (db0726c8fa044c253ae100b87b5ec79a7dcf17f275d733c11d6415de23c0f390)
def Claim_db0726c8fa04 : Prop :=
  ‖((3 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((2494109) / 2500000 : ℝ) : ℂ) - (((6860933) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 1b00409dfbfbcdab46dbbdf595be62ecfc7599a37f0fdeb1c81cb2bd176ae6d2)
theorem prove_Claim_db0726c8fa04 : Claim_db0726c8fa04 :=
  by
    unfold Claim_db0726c8fa04
...
#rh_audit_axioms prove_Claim_db0726c8fa04
