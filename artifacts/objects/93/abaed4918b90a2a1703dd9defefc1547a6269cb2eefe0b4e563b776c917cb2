...
-- claim: zcb98k0-rot-n17 (c5faa86979fbc3d7167478645ce05cef46dc5b15b086d4a59fe0cf0e2405470f)
def Claim_c5faa86979fb : Prop :=
  ‖((17 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 64 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99902029) / 100000000 : ℝ) : ℂ) - (((88509) / 2000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 508ab6db0ad6d8ae71cc59eaac690ff0e4681681cc0147ab014c13f192d80998)
theorem prove_Claim_c5faa86979fb : Claim_c5faa86979fb :=
  by
    unfold Claim_c5faa86979fb
...
#rh_audit_axioms prove_Claim_c5faa86979fb
