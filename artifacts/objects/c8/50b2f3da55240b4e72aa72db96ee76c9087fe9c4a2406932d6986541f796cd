...
-- claim: zcb0k2-b-n10 (71473270839e00e7e621e82d39760a67673695630a56471c02f309cf2f8fdbb5)
def Claim_71473270839e : Prop :=
  ‖((10 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((-1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((98966259) / 100000000 : ℝ) : ℂ) - (((-3585383) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 1250000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 504e852fb50ea1e456ed2f4bee35603779f1363e9527f25fc16020b180a9f019)
theorem prove_Claim_71473270839e : Claim_71473270839e :=
  by
    unfold Claim_71473270839e
    ...
    have hcosi := prove_Claim_a974fd78e18c ((-2878231) / 20000000 : ℝ) ((98966259) / 100000000 : ℝ) 14 ((1) / 50000000 : ℝ) ((1) / 100000000 : ℝ)
      (by rw [abs_of_nonpos (by norm_num : ((-2878231) / 20000000 : ℝ) ≤ 0)]; norm_num)
      (by norm_num [Finset.sum_range_succ, Finset.sum_range_zero, Nat.factorial])
      (by rw [abs_of_nonpos (by norm_num : ((-2878231) / 20000000 : ℝ) ≤ 0)]; norm_num)
    ...
    rw [abs_of_nonneg (by norm_num : (0:ℝ) ≤ (1 : ℝ)), abs_of_nonneg (by norm_num : (0:ℝ) ≤ ((98966259) / 100000000 : ℝ)), abs_of_nonpos (by norm_num : ((-3585383) / 25000000 : ℝ) ≤ 0)] at hmain
...
#rh_audit_axioms prove_Claim_71473270839e
