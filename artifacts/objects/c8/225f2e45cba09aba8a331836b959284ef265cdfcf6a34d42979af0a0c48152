...
-- claim: zcb902k6-rot-n22 (d54540ffa555b223ed2badef1e9ad1d7996bfad55312d56b83646ea8d6a45d0f)
def Claim_d54540ffa555 : Prop :=
  ‖((22 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 320 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((19999067) / 20000000 : ℝ) : ℂ) - (((60371) / 6250000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: a70c319a266580ad57b6b9e2c6300a616938c1ca7101be879456201c4f93003f)
theorem prove_Claim_d54540ffa555 : Claim_d54540ffa555 :=
  by
    unfold Claim_d54540ffa555
...
#rh_audit_axioms prove_Claim_d54540ffa555
