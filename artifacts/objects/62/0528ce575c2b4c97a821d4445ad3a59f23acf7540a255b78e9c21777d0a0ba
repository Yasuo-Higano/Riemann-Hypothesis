...
-- claim: zcb16k3-rot-n8 (651aee07d6ba3f7debc80491d0c1eb1b3f48a63779a56e5fb026b4ebfd5a2b57)
def Claim_651aee07d6ba : Prop :=
  ‖((8 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49578321) / 50000000 : ℝ) : ℂ) - (((6479977) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 06fc6126889b2478e7967686ec97740f2dbcf1b2bed585c71c839c708f193171)
theorem prove_Claim_651aee07d6ba : Claim_651aee07d6ba :=
  by
    unfold Claim_651aee07d6ba
...
#rh_audit_axioms prove_Claim_651aee07d6ba
