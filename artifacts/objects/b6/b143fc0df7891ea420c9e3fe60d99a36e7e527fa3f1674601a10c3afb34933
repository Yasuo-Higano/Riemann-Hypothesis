...
-- claim: zcb4k3-rot-n3 (508386bd3722266a8147135ffdead730c266b1c7f8312a556ab1c4f4d1a8c360)
def Claim_508386bd3722 : Prop :=
  ‖((3 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((2494109) / 2500000 : ℝ) : ℂ) - (((6860933) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 9470b00a5e01eee66dafb0743319c4ddc954fdc97ee6e71ee4e1e51f08addd44)
theorem prove_Claim_508386bd3722 : Claim_508386bd3722 :=
  by
    unfold Claim_508386bd3722
...
#rh_audit_axioms prove_Claim_508386bd3722
