...
-- claim: auto-exp-eta-partial-30-t14-term-5 (03a06cb733bd89814329a0e868d90025718905ccdfab59865002f34c2ef43bca)
def Claim_03a06cb733bd : Prop :=
  |Real.exp ((-40235949) / 50000000 : ℝ) - ((44721359) / 100000000 : ℝ)| ≤ ((57) / 25000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-exp-square, proof sha256: 291e4eb9aede16d84d3423914af5c66a2439495dfd7f22a6420c7b1626f85e1f)
theorem prove_Claim_03a06cb733bd : Claim_03a06cb733bd :=
  by
    unfold Claim_03a06cb733bd
    have hb : |Real.exp ((-40235949) / 100000000 : ℝ) - ((6687403) / 10000000 : ℝ)| ≤ ((21) / 12500000 : ℝ) := by
      have h := prove_Claim_5c9bbbbf47bf
      unfold Claim_5c9bbbbf47bf at h
      exact h
...
#rh_audit_axioms prove_Claim_03a06cb733bd
