...
-- claim: zcb99k0-rot-n6 (9a3fa1a230d1d0928aaa70a1963d52aa4ad5200c4f50ec478b63911424af0e1a)
def Claim_9a3fa1a230d1 : Prop :=
  ‖((6 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 64 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99960813) / 100000000 : ℝ) : ℂ) - (((1399629) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 28f6f501386288548f05ee74144f9058c4a9908bb3e279bcbc603531e9baec1a)
theorem prove_Claim_9a3fa1a230d1 : Claim_9a3fa1a230d1 :=
  by
    unfold Claim_9a3fa1a230d1
...
#rh_audit_axioms prove_Claim_9a3fa1a230d1
