...
-- claim: zcb9k2-rot-n7 (fda8484bd8152ba31064c0444c711e71dbde2de5458fd81278d9affeaff4f0c3)
def Claim_fda8484bd815 : Prop :=
  ‖((7 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((48528151) / 50000000 : ℝ) : ℂ) - (((6021183) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((31) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 6abf6190b1c57426afdcb19122e21e942cf7e694a5e908c6607a38f6eec77d5a)
theorem prove_Claim_fda8484bd815 : Claim_fda8484bd815 :=
  by
    unfold Claim_fda8484bd815
...
#rh_audit_axioms prove_Claim_fda8484bd815
