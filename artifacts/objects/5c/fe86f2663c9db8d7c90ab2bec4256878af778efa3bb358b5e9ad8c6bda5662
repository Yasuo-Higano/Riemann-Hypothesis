...
-- claim: zcb21k2-rot-n11 (e74d3cf4d0ae67db12c959b7071168b14b850f555b0f7037c8ca9cac96a7dcb4)
def Claim_e74d3cf4d0ae : Prop :=
  ‖((11 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((95541419) / 100000000 : ℝ) : ℂ) - (((2952689) / 10000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((119) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: c148a2e20a2861b86146fde36b087749ad830274f2f929b8e1fde5e3202f9ef3)
theorem prove_Claim_e74d3cf4d0ae : Claim_e74d3cf4d0ae :=
  by
    unfold Claim_e74d3cf4d0ae
...
#rh_audit_axioms prove_Claim_e74d3cf4d0ae
