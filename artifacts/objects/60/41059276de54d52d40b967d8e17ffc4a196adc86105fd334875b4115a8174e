...
-- claim: zl3ch-rot-n11 (b90cfeaba7cb7fd2199c8950ac48c41a5cb9980fb334bccfa921d27db15717a2)
def Claim_b90cfeaba7cb : Prop :=
  ‖((11 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 40 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99820369) / 100000000 : ℝ) : ℂ) - (((5991149) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((19) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 631b4dd8f7d9b9aadd99e021e19925f26b18542283959b4a1b4828c32b3a1a62)
theorem prove_Claim_b90cfeaba7cb : Claim_b90cfeaba7cb :=
  by
    unfold Claim_b90cfeaba7cb
...
#rh_audit_axioms prove_Claim_b90cfeaba7cb
