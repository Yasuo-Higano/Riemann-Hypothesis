...
-- claim: zcb902k6-rot-n18 (ac1d9dac2ecd4664539c22fa879a092af315ac527a4ed7d55a4c858419a87f8a)
def Claim_ac1d9dac2ecd : Prop :=
  ‖((18 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 320 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99995921) / 100000000 : ℝ) : ℂ) - (((903229) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 5eda52ac7cf23aaaf49b1e3b892d42ac2b2ef873b532a39465415ef809f2d1fd)
theorem prove_Claim_ac1d9dac2ecd : Claim_ac1d9dac2ecd :=
  by
    unfold Claim_ac1d9dac2ecd
...
#rh_audit_axioms prove_Claim_ac1d9dac2ecd
