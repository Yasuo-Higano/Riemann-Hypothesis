...
-- claim: zcb15k3-rot-n6 (75b39504f8dd55aebe506b6fe249d90cae264097e65461ecfc03a275f8061b2f)
def Claim_75b39504f8dd : Prop :=
  ‖((6 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99373623) / 100000000 : ℝ) : ℂ) - (((5587553) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 2a8afe5e576536fe7301bd9256118d7e5b2f6347f08c3d5b4026e3408b8070bf)
theorem prove_Claim_75b39504f8dd : Claim_75b39504f8dd :=
  by
    unfold Claim_75b39504f8dd
...
#rh_audit_axioms prove_Claim_75b39504f8dd
