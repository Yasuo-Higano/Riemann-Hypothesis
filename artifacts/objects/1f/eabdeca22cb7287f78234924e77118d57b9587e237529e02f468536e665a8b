...
-- claim: zl3b-rot-n24 (15fff1fdb4653d7c073c8bfed6c9bad76b6e6f70c70f4f822ea4bad5082d0b1a)
def Claim_15fff1fdb465 : Prop :=
  ‖((24 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 40 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((4984227) / 5000000 : ℝ) : ℂ) - (((396839) / 5000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((21) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: a11debc7b0428c1a5f9db981c9490927471986b2dd49d99ca5173a8cb25f0508)
theorem prove_Claim_15fff1fdb465 : Claim_15fff1fdb465 :=
  by
    unfold Claim_15fff1fdb465
...
#rh_audit_axioms prove_Claim_15fff1fdb465
