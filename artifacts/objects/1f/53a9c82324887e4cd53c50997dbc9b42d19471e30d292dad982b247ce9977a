...
-- claim: zcoeff-n22-m5o8 (b973648d0e3f2811dd327ae71b825187615b5ee5da3e51c17658e16c10895397)
def Claim_b973648d0e3f : Prop :=
  ((∑ n ∈ Finset.range 22, Real.log n * (n : ℝ) ^ (-((5) / 8 : ℝ))) ≤ ((5219) / 500 : ℝ)) ∧ (15 / 16 * (Real.log 22 * (22 : ℝ) ^ (-((5) / 8 : ℝ))) + 11 / 16 * (Real.log 23 * (23 : ℝ) ^ (-((5) / 8 : ℝ))) + 5 / 16 * (Real.log 24 * (24 : ℝ) ^ (-((5) / 8 : ℝ))) + 1 / 16 * (Real.log 25 * (25 : ℝ) ^ (-((5) / 8 : ℝ))) ≤ ((907) / 1000 : ℝ))

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-eta-grid, proof sha256: ff9e2394b9ea8f70738c44da9c5fe8d93657a7d1994f6e8b1123e8e9a7426932)
theorem prove_Claim_b973648d0e3f : Claim_b973648d0e3f :=
  by
    unfold Claim_b973648d0e3f
...
#rh_audit_axioms prove_Claim_b973648d0e3f
