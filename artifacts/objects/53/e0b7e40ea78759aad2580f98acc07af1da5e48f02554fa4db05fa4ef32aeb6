...
-- claim: zcb7k2-rot-n7 (3ede8ff743f75e8302c5439968b817442dc5ae76ae56b0e9caff67530ab54247)
def Claim_3ede8ff743f7 : Prop :=
  ‖((7 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((48528151) / 50000000 : ℝ) : ℂ) - (((6021183) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((31) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 4e3f9a9e3ef41ca37a58744ecd6b306df763d7c8e470d0b4a12bca429799a958)
theorem prove_Claim_3ede8ff743f7 : Claim_3ede8ff743f7 :=
  by
    unfold Claim_3ede8ff743f7
...
#rh_audit_axioms prove_Claim_3ede8ff743f7
