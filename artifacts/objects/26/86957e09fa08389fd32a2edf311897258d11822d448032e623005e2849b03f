...
-- claim: auto-exp-cpow-eight-hh (ea1d11fd080f8e21c5681d3b6fc4ac31bfdcbb3ca1f63c903df7b54239cdaa06)
def Claim_ea1d11fd080f : Prop :=
  |Real.exp ((-103972077) / 100000000 : ℝ) - ((17677669) / 50000000 : ℝ)| ≤ ((3) / 25000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-exp-square, proof sha256: 9b45b5575aca89f850e5f9f4415b54134a27b3e65f74926ef8c94e0a3f296be2)
theorem prove_Claim_ea1d11fd080f : Claim_ea1d11fd080f :=
  by
    unfold Claim_ea1d11fd080f
    have hb : |Real.exp ((-103972077) / 200000000 : ℝ) - ((11892071) / 20000000 : ℝ)| ≤ ((1) / 12500000 : ℝ) := by
      have h := prove_Claim_423380a6d470
      unfold Claim_423380a6d470 at h
      exact h
...
#rh_audit_axioms prove_Claim_ea1d11fd080f
