...
-- claim: auto-exp-boole-corr-31-t141-s1 (5ca684c2d79f2a7d95d449122f9bccf297ef655d2c1ec28ba2a2ad5d48eee8d7)
def Claim_5ca684c2d79f : Prop :=
  |Real.exp ((-1073121) / 1250000 : ℝ) - ((21189933) / 50000000 : ℝ)| ≤ ((267) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-exp-square, proof sha256: 9007098ec5fe6070debc9555e2d8c5d263a50ae0d3a2bfb974e08f587de3ae7e)
theorem prove_Claim_5ca684c2d79f : Claim_5ca684c2d79f :=
  by
    unfold Claim_5ca684c2d79f
    have hb : |Real.exp ((-1073121) / 2500000 : ℝ) - ((3254991) / 5000000 : ℝ)| ≤ ((51) / 12500000 : ℝ) := by
      have h := prove_Claim_78ca8a787aa5
      unfold Claim_78ca8a787aa5 at h
      exact h
...
#rh_audit_axioms prove_Claim_5ca684c2d79f
