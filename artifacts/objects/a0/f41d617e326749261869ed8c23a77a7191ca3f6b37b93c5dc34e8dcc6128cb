...
-- claim: zcb3k3-rot-n10 (e0648f7ceb070d44e81e56dd6f7bdcdb8449ca47d09c6d5a1b5b6b71dee5e10e)
def Claim_e0648f7ceb07 : Prop :=
  ‖((10 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((98966259) / 100000000 : ℝ) : ℂ) - (((3585383) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 1250000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 03586662640ab779c726c1f921d900d1ad99132ca977cd50b02d05dfb3f8958c)
theorem prove_Claim_e0648f7ceb07 : Claim_e0648f7ceb07 :=
  by
    unfold Claim_e0648f7ceb07
...
#rh_audit_axioms prove_Claim_e0648f7ceb07
