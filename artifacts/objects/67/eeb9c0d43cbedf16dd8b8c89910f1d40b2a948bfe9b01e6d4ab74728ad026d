...
-- claim: zcb2k3-rot-n10 (e05e1d0fa67e15214084be2b57c573f2b779082feebf67e75b8d557217a08327)
def Claim_e05e1d0fa67e : Prop :=
  ‖((10 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((98966259) / 100000000 : ℝ) : ℂ) - (((3585383) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 1250000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 463b62972bd9948a3956378a1b532ac2080da1e622a0a4588a553afeae0b6d11)
theorem prove_Claim_e05e1d0fa67e : Claim_e05e1d0fa67e :=
  by
    unfold Claim_e05e1d0fa67e
...
#rh_audit_axioms prove_Claim_e05e1d0fa67e
