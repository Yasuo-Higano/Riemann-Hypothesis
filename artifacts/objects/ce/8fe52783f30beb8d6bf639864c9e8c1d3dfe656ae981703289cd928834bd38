...
-- claim: zcb22k2-rot-n14 (42b0f5749f2ec468029ebdd53cbfaecb2e0756e22571a9b47507aba43e16921d)
def Claim_42b0f5749f2e : Prop :=
  ‖((14 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 8 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((94608049) / 100000000 : ℝ) : ℂ) - (((8098291) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((127) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: c8ba3216d57212fe935fa87a833023a599576e7cd44dab5dff252318b2e7fedd)
theorem prove_Claim_42b0f5749f2e : Claim_42b0f5749f2e :=
  by
    unfold Claim_42b0f5749f2e
...
#rh_audit_axioms prove_Claim_42b0f5749f2e
