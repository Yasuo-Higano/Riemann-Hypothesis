...
-- claim: zcb28k2-rot-n25 (281d42eb1538a07ed57e4208c3478a6b38741482c997820871c9a39ae6cf6eda)
def Claim_281d42eb1538 : Prop :=
  ‖((25 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 40 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((24919097) / 25000000 : ℝ) : ℂ) - (((803851) / 10000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 2000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: da5db2cbc13b7e43e22dc33a1f1c44c597e813390d31900b5fda091b0cb39f08)
theorem prove_Claim_281d42eb1538 : Claim_281d42eb1538 :=
  by
    unfold Claim_281d42eb1538
...
#rh_audit_axioms prove_Claim_281d42eb1538
