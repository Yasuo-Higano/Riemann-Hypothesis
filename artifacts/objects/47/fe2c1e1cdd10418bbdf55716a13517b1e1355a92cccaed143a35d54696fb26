...
-- claim: zcb0k3-b-n3 (d2f84d4e20d7b9c44f9b5b8a9151c4250623efbde9cded31ed943da146adc0d6)
def Claim_d2f84d4e20d7 : Prop :=
  ‖((3 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((-1) / 32 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99941073) / 100000000 : ℝ) : ℂ) - (((-3432489) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: c20413c55fd860caa7c666e61c53e32cb4765d20a457f54bcbbce8417731a3d8)
theorem prove_Claim_d2f84d4e20d7 : Claim_d2f84d4e20d7 :=
  by
    unfold Claim_d2f84d4e20d7
    ...
    have hcosi := prove_Claim_a974fd78e18c ((-3433163) / 100000000 : ℝ) ((99941073) / 100000000 : ℝ) 14 ((1) / 50000000 : ℝ) ((1) / 100000000 : ℝ)
      (by rw [abs_of_nonpos (by norm_num : ((-3433163) / 100000000 : ℝ) ≤ 0)]; norm_num)
      (by norm_num [Finset.sum_range_succ, Finset.sum_range_zero, Nat.factorial])
      (by rw [abs_of_nonpos (by norm_num : ((-3433163) / 100000000 : ℝ) ≤ 0)]; norm_num)
    ...
    rw [abs_of_nonneg (by norm_num : (0:ℝ) ≤ (1 : ℝ)), abs_of_nonneg (by norm_num : (0:ℝ) ≤ ((99941073) / 100000000 : ℝ)), abs_of_nonpos (by norm_num : ((-3432489) / 100000000 : ℝ) ≤ 0)] at hmain
...
#rh_audit_axioms prove_Claim_d2f84d4e20d7
