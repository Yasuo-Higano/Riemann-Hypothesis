...
-- claim: zcoeff-n8-m7o8 (6b6b6e0b07a88ec4bca75bd404f50df289a563e24463a8043136f7d9b940472d)
def Claim_6b6b6e0b07a8 : Prop :=
  ((∑ n ∈ Finset.range 8, Real.log n * (n : ℝ) ^ (-((7) / 8 : ℝ))) ≤ ((294) / 125 : ℝ)) ∧ (15 / 16 * (Real.log 8 * (8 : ℝ) ^ (-((7) / 8 : ℝ))) + 11 / 16 * (Real.log 9 * (9 : ℝ) ^ (-((7) / 8 : ℝ))) + 5 / 16 * (Real.log 10 * (10 : ℝ) ^ (-((7) / 8 : ℝ))) + 1 / 16 * (Real.log 11 * (11 : ℝ) ^ (-((7) / 8 : ℝ))) ≤ ((84) / 125 : ℝ))

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-eta-grid, proof sha256: c2210cbc9fc456d0cb920cc395c3fcca8b2f786c7bf8a7239378f3eaf577a8e6)
theorem prove_Claim_6b6b6e0b07a8 : Claim_6b6b6e0b07a8 :=
  by
    unfold Claim_6b6b6e0b07a8
...
#rh_audit_axioms prove_Claim_6b6b6e0b07a8
