...
-- claim: zcb30k5-rot-n29 (a907d07bbf8aa67b1d383f14aa0f7a54f5027869f82f0f27cd82674e57fa41f2)
def Claim_a907d07bbf8a : Prop :=
  ‖((29 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 320 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((3124827) / 3125000 : ℝ) : ℂ) - (((1052261) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((11) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: d8a62b94fe923e00dddf44499768637e0acf632084350bb57e0256fddc3946a9)
theorem prove_Claim_a907d07bbf8a : Claim_a907d07bbf8a :=
  by
    unfold Claim_a907d07bbf8a
...
#rh_audit_axioms prove_Claim_a907d07bbf8a
