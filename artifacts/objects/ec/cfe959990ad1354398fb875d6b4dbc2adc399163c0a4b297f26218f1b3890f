...
-- claim: zcoeff-n30-m5o8 (e8cbe78aa8fd68cd898c53775586b275314afcc9ebcc75edcebe116dc3a5d451)
def Claim_e8cbe78aa8fd : Prop :=
  ((∑ n ∈ Finset.range 30, Real.log n * (n : ℝ) ^ (-((5) / 8 : ℝ))) ≤ ((2773) / 200 : ℝ)) ∧ (15 / 16 * (Real.log 30 * (30 : ℝ) ^ (-((5) / 8 : ℝ))) + 11 / 16 * (Real.log 31 * (31 : ℝ) ^ (-((5) / 8 : ℝ))) + 5 / 16 * (Real.log 32 * (32 : ℝ) ^ (-((5) / 8 : ℝ))) + 1 / 16 * (Real.log 33 * (33 : ℝ) ^ (-((5) / 8 : ℝ))) ≤ ((413) / 500 : ℝ))

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-eta-grid, proof sha256: de7eb730fc8c00f88ce67d2094105d91077cd108abe2bce629e6faa8179636de)
theorem prove_Claim_e8cbe78aa8fd : Claim_e8cbe78aa8fd :=
  by
    unfold Claim_e8cbe78aa8fd
    ...
    have hL12 : Real.log (12 : ℝ) ≤ ((2484913) / 1000000 : ℝ) := by
      ...
      linarith
    have hbr12 := prove_Claim_e20ca64ade34 12 5 8 ((1057) / 5000 : ℝ) ((2117) / 10000 : ℝ)
      (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)
    have hpe12 : (((12 : ℕ)) : ℝ) ^ (-(((5 : ℕ) : ℝ) / ((8 : ℕ) : ℝ))) = ((12) : ℝ) ^ (-((5) / 8 : ℝ)) := by
      norm_num
    have hup12 : ((12) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((2117) / 10000 : ℝ) := by
      rw [← hpe12]
      exact hbr12.2
    have hlo12 : (0:ℝ) ≤ ((12) : ℝ) ^ (-((5) / 8 : ℝ)) := by positivity
    have hln12 : (0:ℝ) ≤ Real.log (12 : ℝ) := Real.log_nonneg (by norm_num)
    have hterm12 : Real.log (12 : ℝ) * ((12) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((2484913) / 1000000 : ℝ) * ((2117) / 10000 : ℝ) := by
    ...
    have hL13 : Real.log (13 : ℝ) ≤ ((320619) / 125000 : ℝ) := by
      ...
      linarith
    have hbr13 := prove_Claim_e20ca64ade34 13 5 8 ((2011) / 10000 : ℝ) ((1007) / 5000 : ℝ)
      (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)
    have hpe13 : (((13 : ℕ)) : ℝ) ^ (-(((5 : ℕ) : ℝ) / ((8 : ℕ) : ℝ))) = ((13) : ℝ) ^ (-((5) / 8 : ℝ)) := by
      norm_num
    have hup13 : ((13) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((1007) / 5000 : ℝ) := by
      rw [← hpe13]
      exact hbr13.2
    have hlo13 : (0:ℝ) ≤ ((13) : ℝ) ^ (-((5) / 8 : ℝ)) := by positivity
    have hln13 : (0:ℝ) ≤ Real.log (13 : ℝ) := Real.log_nonneg (by norm_num)
    have hterm13 : Real.log (13 : ℝ) * ((13) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((320619) / 125000 : ℝ) * ((1007) / 5000 : ℝ) := by
    ...
    have hL14 : Real.log (14 : ℝ) ≤ ((2639063) / 1000000 : ℝ) := by
      ...
      linarith
    have hbr14 := prove_Claim_e20ca64ade34 14 5 8 ((24) / 125 : ℝ) ((1923) / 10000 : ℝ)
      (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)
    have hpe14 : (((14 : ℕ)) : ℝ) ^ (-(((5 : ℕ) : ℝ) / ((8 : ℕ) : ℝ))) = ((14) : ℝ) ^ (-((5) / 8 : ℝ)) := by
      norm_num
    have hup14 : ((14) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((1923) / 10000 : ℝ) := by
      rw [← hpe14]
      exact hbr14.2
    have hlo14 : (0:ℝ) ≤ ((14) : ℝ) ^ (-((5) / 8 : ℝ)) := by positivity
    have hln14 : (0:ℝ) ≤ Real.log (14 : ℝ) := Real.log_nonneg (by norm_num)
    have hterm14 : Real.log (14 : ℝ) * ((14) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((2639063) / 1000000 : ℝ) * ((1923) / 10000 : ℝ) := by
    ...
    have hL15 : Real.log (15 : ℝ) ≤ ((677013) / 250000 : ℝ) := by
      ...
      linarith
    have hbr15 := prove_Claim_e20ca64ade34 15 5 8 ((1839) / 10000 : ℝ) ((921) / 5000 : ℝ)
      (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)
    have hpe15 : (((15 : ℕ)) : ℝ) ^ (-(((5 : ℕ) : ℝ) / ((8 : ℕ) : ℝ))) = ((15) : ℝ) ^ (-((5) / 8 : ℝ)) := by
      norm_num
    have hup15 : ((15) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((921) / 5000 : ℝ) := by
      rw [← hpe15]
      exact hbr15.2
    have hlo15 : (0:ℝ) ≤ ((15) : ℝ) ^ (-((5) / 8 : ℝ)) := by positivity
    have hln15 : (0:ℝ) ≤ Real.log (15 : ℝ) := Real.log_nonneg (by norm_num)
    have hterm15 : Real.log (15 : ℝ) * ((15) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((677013) / 250000 : ℝ) * ((921) / 5000 : ℝ) := by
    ...
    have hL16 : Real.log (16 : ℝ) ≤ ((2772589) / 1000000 : ℝ) := by
      ...
      linarith
    have hbr16 := prove_Claim_e20ca64ade34 16 5 8 ((883) / 5000 : ℝ) ((1769) / 10000 : ℝ)
      (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)
    have hpe16 : (((16 : ℕ)) : ℝ) ^ (-(((5 : ℕ) : ℝ) / ((8 : ℕ) : ℝ))) = ((16) : ℝ) ^ (-((5) / 8 : ℝ)) := by
      norm_num
    have hup16 : ((16) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((1769) / 10000 : ℝ) := by
      rw [← hpe16]
      exact hbr16.2
    have hlo16 : (0:ℝ) ≤ ((16) : ℝ) ^ (-((5) / 8 : ℝ)) := by positivity
    have hln16 : (0:ℝ) ≤ Real.log (16 : ℝ) := Real.log_nonneg (by norm_num)
    have hterm16 : Real.log (16 : ℝ) * ((16) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((2772589) / 1000000 : ℝ) * ((1769) / 10000 : ℝ) := by
    ...
    have hL17 : Real.log (17 : ℝ) ≤ ((566643) / 200000 : ℝ) := by
      ...
      linarith
    have hbr17 := prove_Claim_e20ca64ade34 17 5 8 ((1701) / 10000 : ℝ) ((213) / 1250 : ℝ)
      (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)
    have hpe17 : (((17 : ℕ)) : ℝ) ^ (-(((5 : ℕ) : ℝ) / ((8 : ℕ) : ℝ))) = ((17) : ℝ) ^ (-((5) / 8 : ℝ)) := by
      norm_num
    have hup17 : ((17) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((213) / 1250 : ℝ) := by
      rw [← hpe17]
      exact hbr17.2
    have hlo17 : (0:ℝ) ≤ ((17) : ℝ) ^ (-((5) / 8 : ℝ)) := by positivity
    have hln17 : (0:ℝ) ≤ Real.log (17 : ℝ) := Real.log_nonneg (by norm_num)
    have hterm17 : Real.log (17 : ℝ) * ((17) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((566643) / 200000 : ℝ) * ((213) / 1250 : ℝ) := by
    ...
    have hL18 : Real.log (18 : ℝ) ≤ ((2890377) / 1000000 : ℝ) := by
      ...
      linarith
    have hbr18 := prove_Claim_e20ca64ade34 18 5 8 ((1641) / 10000 : ℝ) ((411) / 2500 : ℝ)
      (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)
    have hpe18 : (((18 : ℕ)) : ℝ) ^ (-(((5 : ℕ) : ℝ) / ((8 : ℕ) : ℝ))) = ((18) : ℝ) ^ (-((5) / 8 : ℝ)) := by
      norm_num
    have hup18 : ((18) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((411) / 2500 : ℝ) := by
      rw [← hpe18]
      exact hbr18.2
    have hlo18 : (0:ℝ) ≤ ((18) : ℝ) ^ (-((5) / 8 : ℝ)) := by positivity
    have hln18 : (0:ℝ) ≤ Real.log (18 : ℝ) := Real.log_nonneg (by norm_num)
    have hterm18 : Real.log (18 : ℝ) * ((18) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((2890377) / 1000000 : ℝ) * ((411) / 2500 : ℝ) := by
    ...
    have hL19 : Real.log (19 : ℝ) ≤ ((1472221) / 500000 : ℝ) := by
      ...
      linarith
    have hbr19 := prove_Claim_e20ca64ade34 19 5 8 ((793) / 5000 : ℝ) ((1589) / 10000 : ℝ)
      (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)
    have hpe19 : (((19 : ℕ)) : ℝ) ^ (-(((5 : ℕ) : ℝ) / ((8 : ℕ) : ℝ))) = ((19) : ℝ) ^ (-((5) / 8 : ℝ)) := by
      norm_num
    have hup19 : ((19) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((1589) / 10000 : ℝ) := by
      rw [← hpe19]
      exact hbr19.2
    have hlo19 : (0:ℝ) ≤ ((19) : ℝ) ^ (-((5) / 8 : ℝ)) := by positivity
    have hln19 : (0:ℝ) ≤ Real.log (19 : ℝ) := Real.log_nonneg (by norm_num)
    have hterm19 : Real.log (19 : ℝ) * ((19) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((1472221) / 500000 : ℝ) * ((1589) / 10000 : ℝ) := by
    ...
    have hL20 : Real.log (20 : ℝ) ≤ ((1497869) / 500000 : ℝ) := by
      ...
      linarith
    have hbr20 := prove_Claim_e20ca64ade34 20 5 8 ((96) / 625 : ℝ) ((1539) / 10000 : ℝ)
      (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)
    have hpe20 : (((20 : ℕ)) : ℝ) ^ (-(((5 : ℕ) : ℝ) / ((8 : ℕ) : ℝ))) = ((20) : ℝ) ^ (-((5) / 8 : ℝ)) := by
      norm_num
    have hup20 : ((20) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((1539) / 10000 : ℝ) := by
      rw [← hpe20]
      exact hbr20.2
    have hlo20 : (0:ℝ) ≤ ((20) : ℝ) ^ (-((5) / 8 : ℝ)) := by positivity
    have hln20 : (0:ℝ) ≤ Real.log (20 : ℝ) := Real.log_nonneg (by norm_num)
    have hterm20 : Real.log (20 : ℝ) * ((20) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((1497869) / 500000 : ℝ) * ((1539) / 10000 : ℝ) := by
    ...
    have hL21 : Real.log (21 : ℝ) ≤ ((3044527) / 1000000 : ℝ) := by
      ...
      linarith
    have hbr21 := prove_Claim_e20ca64ade34 21 5 8 ((149) / 1000 : ℝ) ((1493) / 10000 : ℝ)
      (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)
    have hpe21 : (((21 : ℕ)) : ℝ) ^ (-(((5 : ℕ) : ℝ) / ((8 : ℕ) : ℝ))) = ((21) : ℝ) ^ (-((5) / 8 : ℝ)) := by
      norm_num
    have hup21 : ((21) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((1493) / 10000 : ℝ) := by
      rw [← hpe21]
      exact hbr21.2
    have hlo21 : (0:ℝ) ≤ ((21) : ℝ) ^ (-((5) / 8 : ℝ)) := by positivity
    have hln21 : (0:ℝ) ≤ Real.log (21 : ℝ) := Real.log_nonneg (by norm_num)
    have hterm21 : Real.log (21 : ℝ) * ((21) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((3044527) / 1000000 : ℝ) * ((1493) / 10000 : ℝ) := by
    ...
    have hL22 : Real.log (22 : ℝ) ≤ ((3091047) / 1000000 : ℝ) := by
      ...
      linarith
    have hbr22 := prove_Claim_e20ca64ade34 22 5 8 ((1447) / 10000 : ℝ) ((29) / 200 : ℝ)
      (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)
    have hpe22 : (((22 : ℕ)) : ℝ) ^ (-(((5 : ℕ) : ℝ) / ((8 : ℕ) : ℝ))) = ((22) : ℝ) ^ (-((5) / 8 : ℝ)) := by
      norm_num
    have hup22 : ((22) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((29) / 200 : ℝ) := by
      rw [← hpe22]
      exact hbr22.2
    have hlo22 : (0:ℝ) ≤ ((22) : ℝ) ^ (-((5) / 8 : ℝ)) := by positivity
    have hln22 : (0:ℝ) ≤ Real.log (22 : ℝ) := Real.log_nonneg (by norm_num)
    have hterm22 : Real.log (22 : ℝ) * ((22) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((3091047) / 1000000 : ℝ) * ((29) / 200 : ℝ) := by
    ...
    have hL23 : Real.log (23 : ℝ) ≤ ((3135499) / 1000000 : ℝ) := by
      ...
      linarith
    have hbr23 := prove_Claim_e20ca64ade34 23 5 8 ((88) / 625 : ℝ) ((1411) / 10000 : ℝ)
      (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)
    have hpe23 : (((23 : ℕ)) : ℝ) ^ (-(((5 : ℕ) : ℝ) / ((8 : ℕ) : ℝ))) = ((23) : ℝ) ^ (-((5) / 8 : ℝ)) := by
      norm_num
    have hup23 : ((23) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((1411) / 10000 : ℝ) := by
      rw [← hpe23]
      exact hbr23.2
    have hlo23 : (0:ℝ) ≤ ((23) : ℝ) ^ (-((5) / 8 : ℝ)) := by positivity
    have hln23 : (0:ℝ) ≤ Real.log (23 : ℝ) := Real.log_nonneg (by norm_num)
    have hterm23 : Real.log (23 : ℝ) * ((23) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((3135499) / 1000000 : ℝ) * ((1411) / 10000 : ℝ) := by
    ...
    have hL24 : Real.log (24 : ℝ) ≤ ((158903) / 50000 : ℝ) := by
      ...
      linarith
    have hbr24 := prove_Claim_e20ca64ade34 24 5 8 ((1371) / 10000 : ℝ) ((687) / 5000 : ℝ)
      (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)
    have hpe24 : (((24 : ℕ)) : ℝ) ^ (-(((5 : ℕ) : ℝ) / ((8 : ℕ) : ℝ))) = ((24) : ℝ) ^ (-((5) / 8 : ℝ)) := by
      norm_num
    have hup24 : ((24) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((687) / 5000 : ℝ) := by
      rw [← hpe24]
      exact hbr24.2
    have hlo24 : (0:ℝ) ≤ ((24) : ℝ) ^ (-((5) / 8 : ℝ)) := by positivity
    have hln24 : (0:ℝ) ≤ Real.log (24 : ℝ) := Real.log_nonneg (by norm_num)
    have hterm24 : Real.log (24 : ℝ) * ((24) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((158903) / 50000 : ℝ) * ((687) / 5000 : ℝ) := by
    ...
    have hL25 : Real.log (25 : ℝ) ≤ ((804721) / 250000 : ℝ) := by
      ...
      linarith
    have hbr25 := prove_Claim_e20ca64ade34 25 5 8 ((167) / 1250 : ℝ) ((1339) / 10000 : ℝ)
      (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)
    have hpe25 : (((25 : ℕ)) : ℝ) ^ (-(((5 : ℕ) : ℝ) / ((8 : ℕ) : ℝ))) = ((25) : ℝ) ^ (-((5) / 8 : ℝ)) := by
      norm_num
    have hup25 : ((25) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((1339) / 10000 : ℝ) := by
      rw [← hpe25]
      exact hbr25.2
    have hlo25 : (0:ℝ) ≤ ((25) : ℝ) ^ (-((5) / 8 : ℝ)) := by positivity
    have hln25 : (0:ℝ) ≤ Real.log (25 : ℝ) := Real.log_nonneg (by norm_num)
    have hterm25 : Real.log (25 : ℝ) * ((25) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((804721) / 250000 : ℝ) * ((1339) / 10000 : ℝ) := by
    ...
    have hL26 : Real.log (26 : ℝ) ≤ ((3258099) / 1000000 : ℝ) := by
      ...
      linarith
    have hbr26 := prove_Claim_e20ca64ade34 26 5 8 ((163) / 1250 : ℝ) ((1307) / 10000 : ℝ)
      (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)
    have hpe26 : (((26 : ℕ)) : ℝ) ^ (-(((5 : ℕ) : ℝ) / ((8 : ℕ) : ℝ))) = ((26) : ℝ) ^ (-((5) / 8 : ℝ)) := by
      norm_num
    have hup26 : ((26) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((1307) / 10000 : ℝ) := by
      rw [← hpe26]
      exact hbr26.2
    have hlo26 : (0:ℝ) ≤ ((26) : ℝ) ^ (-((5) / 8 : ℝ)) := by positivity
    have hln26 : (0:ℝ) ≤ Real.log (26 : ℝ) := Real.log_nonneg (by norm_num)
    have hterm26 : Real.log (26 : ℝ) * ((26) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((3258099) / 1000000 : ℝ) * ((1307) / 10000 : ℝ) := by
    ...
    have hL27 : Real.log (27 : ℝ) ≤ ((20599) / 6250 : ℝ) := by
      ...
      linarith
    have hbr27 := prove_Claim_e20ca64ade34 27 5 8 ((1273) / 10000 : ℝ) ((319) / 2500 : ℝ)
      (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)
    have hpe27 : (((27 : ℕ)) : ℝ) ^ (-(((5 : ℕ) : ℝ) / ((8 : ℕ) : ℝ))) = ((27) : ℝ) ^ (-((5) / 8 : ℝ)) := by
      norm_num
    have hup27 : ((27) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((319) / 2500 : ℝ) := by
      rw [← hpe27]
      exact hbr27.2
    have hlo27 : (0:ℝ) ≤ ((27) : ℝ) ^ (-((5) / 8 : ℝ)) := by positivity
    have hln27 : (0:ℝ) ≤ Real.log (27 : ℝ) := Real.log_nonneg (by norm_num)
    have hterm27 : Real.log (27 : ℝ) * ((27) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((20599) / 6250 : ℝ) * ((319) / 2500 : ℝ) := by
    ...
    have hL28 : Real.log (28 : ℝ) ≤ ((333221) / 100000 : ℝ) := by
      ...
      linarith
    have hbr28 := prove_Claim_e20ca64ade34 28 5 8 ((249) / 2000 : ℝ) ((78) / 625 : ℝ)
      (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)
    have hpe28 : (((28 : ℕ)) : ℝ) ^ (-(((5 : ℕ) : ℝ) / ((8 : ℕ) : ℝ))) = ((28) : ℝ) ^ (-((5) / 8 : ℝ)) := by
      norm_num
    have hup28 : ((28) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((78) / 625 : ℝ) := by
      rw [← hpe28]
      exact hbr28.2
    have hlo28 : (0:ℝ) ≤ ((28) : ℝ) ^ (-((5) / 8 : ℝ)) := by positivity
    have hln28 : (0:ℝ) ≤ Real.log (28 : ℝ) := Real.log_nonneg (by norm_num)
    have hterm28 : Real.log (28 : ℝ) * ((28) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((333221) / 100000 : ℝ) * ((78) / 625 : ℝ) := by
    ...
    have hL29 : Real.log (29 : ℝ) ≤ ((1683653) / 500000 : ℝ) := by
      ...
      linarith
    have hbr29 := prove_Claim_e20ca64ade34 29 5 8 ((1217) / 10000 : ℝ) ((61) / 500 : ℝ)
      (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)
    have hpe29 : (((29 : ℕ)) : ℝ) ^ (-(((5 : ℕ) : ℝ) / ((8 : ℕ) : ℝ))) = ((29) : ℝ) ^ (-((5) / 8 : ℝ)) := by
      norm_num
    have hup29 : ((29) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((61) / 500 : ℝ) := by
      rw [← hpe29]
      exact hbr29.2
    have hlo29 : (0:ℝ) ≤ ((29) : ℝ) ^ (-((5) / 8 : ℝ)) := by positivity
    have hln29 : (0:ℝ) ≤ Real.log (29 : ℝ) := Real.log_nonneg (by norm_num)
    have hterm29 : Real.log (29 : ℝ) * ((29) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((1683653) / 500000 : ℝ) * ((61) / 500 : ℝ) := by
    ...
    have hL30 : Real.log (30 : ℝ) ≤ ((1700599) / 500000 : ℝ) := by
      ...
      linarith
    have hbr30 := prove_Claim_e20ca64ade34 30 5 8 ((149) / 1250 : ℝ) ((239) / 2000 : ℝ)
      (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)
    have hpe30 : (((30 : ℕ)) : ℝ) ^ (-(((5 : ℕ) : ℝ) / ((8 : ℕ) : ℝ))) = ((30) : ℝ) ^ (-((5) / 8 : ℝ)) := by
      norm_num
    have hup30 : ((30) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((239) / 2000 : ℝ) := by
      rw [← hpe30]
      exact hbr30.2
    have hlo30 : (0:ℝ) ≤ ((30) : ℝ) ^ (-((5) / 8 : ℝ)) := by positivity
    have hln30 : (0:ℝ) ≤ Real.log (30 : ℝ) := Real.log_nonneg (by norm_num)
    have hterm30 : Real.log (30 : ℝ) * ((30) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((1700599) / 500000 : ℝ) * ((239) / 2000 : ℝ) := by
    ...
    have hL31 : Real.log (31 : ℝ) ≤ ((858497) / 250000 : ℝ) := by
      ...
      linarith
    have hbr31 := prove_Claim_e20ca64ade34 31 5 8 ((73) / 625 : ℝ) ((1171) / 10000 : ℝ)
      (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)
    have hpe31 : (((31 : ℕ)) : ℝ) ^ (-(((5 : ℕ) : ℝ) / ((8 : ℕ) : ℝ))) = ((31) : ℝ) ^ (-((5) / 8 : ℝ)) := by
      norm_num
    have hup31 : ((31) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((1171) / 10000 : ℝ) := by
      rw [← hpe31]
      exact hbr31.2
    have hlo31 : (0:ℝ) ≤ ((31) : ℝ) ^ (-((5) / 8 : ℝ)) := by positivity
    have hln31 : (0:ℝ) ≤ Real.log (31 : ℝ) := Real.log_nonneg (by norm_num)
    have hterm31 : Real.log (31 : ℝ) * ((31) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((858497) / 250000 : ℝ) * ((1171) / 10000 : ℝ) := by
    ...
    have hL32 : Real.log (32 : ℝ) ≤ ((433217) / 125000 : ℝ) := by
      ...
      linarith
    have hbr32 := prove_Claim_e20ca64ade34 32 5 8 ((229) / 2000 : ℝ) ((287) / 2500 : ℝ)
      (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)
    have hpe32 : (((32 : ℕ)) : ℝ) ^ (-(((5 : ℕ) : ℝ) / ((8 : ℕ) : ℝ))) = ((32) : ℝ) ^ (-((5) / 8 : ℝ)) := by
      norm_num
    have hup32 : ((32) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((287) / 2500 : ℝ) := by
      rw [← hpe32]
      exact hbr32.2
    have hlo32 : (0:ℝ) ≤ ((32) : ℝ) ^ (-((5) / 8 : ℝ)) := by positivity
    have hln32 : (0:ℝ) ≤ Real.log (32 : ℝ) := Real.log_nonneg (by norm_num)
    have hterm32 : Real.log (32 : ℝ) * ((32) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((433217) / 125000 : ℝ) * ((287) / 2500 : ℝ) := by
    ...
    have hL33 : Real.log (33 : ℝ) ≤ ((874127) / 250000 : ℝ) := by
      ...
      linarith
    have hbr33 := prove_Claim_e20ca64ade34 33 5 8 ((1123) / 10000 : ℝ) ((563) / 5000 : ℝ)
      (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num) (by norm_num)
    have hpe33 : (((33 : ℕ)) : ℝ) ^ (-(((5 : ℕ) : ℝ) / ((8 : ℕ) : ℝ))) = ((33) : ℝ) ^ (-((5) / 8 : ℝ)) := by
      norm_num
    have hup33 : ((33) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((563) / 5000 : ℝ) := by
      rw [← hpe33]
      exact hbr33.2
    have hlo33 : (0:ℝ) ≤ ((33) : ℝ) ^ (-((5) / 8 : ℝ)) := by positivity
    have hln33 : (0:ℝ) ≤ Real.log (33 : ℝ) := Real.log_nonneg (by norm_num)
    have hterm33 : Real.log (33 : ℝ) * ((33) : ℝ) ^ (-((5) / 8 : ℝ)) ≤ ((874127) / 250000 : ℝ) * ((563) / 5000 : ℝ) := by
...
#rh_audit_axioms prove_Claim_e8cbe78aa8fd
