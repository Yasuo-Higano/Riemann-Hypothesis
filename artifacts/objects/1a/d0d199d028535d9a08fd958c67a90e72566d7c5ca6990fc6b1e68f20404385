...
-- claim: zcb0k3-b-n2 (04bda068d408b92ba8d151b1131f6e824f73a8390650b43d50753bf06b4d522d)
def Claim_04bda068d408 : Prop :=
  ‖((2 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((-1) / 32 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99976541) / 100000000 : ℝ) : ℂ) - (((-541479) / 25000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((9) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 224a4ca96351e6775831e9ba0c2c3debe3abc0d05318345eb65c7181df50ec61)
theorem prove_Claim_04bda068d408 : Claim_04bda068d408 :=
  by
    unfold Claim_04bda068d408
    ...
    have hcosi := prove_Claim_a974fd78e18c ((-433217) / 20000000 : ℝ) ((99976541) / 100000000 : ℝ) 14 ((1) / 50000000 : ℝ) ((1) / 100000000 : ℝ)
      (by rw [abs_of_nonpos (by norm_num : ((-433217) / 20000000 : ℝ) ≤ 0)]; norm_num)
      (by norm_num [Finset.sum_range_succ, Finset.sum_range_zero, Nat.factorial])
      (by rw [abs_of_nonpos (by norm_num : ((-433217) / 20000000 : ℝ) ≤ 0)]; norm_num)
    ...
    rw [abs_of_nonneg (by norm_num : (0:ℝ) ≤ (1 : ℝ)), abs_of_nonneg (by norm_num : (0:ℝ) ≤ ((99976541) / 100000000 : ℝ)), abs_of_nonpos (by norm_num : ((-541479) / 25000000 : ℝ) ≤ 0)] at hmain
...
#rh_audit_axioms prove_Claim_04bda068d408
