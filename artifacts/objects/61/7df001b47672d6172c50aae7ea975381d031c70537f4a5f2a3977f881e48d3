...
-- claim: auto-exp-gkum-t141o20-xs-s2 (6fca6e173dec61a017347bd2b6fdc87eb7d2cc7311558149ae44712fb4abf060)
def Claim_6fca6e173dec : Prop :=
  |Real.exp ((1466580521) / 800000000 : ℝ) - ((2501611) / 400000 : ℝ)| ≤ ((19773) / 100000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-exp-square, proof sha256: 00d217db83df7ec4e5ef90e64e3f46c5bc94da59f8f5438fc8f290d0f68d64d7)
theorem prove_Claim_6fca6e173dec : Claim_6fca6e173dec :=
  by
    unfold Claim_6fca6e173dec
    have hb : |Real.exp ((1466580521) / 1600000000 : ℝ) - ((250080537) / 100000000 : ℝ)| ≤ ((247) / 6250000 : ℝ) := by
      have h := prove_Claim_d3ca8e598e3f
      unfold Claim_d3ca8e598e3f at h
      exact h
...
#rh_audit_axioms prove_Claim_6fca6e173dec
