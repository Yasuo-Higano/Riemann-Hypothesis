...
-- claim: zcb21k3-rot-n6 (fef035b8b28a349cd3d81396d1f08265d8f2c9947eb6edd5b6e7f28b1d3d6602)
def Claim_fef035b8b28a : Prop :=
  ‖((6 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99373623) / 100000000 : ℝ) : ℂ) - (((5587553) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 3d07448da32cb881c48e8f2308bf09595de9c8646531bb9f9524485f724c4966)
theorem prove_Claim_fef035b8b28a : Claim_fef035b8b28a :=
  by
    unfold Claim_fef035b8b28a
...
#rh_audit_axioms prove_Claim_fef035b8b28a
