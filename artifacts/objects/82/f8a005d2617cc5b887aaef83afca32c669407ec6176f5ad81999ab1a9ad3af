...
-- claim: zcb30k5-rot-n20 (fd5c4e7d326e1f8d6cf47c38fd9bb0480cc8f13bf7e5f333dca74431195f6681)
def Claim_fd5c4e7d326e : Prop :=
  ‖((20 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 320 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((49997809) / 50000000 : ℝ) : ℂ) - (((117019) / 12500000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 679f40aa3464827e0398eab4238cdc2a8a6e1755f3cbdba8a7310c99e8b460ec)
theorem prove_Claim_fd5c4e7d326e : Claim_fd5c4e7d326e :=
  by
    unfold Claim_fd5c4e7d326e
...
#rh_audit_axioms prove_Claim_fd5c4e7d326e
