...
-- claim: zcb2k3-rot-n6 (a871efd75f40f2ce5531a0bfee7b58194e9ee940cfc1e361510054d4e536b8c4)
def Claim_a871efd75f40 : Prop :=
  ‖((6 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99373623) / 100000000 : ℝ) : ℂ) - (((5587553) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: f0eba67e5933cc2d902f516be03f88a6759901a36c7061f077f34eb800ce5c8a)
theorem prove_Claim_a871efd75f40 : Claim_a871efd75f40 :=
  by
    unfold Claim_a871efd75f40
...
#rh_audit_axioms prove_Claim_a871efd75f40
