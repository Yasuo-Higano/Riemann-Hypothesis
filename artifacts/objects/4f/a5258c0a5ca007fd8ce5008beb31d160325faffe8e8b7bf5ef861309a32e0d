...
-- claim: zcb16k3-rot-n15 (5ca62bea658e1e74dc30f6993998678639b59cc8a23a0657c811edcce9f93ecc)
def Claim_5ca62bea658e : Prop :=
  ‖((15 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((19714217) / 20000000 : ℝ) : ℂ) - (((8422311) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((3) / 10000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 12ffdc0bf118b03d2b0a74a6d7aad54f3c9ad93bc0989904732237e79e633e4d)
theorem prove_Claim_5ca62bea658e : Claim_5ca62bea658e :=
  by
    unfold Claim_5ca62bea658e
...
#rh_audit_axioms prove_Claim_5ca62bea658e
