...
-- claim: zcb0k3-b-n10 (31dfdb89f98444096bc15fccd31288e34eaf8a0fb322d8b7b11621ca466c2f82)
def Claim_31dfdb89f984 : Prop :=
  ‖((10 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((-1) / 32 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((9974123) / 10000000 : ℝ) : ℂ) - (((-7189369) / 100000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((3) / 6250000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 74fb453fd68c401adc817ea7715f6f550f521bcd3932368f8a2fd93b97a1a162)
theorem prove_Claim_31dfdb89f984 : Claim_31dfdb89f984 :=
  by
    unfold Claim_31dfdb89f984
    ...
    have hcosi := prove_Claim_a974fd78e18c ((-7195577) / 100000000 : ℝ) ((9974123) / 10000000 : ℝ) 14 ((1) / 50000000 : ℝ) ((1) / 100000000 : ℝ)
      (by rw [abs_of_nonpos (by norm_num : ((-7195577) / 100000000 : ℝ) ≤ 0)]; norm_num)
      (by norm_num [Finset.sum_range_succ, Finset.sum_range_zero, Nat.factorial])
      (by rw [abs_of_nonpos (by norm_num : ((-7195577) / 100000000 : ℝ) ≤ 0)]; norm_num)
    ...
    rw [abs_of_nonneg (by norm_num : (0:ℝ) ≤ (1 : ℝ)), abs_of_nonneg (by norm_num : (0:ℝ) ≤ ((9974123) / 10000000 : ℝ)), abs_of_nonpos (by norm_num : ((-7189369) / 100000000 : ℝ) ≤ 0)] at hmain
...
#rh_audit_axioms prove_Claim_31dfdb89f984
