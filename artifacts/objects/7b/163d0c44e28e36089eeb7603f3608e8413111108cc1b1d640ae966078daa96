...
-- claim: zcb30k2-rot-n24 (51015200eff76542e53659ebb934429d61ec40320fb211898488787912fc5d03)
def Claim_51015200eff7 : Prop :=
  ‖((24 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 40 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((4984227) / 5000000 : ℝ) : ℂ) - (((396839) / 5000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((21) / 50000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 8d96bbb7490b258132a62adb8855a9b7fe355cce0c0678a358bd1f049e980f2e)
theorem prove_Claim_51015200eff7 : Claim_51015200eff7 :=
  by
    unfold Claim_51015200eff7
...
#rh_audit_axioms prove_Claim_51015200eff7
