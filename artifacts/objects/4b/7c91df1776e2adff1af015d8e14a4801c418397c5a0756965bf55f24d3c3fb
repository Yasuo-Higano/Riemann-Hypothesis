...
-- claim: zcb1k3-rot-n6 (e6937c98ffff516bbe1d372aa0ab0469cd2189909277d893f0907b7412aba5fd)
def Claim_e6937c98ffff : Prop :=
  ‖((6 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99373623) / 100000000 : ℝ) : ℂ) - (((5587553) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 832d0cdb590db8578054c852085461e2c015cc3e7ea452963a705d3945f2ce91)
theorem prove_Claim_e6937c98ffff : Claim_e6937c98ffff :=
  by
    unfold Claim_e6937c98ffff
...
#rh_audit_axioms prove_Claim_e6937c98ffff
