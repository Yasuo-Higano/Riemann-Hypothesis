...
-- claim: zcb26k3-rot-n6 (bedb4a4b97cd6552bcaadb05fa84d10c4e72f0a06cd258f5b0afbdfc347d8f87)
def Claim_bedb4a4b97cd : Prop :=
  ‖((6 : ℕ) : ℂ) ^ (-(((0 : ℝ) : ℂ) + (((1) / 16 : ℝ) : ℂ) * Complex.I)) - (((1 : ℝ) : ℂ)) * ((((99373623) / 100000000 : ℝ) : ℂ) - (((5587553) / 50000000 : ℝ) : ℂ) * Complex.I)‖ ≤ ((1) / 5000000 : ℝ)

-- BEGIN UNTRUSTED PROOF (prover: certificate-compiler-cpow, proof sha256: 59e3f47a0a64a834386f95e85eba729a562a75478cb1420d58508a458d936af4)
theorem prove_Claim_bedb4a4b97cd : Claim_bedb4a4b97cd :=
  by
    unfold Claim_bedb4a4b97cd
...
#rh_audit_axioms prove_Claim_bedb4a4b97cd
